...
return K.each(e.match(fe)||[],function(e,n){t[n]=!0}),t}function a(){Z.removeEventListener("DOMContentLoaded",a,!1),e.removeEventListener("load",a,!1),K.ready()}function s(){Object.defineProperty(this.cache={},0,{get:function(){return{}}}),this.expando=K.expando+s.uid++}function l(e,t,n){var i
...
return n}function c(){return!0}function d(){return!1}function u(){try{return Z.activeElement}catch(e){}}function p(e,t){return K.nodeName(e,"table")&&K.nodeName(11!==t.nodeType?t:t.firstChild,"tr")?e.getElementsByTagName("tbody")[0]||e.appendChild(e.ownerDocument.createElement("tbody")):e}function f(e){return e.type=(null!==e.getAttribute("type"))+"/"+e.type,e}function h(e){var t=Ne.exec(e.type)
...
return o.detach(),r}function w(e){var t=Z,n=He[e]
...
return n=n||ze(e),n&&(a=n.getPropertyValue(t)||n[t]),n&&(""!==a||K.contains(e.ownerDocument,e)||(a=K.style(e,t)),Ye.test(a)&&We.test(t)&&(i=s.width,o=s.minWidth,r=s.maxWidth,s.minWidth=s.maxWidth=s.width=a,a=n.width,s.width=i,s.minWidth=o,s.maxWidth=r)),void 0!==a?a+"":a}function _(e,t){return{get:function(){return e()?void delete this.get:(this.get=t).apply(this,arguments)}}}function C(e,t){if(t in e)return t
...
if(0>=o||null==o){if(o=x(e,t,r),(0>o||null==o)&&(o=e.style[t]),Ye.test(o))return o
...
return e}function E(e,t,n,i,o){return new E.prototype.init(e,t,n,i,o)}function I(){return setTimeout(function(){Je=void 0}),Je=K.now()}function M(e,t){var n,i=0,o={height:e}
for(t=t?1:0;4>i;i+=2-t)n=_e[i],o["margin"+n]=o["padding"+n]=e
return t&&(o.opacity=o.width=e),o}function A(e,t,n){for(var i,o=(nt[t]||[]).concat(nt["*"]),r=0,a=o.length;a>r;r++)if(i=o[r].call(n,t,e))return i}function L(e,t,n){var i,o,r,a,s,l,c,d,u=this,p={},f=e.style,h=e.nodeType&&Ce(e),m=ve.get(e,"fxshow")
n.queue||(s=K._queueHooks(e,"fx"),null==s.unqueued&&(s.unqueued=0,l=s.empty.fire,s.empty.fire=function(){s.unqueued||l()}),s.unqueued++,u.always(function(){u.always(function(){s.unqueued--,K.queue(e,"fx").length||s.empty.fire()})})),1===e.nodeType&&("height"in t||"width"in t)&&(n.overflow=[f.overflow,f.overflowX,f.overflowY],c=K.css(e,"display"),d="none"===c?ve.get(e,"olddisplay")||w(e.nodeName):c,"inline"===d&&"none"===K.css(e,"float")&&(f.display="inline-block")),n.overflow&&(f.overflow="hidden",u.always(function(){f.overflow=n.overflow[0],f.overflowX=n.overflow[1],f.overflowY=n.overflow[2]}))
for(i in t)if(o=t[i],Xe.exec(o)){if(delete t[i],r=r||"toggle"===o,o===(h?"hide":"show")){if("show"!==o||!m||void 0===m[i])continue
h=!0}p[i]=m&&m[i]||K.style(e,i)}else c=void 0
if(K.isEmptyObject(p))"inline"===("none"===c?w(e.nodeName):c)&&(f.display=c)
else{m?"hidden"in m&&(h=m.hidden):m=ve.access(e,"fxshow",{}),r&&(m.hidden=!h),h?K(e).show():u.done(function(){K(e).hide()}),u.done(function(){var t
ve.remove(e,"fxshow")
for(t in p)K.style(e,t,p[t])})
for(i in p)a=A(h?m[i]:0,i,u),i in m||(m[i]=a.start,h&&(a.end=a.start,a.start="width"===i||"height"===i?1:0))}}function F(e,t){var n,i,o,r,a
...
for(n in r)n in e||(e[n]=r[n],t[n]=o)}else t[i]=o}function P(e,t,n){var i,o,r=0,a=tt.length,s=K.Deferred().always(function(){delete l.elem}),l=function(){if(o)return!1
...
for(F(d,c.opts.specialEasing);a>r;r++)if(i=tt[r].call(c,e,d,c.opts))return i
return K.map(d,A,c),K.isFunction(c.opts.start)&&c.opts.start.call(e,c),K.fx.timer(K.extend(l,{elem:e,anim:c,queue:c.opts.queue})),c.progress(c.opts.progress).done(c.opts.done,c.opts.complete).fail(c.opts.fail).always(c.opts.always)}function O(e){return function(t,n){"string"!=typeof t&&(n=t,t="*")
...
break}a||(a=o)}r=r||a}return r?(r!==l[0]&&l.unshift(r),n[r]):void 0}function R(e,t,n,i){var o,r,a,s,l,c={},d=e.dataTypes.slice()
...
else if("*"!==l&&l!==r){if(a=c[l+" "+r]||c["* "+r],!a)for(o in c)if(s=o.split(" "),s[1]===r&&(a=c[l+" "+s[0]]||c["* "+s[0]])){a===!0?a=c[o]:c[o]!==!0&&(r=s[0],d.unshift(s[1]))
...
return this.pushStack(n>=0&&t>n?[this[n]]:[])},end:function(){return this.prevObject||this.constructor(null)},push:U,sort:Y.sort,splice:Y.splice},K.extend=K.fn.extend=function(){var e,t,n,i,o,r,a=arguments[0]||{},s=1,l=arguments.length,c=!1
...
e=K.trim(e),e&&(1===e.indexOf("use strict")?(t=Z.createElement("script"),t.text=e,Z.head.appendChild(t).parentNode.removeChild(t)):n(e))},camelCase:function(e){return e.replace(te,"ms-").replace(ne,ie)},nodeName:function(e,t){return e.nodeName&&e.nodeName.toLowerCase()===t.toLowerCase()},each:function(e,t,i){var o,r=0,a=e.length,s=n(e)
...
return"string"==typeof t&&(n=e[t],t=e,e=n),K.isFunction(e)?(i=z.call(arguments,2),o=function(){return e.apply(t||this,i.concat(z.call(arguments)))},o.guid=e.guid=e.guid||K.guid++,o):void 0},now:Date.now,support:J}),K.each("Boolean Number String Function Array Date RegExp Object Error".split(" "),function(e,t){V["[object "+t+"]"]=t.toLowerCase()})
var oe=function(e){function t(e,t,n,i){var o,r,a,s,l,c,u,f,h,m
if((t?t.ownerDocument||t:H)!==L&&A(t),t=t||L,n=n||[],s=t.nodeType,"string"!=typeof e||!e||1!==s&&9!==s&&11!==s)return n
if(!i&&P){if(11!==s&&(o=ye.exec(e)))if(a=o[1]){if(9===s){if(r=t.getElementById(a),!r||!r.parentNode)return n
...
if((a=o[3])&&x.getElementsByClassName)return X.apply(n,t.getElementsByClassName(a)),n}if(x.qsa&&(!O||!O.test(e))){if(f=u=R,h=t,m=1!==s&&e,1===s&&"object"!==t.nodeName.toLowerCase()){for(c=D(e),(u=t.getAttribute("id"))?f=u.replace(we,"\\$&"):t.setAttribute("id",f),f="[id='"+f+"'] ",l=c.length;l--;)c[l]=f+p(c[l])
h=be.test(e)&&d(t.parentNode)||t,m=c.join(",")}if(m)try{return X.apply(n,h.querySelectorAll(m)),n}catch(e){}finally{u||t.removeAttribute("id")}}}return k(e.replace(le,"$1"),t,n,i)}function n(){function e(n,i){return t.push(n+" ")>_.cacheLength&&delete e[t.shift()],e[n+" "]=i}var t=[]
return e}function i(e){return e[R]=!0,e}function o(e){var t=L.createElement("div")
...
return("input"===n||"button"===n)&&t.type===e}}function c(e){return i(function(t){return t=+t,i(function(n,i){for(var o,r=e([],n.length,t),a=r.length;a--;)n[o=r[a]]&&(n[o]=!(i[o]=n[o]))})})}function d(e){return e&&"undefined"!=typeof e.getElementsByTagName&&e}function u(){}function p(e){for(var t=0,n=e.length,i="";n>t;t++)i+=e[t].value
return i}function f(e,t,n){var i=t.dir,o=n&&"parentNode"===i,r=Y++
...
return a}function v(e,t,n,o,r,a){return o&&!o[R]&&(o=v(o)),r&&!r[R]&&(r=v(r,a)),i(function(i,a,s,l){var c,d,u,p=[],f=[],h=a.length,v=i||m(t||"*",s.nodeType?[s]:s,[]),y=!e||!i&&t?v:g(v,p,e,s,l),b=n?r||(i?e:h||o)?[]:a:y
if(n&&n(y,b,s,l),o)for(c=g(b,f),o(c,[],s,l),d=c.length;d--;)(u=c[d])&&(b[f[d]]=!(y[f[d]]=u))
if(i){if(r||e){if(r){for(c=[],d=b.length;d--;)(u=b[d])&&c.push(y[d]=u)
r(null,b=[],c,l)}for(d=b.length;d--;)(u=b[d])&&(c=r?ee(i,u):p[d])>-1&&(i[c]=!(a[c]=u))}}else b=g(b===a?b.splice(h,b.length):b),r?r(null,a,b,l):X.apply(a,b)})}function y(e){for(var t,n,i,o=e.length,r=_.relative[e[0].type],a=r||_.relative[" "],s=r?1:0,l=f(function(e){return e===t},a,!0),c=f(function(e){return ee(t,e)>-1},a,!0),d=[function(e,n,i){var o=!r&&(i||n!==E)||((t=n).nodeType?l(e,n,i):c(e,n,i))
return t=null,o}];o>s;s++)if(n=_.relative[e[s].type])d=[f(h(d),n)]
else{if(n=_.filter[e[s].type].apply(null,e[s].matches),n[R]){for(i=++s;o>i&&!_.relative[e[i].type];i++);return v(s>1&&h(d),s>1&&p(e.slice(0,s-1).concat({value:" "===e[s-2].type?"*":""})).replace(le,"$1"),n,i>s&&y(e.slice(s,i)),o>i&&y(e=e.slice(i)),o>i&&p(e))}d.push(n)}return h(d)}function b(e,n){var o=n.length>0,r=e.length>0,a=function(i,a,s,l,c){var d,u,p,f=0,h="0",m=i&&[],v=[],y=E,b=i||r&&_.find.TAG("*",c),w=W+=null==y?1:Math.random()||.1,x=b.length
for(c&&(E=a!==L&&a);h!==x&&null!=(d=b[h]);h++){if(r&&d){for(u=0;p=e[u++];)if(p(d,a,s)){l.push(d)
break}c&&(W=w)}o&&((d=!p&&d)&&f--,i&&m.push(d))}if(f+=h,o&&h!==f){for(u=0;p=n[u++];)p(m,v,a,s)
if(i){if(f>0)for(;h--;)m[h]||v[h]||(v[h]=J.call(l))
v=g(v)}X.apply(l,v),c&&!i&&v.length>0&&f+n.length>1&&t.uniqueSort(l)}return c&&(W=w,E=y),m}
return o?i(a):a}var w,x,_,C,S,D,T,k,E,I,M,A,L,F,P,O,N,$,j,R="sizzle"+1*new Date,H=e.document,W=0,Y=0,z=n(),q=n(),U=n(),B=function(e,t){return e===t&&(M=!0),0},V=1<<31,G={}.hasOwnProperty,Q=[],J=Q.pop,Z=Q.push,X=Q.push,K=Q.slice,ee=function(e,t){for(var n=0,i=e.length;i>n;n++)if(e[n]===t)return n
...
return i!==i||n?t:0>i?String.fromCharCode(i+65536):String.fromCharCode(i>>10|55296,1023&i|56320)},Ce=function(){A()}
try{X.apply(Q=K.call(H.childNodes),H.childNodes),Q[H.childNodes.length].nodeType}catch(e){X={apply:Q.length?function(e,t){Z.apply(e,K.call(t))}:function(e,t){for(var n=e.length,i=0;e[n++]=t[i++];);e.length=n-1}}}x=t.support={},S=t.isXML=function(e){var t=e&&(e.ownerDocument||e).documentElement
return!!t&&"HTML"!==t.nodeName},A=t.setDocument=function(e){var t,n,i=e?e.ownerDocument||e:H
return i!==L&&9===i.nodeType&&i.documentElement?(L=i,F=i.documentElement,n=i.defaultView,n&&n!==n.top&&(n.addEventListener?n.addEventListener("unload",Ce,!1):n.attachEvent&&n.attachEvent("onunload",Ce)),P=!S(i),x.attributes=o(function(e){return e.className="i",!e.getAttribute("className")}),x.getElementsByTagName=o(function(e){return e.appendChild(i.createComment("")),!e.getElementsByTagName("*").length}),x.getElementsByClassName=ve.test(i.getElementsByClassName),x.getById=o(function(e){return F.appendChild(e).id=R,!i.getElementsByName||!i.getElementsByName(R).length}),x.getById?(_.find.ID=function(e,t){if("undefined"!=typeof t.getElementById&&P){var n=t.getElementById(e)
...
return i}return r},_.find.CLASS=x.getElementsByClassName&&function(e,t){return P?t.getElementsByClassName(e):void 0},N=[],O=[],(x.qsa=ve.test(i.querySelectorAll))&&(o(function(e){F.appendChild(e).innerHTML="<a id='"+R+"'></a><select id='"+R+"-\f]' msallowcapture=''><option selected=''></option></select>",e.querySelectorAll("[msallowcapture^='']").length&&O.push("[*^$]="+ne+"*(?:''|\"\")"),e.querySelectorAll("[selected]").length||O.push("\\["+ne+"*(?:value|"+te+")"),e.querySelectorAll("[id~="+R+"-]").length||O.push("~="),e.querySelectorAll(":checked").length||O.push(":checked"),e.querySelectorAll("a#"+R+"+*").length||O.push(".#.+[+~]")}),o(function(e){var t=i.createElement("input")
t.setAttribute("type","hidden"),e.appendChild(t).setAttribute("name","D"),e.querySelectorAll("[name=d]").length&&O.push("name"+ne+"*[*^$|!~]?="),e.querySelectorAll(":enabled").length||O.push(":enabled",":disabled"),e.querySelectorAll("*,:x"),O.push(",.*:")})),(x.matchesSelector=ve.test($=F.matches||F.webkitMatchesSelector||F.mozMatchesSelector||F.oMatchesSelector||F.msMatchesSelector))&&o(function(e){x.disconnectedMatch=$.call(e,"div"),$.call(e,"[s!='']:x"),N.push("!=",ae)}),O=O.length&&new RegExp(O.join("|")),N=N.length&&new RegExp(N.join("|")),t=ve.test(F.compareDocumentPosition),j=t||ve.test(F.contains)?function(e,t){var n=9===e.nodeType?e.documentElement:e,i=t&&t.parentNode
...
return!1},B=t?function(e,t){if(e===t)return M=!0,0
var n=!e.compareDocumentPosition-!t.compareDocumentPosition
return n?n:(n=(e.ownerDocument||e)===(t.ownerDocument||t)?e.compareDocumentPosition(t):1,1&n||!x.sortDetached&&t.compareDocumentPosition(e)===n?e===i||e.ownerDocument===H&&j(H,e)?-1:t===i||t.ownerDocument===H&&j(H,t)?1:I?ee(I,e)-ee(I,t):0:4&n?-1:1)}:function(e,t){if(e===t)return M=!0,0
...
for(;l[o]===c[o];)o++
return o?a(l[o],c[o]):l[o]===H?-1:c[o]===H?1:0},i):L},t.matches=function(e,n){return t(e,null,null,n)},t.matchesSelector=function(e,n){if((e.ownerDocument||e)!==L&&A(e),n=n.replace(ue,"='$1']"),!(!x.matchesSelector||!P||N&&N.test(n)||O&&O.test(n)))try{var i=$.call(e,n)
if(i||x.disconnectedMatch||e.document&&11!==e.document.nodeType)return i}catch(e){}return t(n,L,null,[e]).length>0},t.contains=function(e,t){return(e.ownerDocument||e)!==L&&A(e),j(e,t)},t.attr=function(e,t){(e.ownerDocument||e)!==L&&A(e)
var n=_.attrHandle[t.toLowerCase()],i=n&&G.call(_.attrHandle,t.toLowerCase())?n(e,t,!P):void 0
return void 0!==i?i:x.attributes||!P?e.getAttribute(t):(i=e.getAttributeNode(t))&&i.specified?i.value:null},t.error=function(e){throw new Error("Syntax error, unrecognized expression: "+e)},t.uniqueSort=function(e){var t,n=[],i=0,o=0
if(M=!x.detectDuplicates,I=!x.sortStable&&e.slice(0),e.sort(B),M){for(;t=e[o++];)t===e[o]&&(i=n.push(o))
...
return he.CHILD.test(e[0])?null:(e[3]?e[2]=e[4]||e[5]||"":n&&pe.test(n)&&(t=D(n,!0))&&(t=n.indexOf(")",n.length-t)-n.length)&&(e[0]=e[0].slice(0,t),e[2]=n.slice(0,t)),e.slice(0,3))}},filter:{TAG:function(e){var t=e.replace(xe,_e).toLowerCase()
...
return 1===i&&0===o?function(e){return!!e.parentNode}:function(t,n,l){var c,d,u,p,f,h,m=r!==a?"nextSibling":"previousSibling",g=t.parentNode,v=s&&t.nodeName.toLowerCase(),y=!l&&!s
if(g){if(r){for(;m;){for(u=t;u=u[m];)if(s?u.nodeName.toLowerCase()===v:1===u.nodeType)return!1
h=m="only"===e&&!h&&"nextSibling"}return!0}if(h=[a?g.firstChild:g.lastChild],a&&y){for(d=g[R]||(g[R]={}),c=d[e]||[],f=c[0]===W&&c[1],p=c[0]===W&&c[2],u=f&&g.childNodes[f];u=++f&&u&&u[m]||(p=f=0)||h.pop();)if(1===u.nodeType&&++p&&u===t){d[e]=[W,f,p]
break}}else if(y&&(c=(t[R]||(t[R]={}))[e])&&c[0]===W)p=c[1]
else for(;(u=++f&&u&&u[m]||(p=f=0)||h.pop())&&((s?u.nodeName.toLowerCase()!==v:1!==u.nodeType)||!++p||(y&&((u[R]||(u[R]={}))[e]=[W,p]),u!==t)););return p-=o,p===i||p%i===0&&p/i>=0}}},PSEUDO:function(e,n){var o,r=_.pseudos[e]||_.setFilters[e.toLowerCase()]||t.error("unsupported pseudo: "+e)
...
return n&&n.slice(1)===t.id},root:function(e){return e===F},focus:function(e){return e===L.activeElement&&(!L.hasFocus||L.hasFocus())&&!!(e.type||e.href||~e.tabIndex)},enabled:function(e){return e.disabled===!1},disabled:function(e){return e.disabled===!0},checked:function(e){var t=e.nodeName.toLowerCase()
...
return u.prototype=_.filters=_.pseudos,_.setFilters=new u,D=t.tokenize=function(e,n){var i,o,r,a,s,l,c,d=q[e+" "]
if(d)return n?0:d.slice(0)
for(s=e,l=[],c=_.preFilter;s;){(!i||(o=ce.exec(s)))&&(o&&(s=s.slice(o[0].length)||s),l.push(r=[])),i=!1,(o=de.exec(s))&&(i=o.shift(),r.push({value:i,type:o[0].replace(le," ")}),s=s.slice(i.length))
for(a in _.filter)!(o=he[a].exec(s))||c[a]&&!(o=c[a](o))||(i=o.shift(),r.push({value:i,type:a,matches:o}),s=s.slice(i.length))
if(!i)break}return n?s.length:s?t.error(e):q(e,l).slice(0)},T=t.compile=function(e,t){var n,i=[],o=[],r=U[e+" "]
if(!r){for(t||(t=D(e)),n=t.length;n--;)r=y(t[n]),r[R]?i.push(r):o.push(r)
r=U(e,b(o,i)),r.selector=e}return r},k=t.select=function(e,t,n,i){var o,r,a,s,l,c="function"==typeof e&&e,u=!i&&D(e=c.selector||e)
if(n=n||[],1===u.length){if(r=u[0]=u[0].slice(0),r.length>2&&"ID"===(a=r[0]).type&&x.getById&&9===t.nodeType&&P&&_.relative[r[1].type]){if(t=(_.find.ID(a.matches[0].replace(xe,_e),t)||[])[0],!t)return n
c&&(t=t.parentNode),e=e.slice(r.shift().value.length)}for(o=he.needsContext.test(e)?0:r.length;o--&&(a=r[o],!_.relative[s=a.type]);)if((l=_.find[s])&&(i=l(a.matches[0].replace(xe,_e),be.test(r[0].type)&&d(t.parentNode)||t))){if(r.splice(o,1),e=i.length&&p(r),!e)return X.apply(n,i),n
break}}return(c||T(e,u))(i,t,!P,n,be.test(e)&&d(t.parentNode)||t),n},x.sortStable=R.split("").sort(B).join("")===R,x.detectDuplicates=!!M,A(),x.sortDetached=o(function(e){return 1&e.compareDocumentPosition(L.createElement("div"))}),o(function(e){return e.innerHTML="<a href='#'></a>","#"===e.firstChild.getAttribute("href")})||r("type|href|height|width",function(e,t,n){return n?void 0:e.getAttribute(t,"type"===t.toLowerCase()?1:2)}),x.attributes&&o(function(e){return e.innerHTML="<input/>",e.firstChild.setAttribute("value",""),""===e.firstChild.getAttribute("value")})||r("value",function(e,t,n){return n||"input"!==e.nodeName.toLowerCase()?void 0:e.defaultValue}),o(function(e){return null==e.getAttribute("disabled")})||r(te,function(e,t,n){var i
...
var le,ce=/^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/,de=K.fn.init=function(e,t){var n,i
if(!e)return this
...
if(n[1]){if(t=t instanceof K?t[0]:t,K.merge(this,K.parseHTML(n[1],t&&t.nodeType?t.ownerDocument||t:Z,!0)),ae.test(n[1])&&K.isPlainObject(t))for(n in t)K.isFunction(this[n])?this[n](t[n]):this.attr(n,t[n])
...
de.prototype=K.fn,le=K(Z)
var ue=/^(?:parents|prev(?:Until|All))/,pe={children:!0,contents:!0,next:!0,prev:!0}
...
return"Until"!==e.slice(-5)&&(i=n),i&&"string"==typeof i&&(o=K.filter(i,o)),this.length>1&&(pe[e]||K.unique(o),ue.test(e)&&o.reverse()),this.pushStack(o)}})
var fe=/\S+/g,he={}
K.Callbacks=function(e){e="string"==typeof e?he[e]||r(e):K.extend({},e)
var t,n,i,o,a,s,l=[],c=!e.once&&[],d=function(r){for(t=e.memory&&r,n=!0,s=o||0,o=0,a=l.length,i=!0;l&&a>s;s++)if(l[s].apply(r[0],r[1])===!1&&e.stopOnFalse){t=!1
break}i=!1,l&&(c?c.length&&d(c.shift()):t?l=[]:u.disable())},u={add:function(){if(l){var n=l.length
!function t(n){K.each(n,function(n,i){var o=K.type(i)
"function"===o?e.unique&&u.has(i)||l.push(i):i&&i.length&&"string"!==o&&t(i)})}(arguments),i?a=l.length:t&&(o=n,d(t))}return this},remove:function(){return l&&K.each(arguments,function(e,t){for(var n;(n=K.inArray(t,l,n))>-1;)l.splice(n,1),i&&(a>=n&&a--,s>=n&&s--)}),this},has:function(e){return e?K.inArray(e,l)>-1:!(!l||!l.length)},empty:function(){return l=[],a=0,this},disable:function(){return l=c=t=void 0,this},disabled:function(){return!l},lock:function(){return c=void 0,t||u.disable(),this},locked:function(){return!c},fireWith:function(e,t){return!l||n&&!c||(t=t||[],t=[e,t.slice?t.slice():t],i?c.push(t):d(t)),this},fire:function(){return u.fireWith(this,arguments),this},fired:function(){return!!n}}
return u},K.extend({Deferred:function(e){var t=[["resolve","done",K.Callbacks("once memory"),"resolved"],["reject","fail",K.Callbacks("once memory"),"rejected"],["notify","progress",K.Callbacks("memory")]],n="pending",i={state:function(){return n},always:function(){return o.done(arguments).fail(arguments),this},then:function(){var e=arguments
...
var Te=/^key/,ke=/^(?:mouse|pointer|contextmenu)|click/,Ee=/^(?:focusinfocus|focusoutblur)$/,Ie=/^([^.]*)(?:\.(.+)|)$/
K.event={global:{},add:function(e,t,n,i,o){var r,a,s,l,c,d,u,p,f,h,m,g=ve.get(e)
if(g)for(n.handler&&(r=n,n=r.handler,o=r.selector),n.guid||(n.guid=K.guid++),(l=g.events)||(l=g.events={}),(a=g.handle)||(a=g.handle=function(t){return typeof K!==De&&K.event.triggered!==t.type?K.event.dispatch.apply(e,arguments):void 0}),t=(t||"").match(fe)||[""],c=t.length;c--;)s=Ie.exec(t[c])||[],f=m=s[1],h=(s[2]||"").split(".").sort(),f&&(u=K.event.special[f]||{},f=(o?u.delegateType:u.bindType)||f,u=K.event.special[f]||{},d=K.extend({type:f,origType:m,data:i,handler:n,guid:n.guid,selector:o,needsContext:o&&K.expr.match.needsContext.test(o),namespace:h.join(".")},r),(p=l[f])||(p=l[f]=[],p.delegateCount=0,u.setup&&u.setup.call(e,i,h,a)!==!1||e.addEventListener&&e.addEventListener(f,a,!1)),u.add&&(u.add.call(e,d),d.handler.guid||(d.handler.guid=n.guid)),o?p.splice(p.delegateCount++,0,d):p.push(d),K.event.global[f]=!0)},remove:function(e,t,n,i,o){var r,a,s,l,c,d,u,p,f,h,m,g=ve.hasData(e)&&ve.get(e)
if(g&&(l=g.events)){for(t=(t||"").match(fe)||[""],c=t.length;c--;)if(s=Ie.exec(t[c])||[],f=m=s[1],h=(s[2]||"").split(".").sort(),f){for(u=K.event.special[f]||{},f=(i?u.delegateType:u.bindType)||f,p=l[f]||[],s=s[2]&&new RegExp("(^|\\.)"+h.join("\\.(?:.*\\.|)")+"(\\.|$)"),a=r=p.length;r--;)d=p[r],!o&&m!==d.origType||n&&n.guid!==d.guid||s&&!s.test(d.namespace)||i&&i!==d.selector&&("**"!==i||!d.selector)||(p.splice(r,1),d.selector&&p.delegateCount--,u.remove&&u.remove.call(e,d))
a&&!p.length&&(u.teardown&&u.teardown.call(e,h,g.handle)!==!1||K.removeEvent(e,f,g.handle),delete l[f])}else for(f in l)K.event.remove(e,f+t[c],n,i,!0)
K.isEmptyObject(l)&&(delete g.handle,ve.remove(e,"events"))}},trigger:function(t,n,i,o){var r,a,s,l,c,d,u,p=[i||Z],f=Q.call(t,"type")?t.type:t,h=Q.call(t,"namespace")?t.namespace.split("."):[]
if(a=s=i=i||Z,3!==i.nodeType&&8!==i.nodeType&&!Ee.test(f+K.event.triggered)&&(f.indexOf(".")>=0&&(h=f.split("."),f=h.shift(),h.sort()),c=f.indexOf(":")<0&&"on"+f,t=t[K.expando]?t:new K.Event(f,"object"==typeof t&&t),t.isTrigger=o?2:3,t.namespace=h.join("."),t.namespace_re=t.namespace?new RegExp("(^|\\.)"+h.join("\\.(?:.*\\.|)")+"(\\.|$)"):null,t.result=void 0,t.target||(t.target=i),n=null==n?[t]:K.makeArray(n,[t]),u=K.event.special[f]||{},o||!u.trigger||u.trigger.apply(i,n)!==!1)){if(!o&&!u.noBubble&&!K.isWindow(i)){for(l=u.delegateType||f,Ee.test(l+f)||(a=a.parentNode);a;a=a.parentNode)p.push(a),s=a
s===(i.ownerDocument||Z)&&p.push(s.defaultView||s.parentWindow||e)}for(r=0;(a=p[r++])&&!t.isPropagationStopped();)t.type=r>1?l:u.bindType||f,d=(ve.get(a,"events")||{})[t.type]&&ve.get(a,"handle"),d&&d.apply(a,n),d=c&&a[c],d&&d.apply&&K.acceptData(a)&&(t.result=d.apply(a,n),t.result===!1&&t.preventDefault())
return t.type=f,o||t.isDefaultPrevented()||u._default&&u._default.apply(p.pop(),n)!==!1||!K.acceptData(i)||c&&K.isFunction(i[f])&&!K.isWindow(i)&&(s=i[c],s&&(i[c]=null),K.event.triggered=f,i[f](),K.event.triggered=void 0,s&&(i[c]=s)),t.result}},dispatch:function(e){e=K.event.fix(e)
...
return e.target||(e.target=Z),3===e.target.nodeType&&(e.target=e.target.parentNode),a.filter?a.filter(e,r):e},special:{load:{noBubble:!0},focus:{trigger:function(){return this!==u()&&this.focus?(this.focus(),!1):void 0},delegateType:"focusin"},blur:{trigger:function(){return this===u()&&this.blur?(this.blur(),!1):void 0},delegateType:"focusout"},click:{trigger:function(){return"checkbox"===this.type&&this.click&&K.nodeName(this,"input")?(this.click(),!1):void 0},_default:function(e){return K.nodeName(e.target,"a")}},beforeunload:{postDispatch:function(e){void 0!==e.result&&e.originalEvent&&(e.originalEvent.returnValue=e.result)}}},simulate:function(e,t,n,i){var o=K.extend(new K.Event,n,{type:e,isSimulated:!0,originalEvent:{}})
...
return this}if(null==n&&null==i?(i=t,n=t=void 0):null==i&&("string"==typeof t?(i=n,n=void 0):(i=n,n=t,t=void 0)),i===!1)i=d
...
return this}return(t===!1||"function"==typeof t)&&(n=t,t=void 0),n===!1&&(n=d),this.each(function(){K.event.remove(this,e,n,t)})},trigger:function(e,t){return this.each(function(){K.event.trigger(e,t,this)})},triggerHandler:function(e,t){var n=this[0]
return n?K.event.trigger(e,t,n,!0):void 0}})
var Me=/<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi,Ae=/<([\w:]+)/,Le=/<|&#?\w+;/,Fe=/<(?:script|style|link)/i,Pe=/checked\s*(?:[^=]|=\s*.checked.)/i,Oe=/^$|\/(?:java|ecma)script/i,Ne=/^true\/(.*)/,$e=/^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g,je={option:[1,"<select multiple='multiple'>","</select>"],thead:[1,"<table>","</table>"],col:[2,"<table><colgroup>","</colgroup></table>"],tr:[2,"<table><tbody>","</tbody></table>"],td:[3,"<table><tbody><tr>","</tr></tbody></table>"],_default:[0,"",""]}
...
return a=v(s,"script"),a.length>0&&m(a,!l&&v(e,"script")),s},buildFragment:function(e,t,n,i){for(var o,r,a,s,l,c,d=t.createDocumentFragment(),u=[],p=0,f=e.length;f>p;p++)if(o=e[p],o||0===o)if("object"===K.type(o))K.merge(u,o.nodeType?[o]:o)
else if(Le.test(o)){for(r=r||d.appendChild(t.createElement("div")),a=(Ae.exec(o)||["",""])[1].toLowerCase(),s=je[a]||je._default,r.innerHTML=s[1]+o.replace(Me,"<$1></$2>")+s[2],c=s[0];c--;)r=r.lastChild
K.merge(u,r.childNodes),r=d.firstChild,r.textContent=""}else u.push(t.createTextNode(o))
for(d.textContent="",p=0;o=u[p++];)if((!i||-1===K.inArray(o,i))&&(l=K.contains(o.ownerDocument,o),r=v(d.appendChild(o),"script"),l&&m(r),n))for(c=0;o=r[c++];)Oe.test(o.type||"")&&n.push(o)
return d},cleanData:function(e){for(var t,n,i,o,r=K.event.special,a=0;void 0!==(n=e[a]);a++){if(K.acceptData(n)&&(o=n[ve.expando],o&&(t=ve.cache[o]))){if(t.events)for(i in t.events)r[i]?K.event.remove(n,i):K.removeEvent(n,i,t.handle)
...
if("string"==typeof e&&!Fe.test(e)&&!je[(Ae.exec(e)||["",""])[1].toLowerCase()]){e=e.replace(Me,"<$1></$2>")
...
var n,i,o,r,a,s,l=0,c=this.length,d=this,u=c-1,p=e[0],m=K.isFunction(p)
if(m||c>1&&"string"==typeof p&&!J.checkClone&&Pe.test(p))return this.each(function(n){var i=d.eq(n)
m&&(e[0]=p.call(this,n,i.html())),i.domManip(e,t)})
if(c&&(n=K.buildFragment(e,this[0].ownerDocument,!1,this),i=n.firstChild,1===n.childNodes.length&&(n=i),i)){for(o=K.map(v(n,"script"),f),r=o.length;c>l;l++)a=n,l!==u&&(a=K.clone(a,!0,!0),r&&K.merge(o,v(a,"script"))),t.call(this[l],a,l)
if(r)for(s=o[o.length-1].ownerDocument,K.map(o,h),l=0;r>l;l++)a=o[l],Oe.test(a.type||"")&&!ve.access(a,"globalEval")&&K.contains(s,a)&&(a.src?K._evalUrl&&K._evalUrl(a.src):K.globalEval(a.textContent.replace($e,"")))}return this}}),K.each({appendTo:"append",prependTo:"prepend",insertBefore:"before",insertAfter:"after",replaceAll:"replaceWith"},function(e,t){K.fn[e]=function(e){for(var n,i=[],o=K(e),r=o.length-1,a=0;r>=a;a++)n=a===r?this:this.clone(!0),K(o[a])[t](n),U.apply(i,n.get())
return this.pushStack(i)}})
var Re,He={},We=/^margin/,Ye=new RegExp("^("+xe+")(?!px)[a-z%]+$","i"),ze=function(t){return t.ownerDocument.defaultView.opener?t.ownerDocument.defaultView.getComputedStyle(t,null):e.getComputedStyle(t,null)}
...
return t=K.cssProps[s]||(K.cssProps[s]=C(e.style,s)),a=K.cssHooks[t]||K.cssHooks[s],a&&"get"in a&&(o=a.get(e,!0,n)),void 0===o&&(o=x(e,t,i)),"normal"===o&&t in Ge&&(o=Ge[t]),""===n||n?(r=parseFloat(o),n===!0||K.isNumeric(r)?r||0:o):o}}),K.each(["height","width"],function(e,t){K.cssHooks[t]={get:function(e,n,i){return n?qe.test(K.css(e,"display"))&&0===e.offsetWidth?K.swap(e,Ve,function(){return T(e,t,i)}):T(e,t,i):void 0},set:function(e,n,i){var o=i&&ze(e)
...
var Je,Ze,Xe=/^(?:toggle|show|hide)$/,Ke=new RegExp("^(?:([+-])=|)("+xe+")([a-z%]*)$","i"),et=/queueHooks$/,tt=[L],nt={"*":[function(e,t){var n=this.createTween(e,t),i=n.cur(),o=Ke.exec(t),r=o&&o[3]||(K.cssNumber[e]?"":"px"),a=(K.cssNumber[e]||"px"!==r&&+i)&&Ke.exec(K.css(n.elem,e)),s=1,l=20
...
K.Animation=K.extend(P,{tweener:function(e,t){K.isFunction(e)?(t=e,e=["*"]):e=e.split(" ")
...
K.fn[t]=function(e,i,o){return null==e||"boolean"==typeof e?n.apply(this,arguments):this.animate(M(t,!0),e,i,o)}}),K.each({slideDown:M("show"),slideUp:M("hide"),slideToggle:M("toggle"),fadeIn:{opacity:"show"},fadeOut:{opacity:"hide"},fadeToggle:{opacity:"toggle"}},function(e,t){K.fn[e]=function(e,n,i){return this.animate(t,e,n,i)}}),K.timers=[],K.fx.tick=function(){var e,t=0,n=K.timers
for(Je=K.now();t<n.length;t++)e=n[t],e()||n[t]!==e||n.splice(t--,1)
n.length||K.fx.stop(),Je=void 0},K.fx.timer=function(e){K.timers.push(e),e()?K.fx.start():K.timers.pop()},K.fx.interval=13,K.fx.start=function(){Ze||(Ze=setInterval(K.fx.tick,K.fx.interval))},K.fx.stop=function(){clearInterval(Ze),Ze=null},K.fx.speeds={slow:600,fast:200,_default:400},K.fn.delay=function(e,t){return e=K.fx?K.fx.speeds[e]||e:e,t=t||"fx",this.queue(t,function(t,n){var i=setTimeout(t,e)
n.stop=function(){clearTimeout(i)}})},function(){var e=Z.createElement("input"),t=Z.createElement("select"),n=t.appendChild(Z.createElement("option"))
e.type="checkbox",J.checkOn=""!==e.value,J.optSelected=n.selected,t.disabled=!0,J.optDisabled=!n.disabled,e=Z.createElement("input"),e.value="t",e.type="radio",J.radioValue="t"===e.value}()
...
K.extend({active:0,lastModified:{},etag:{},ajaxSettings:{url:xt,type:"GET",isLocal:ht.test(_t[1]),global:!0,processData:!0,async:!0,contentType:"application/x-www-form-urlencoded; charset=UTF-8",accepts:{"*":wt,text:"text/plain",html:"text/html",xml:"application/xml, text/xml",json:"application/json, text/javascript"},contents:{xml:/xml/,html:/html/,json:/json/},responseFields:{xml:"responseXML",text:"responseText",json:"responseJSON"},converters:{"* text":String,"text html":!0,"text json":K.parseJSON,"text xml":K.parseXML},flatOptions:{url:!0,context:!0}},ajaxSetup:function(e,t){return t?$($(e,K.ajaxSettings),t):$(K.ajaxSettings,e)},ajaxPrefilter:O(yt),ajaxTransport:O(bt),ajax:function(e,t){function n(e,t,n,a){var l,d,v,y,w,_=t
2!==b&&(b=2,s&&clearTimeout(s),i=void 0,r=a||"",x.readyState=e>0?4:0,l=e>=200&&300>e||304===e,n&&(y=j(u,x,n)),y=R(u,y,x,l),l?(u.ifModified&&(w=x.getResponseHeader("Last-Modified"),w&&(K.lastModified[o]=w),w=x.getResponseHeader("etag"),w&&(K.etag[o]=w)),204===e||"HEAD"===u.type?_="nocontent":304===e?_="notmodified":(_=y.state,d=y.data,v=y.error,l=!v)):(v=_,(e||!_)&&(_="error",0>e&&(e=0))),x.status=e,x.statusText=(t||_)+"",l?h.resolveWith(p,[d,_,x]):h.rejectWith(p,[x,_,v]),x.statusCode(g),g=void 0,c&&f.trigger(l?"ajaxSuccess":"ajaxError",[x,u,l?d:v]),m.fireWith(p,[x,_]),c&&(f.trigger("ajaxComplete",[x,u]),--K.active||K.event.trigger("ajaxStop")))}"object"==typeof e&&(t=e,e=void 0),t=t||{}
var i,o,r,a,s,l,c,d,u=K.ajaxSetup({},t),p=u.context||u,f=u.context&&(p.nodeType||p.jquery)?K(p):K.event,h=K.Deferred(),m=K.Callbacks("once memory"),g=u.statusCode||{},v={},y={},b=0,w="canceled",x={readyState:0,getResponseHeader:function(e){var t
...
return b||(e=y[n]=y[n]||e,v[e]=t),this},overrideMimeType:function(e){return b||(u.mimeType=e),this},statusCode:function(e){var t
if(e)if(2>b)for(t in e)g[t]=[g[t],e[t]]
else x.always(e[x.status])
return this},abort:function(e){var t=e||w
return i&&i.abort(t),n(0,t),this}}
if(h.promise(x).complete=m.add,x.success=x.done,x.error=x.fail,u.url=((e||u.url||xt)+"").replace(ut,"").replace(gt,_t[1]+"//"),u.type=t.method||t.type||u.method||u.type,u.dataTypes=K.trim(u.dataType||"*").toLowerCase().match(fe)||[""],null==u.crossDomain&&(l=vt.exec(u.url.toLowerCase()),u.crossDomain=!(!l||l[1]===_t[1]&&l[2]===_t[2]&&(l[3]||("http:"===l[1]?"80":"443"))===(_t[3]||("http:"===_t[1]?"80":"443")))),u.data&&u.processData&&"string"!=typeof u.data&&(u.data=K.param(u.data,u.traditional)),N(yt,u,t,x),2===b)return x
c=K.event&&u.global,c&&0===K.active++&&K.event.trigger("ajaxStart"),u.type=u.type.toUpperCase(),u.hasContent=!mt.test(u.type),o=u.url,u.hasContent||(u.data&&(o=u.url+=(dt.test(o)?"&":"?")+u.data,delete u.data),u.cache===!1&&(u.url=pt.test(o)?o.replace(pt,"$1_="+ct++):o+(dt.test(o)?"&":"?")+"_="+ct++)),u.ifModified&&(K.lastModified[o]&&x.setRequestHeader("If-Modified-Since",K.lastModified[o]),K.etag[o]&&x.setRequestHeader("If-None-Match",K.etag[o])),(u.data&&u.hasContent&&u.contentType!==!1||t.contentType)&&x.setRequestHeader("Content-Type",u.contentType),x.setRequestHeader("Accept",u.dataTypes[0]&&u.accepts[u.dataTypes[0]]?u.accepts[u.dataTypes[0]]+("*"!==u.dataTypes[0]?", "+wt+"; q=0.01":""):u.accepts["*"])
...
if(i=N(bt,u,t,x)){x.readyState=1,c&&f.trigger("ajaxSend",[x,u]),u.async&&u.timeout>0&&(s=setTimeout(function(){x.abort("timeout")},u.timeout))
...
var Et=0,It={},Mt={0:200,1223:204},At=K.ajaxSettings.xhr()
e.attachEvent&&e.attachEvent("onunload",function(){for(var e in It)It[e]()}),J.cors=!!At&&"withCredentials"in At,J.ajax=At=!!At,K.ajaxTransport(function(e){var t
return J.cors||At&&!e.crossDomain?{send:function(n,i){var o,r=e.xhr(),a=++Et
if(r.open(e.type,e.url,e.async,e.username,e.password),e.xhrFields)for(o in e.xhrFields)r[o]=e.xhrFields[o]
e.mimeType&&r.overrideMimeType&&r.overrideMimeType(e.mimeType),e.crossDomain||n["X-Requested-With"]||(n["X-Requested-With"]="XMLHttpRequest")
for(o in n)r.setRequestHeader(o,n[o])
t=function(e){return function(){t&&(delete It[a],t=r.onload=r.onerror=null,"abort"===e?r.abort():"error"===e?i(r.status,r.statusText):i(Mt[r.status]||r.status,r.statusText,"string"==typeof r.responseText?{text:r.responseText}:void 0,r.getAllResponseHeaders()))}},r.onload=t(),r.onerror=t("error"),t=It[a]=t("abort")
...
return{send:function(i,o){t=K("<script>").prop({async:!0,charset:e.scriptCharset,src:e.url}).on("load error",n=function(e){t.remove(),n=null,e&&o("error"===e.type?404:200,e.type)}),Z.head.appendChild(t[0])},abort:function(){n&&n()}}}})
var Lt=[],Ft=/(=)\?(?=&|$)|\?\?/
K.ajaxSetup({jsonp:"callback",jsonpCallback:function(){var e=Lt.pop()||K.expando+"_"+ct++
return this[e]=!0,e}}),K.ajaxPrefilter("json jsonp",function(t,n,i){var o,r,a,s=t.jsonp!==!1&&(Ft.test(t.url)?"url":"string"==typeof t.data&&!(t.contentType||"").indexOf("application/x-www-form-urlencoded")&&Ft.test(t.data)&&"data")
return s||"jsonp"===t.dataTypes[0]?(o=t.jsonpCallback=K.isFunction(t.jsonpCallback)?t.jsonpCallback():t.jsonpCallback,s?t[s]=t[s].replace(Ft,"$1"+o):t.jsonp!==!1&&(t.url+=(dt.test(t.url)?"&":"?")+t.jsonp+"="+o),t.converters["script json"]=function(){return a||K.error(o+" was not called"),a[0]},t.dataTypes[0]="json",r=e[o],e[o]=function(){a=arguments},i.always(function(){e[o]=r,t[o]&&(t.jsonpCallback=n.jsonpCallback,Lt.push(o)),a&&K.isFunction(r)&&r(a[0]),a=r=void 0}),"script"):void 0}),K.parseHTML=function(e,t,n){if(!e||"string"!=typeof e)return null
"boolean"==typeof t&&(n=t,t=!1),t=t||Z
var i=ae.exec(e),o=!n&&[]
return i?[t.createElement(i[1])]:(i=K.buildFragment([e],t,o),o&&o.length&&K(o).remove(),K.merge([],i.childNodes))}
var Pt=K.fn.load
K.fn.load=function(e,t,n){if("string"!=typeof e&&Pt)return Pt.apply(this,arguments)
...
K.offset={setOffset:function(e,t,n){var i,o,r,a,s,l,c,d=K.css(e,"position"),u=K(e),p={}
"static"===d&&(e.style.position="relative"),s=u.offset(),r=K.css(e,"top"),l=K.css(e,"left"),c=("absolute"===d||"fixed"===d)&&(r+l).indexOf("auto")>-1,c?(i=u.position(),a=i.top,o=i.left):(a=parseFloat(r)||0,o=parseFloat(l)||0),K.isFunction(t)&&(t=t.call(e,n,s)),null!=t.top&&(p.top=t.top-s.top+a),null!=t.left&&(p.left=t.left-s.left+o),"using"in t?t.using.call(e,p):u.css(p)}},K.fn.extend({offset:function(e){if(arguments.length)return void 0===e?this:this.each(function(t){K.offset.setOffset(this,e,t)})
var t,n,i=this[0],o={top:0,left:0},r=i&&i.ownerDocument
return r?(t=r.documentElement,K.contains(t,i)?(typeof i.getBoundingClientRect!==De&&(o=i.getBoundingClientRect()),n=W(r),{top:o.top+n.pageYOffset-t.clientTop,left:o.left+n.pageXOffset-t.clientLeft}):o):void 0},position:function(){if(this[0]){var e,t,n=this[0],i={top:0,left:0}
return"fixed"===K.css(n,"position")?t=n.getBoundingClientRect():(e=this.offsetParent(),t=this.offset(),K.nodeName(e[0],"html")||(i=e.offset()),i.top+=K.css(e[0],"borderTopWidth",!0),i.left+=K.css(e[0],"borderLeftWidth",!0)),{top:t.top-i.top-K.css(n,"marginTop",!0),left:t.left-i.left-K.css(n,"marginLeft",!0)}}},offsetParent:function(){return this.map(function(){for(var e=this.offsetParent||Ot;e&&!K.nodeName(e,"html")&&"static"===K.css(e,"position");)e=e.offsetParent
return e||Ot})}}),K.each({scrollLeft:"pageXOffset",scrollTop:"pageYOffset"},function(t,n){var i="pageYOffset"===n
...
var Nt=e.jQuery,$t=e.$
return K.noConflict=function(t){return e.$===K&&(e.$=$t),t&&e.jQuery===K&&(e.jQuery=Nt),K},typeof t===De&&(e.jQuery=e.$=K),K}),function(e,t){"object"==typeof exports&&"undefined"!=typeof module?module.exports=t():"function"==typeof define&&define.amd?define(t):e.moment=t()}(this,function(){"use strict"
...
return l(t,"toString")&&(e.toString=t.toString),l(t,"valueOf")&&(e.valueOf=t.valueOf),e}function d(e,t,n,i){return vt(e,t,n,i,!0).utc()}function u(){return{empty:!1,unusedTokens:[],unusedInput:[],overflow:-2,charsLeftOver:0,nullInput:!1,invalidMonth:null,invalidFormat:!1,userInvalidated:!1,iso:!1,parsedDateParts:[],meridiem:null}}function p(e){return null==e._pf&&(e._pf=u()),e._pf}function f(e){if(null==e._isValid){var t=p(e),n=vi.call(t.parsedDateParts,function(e){return null!=e}),i=!isNaN(e._d.getTime())&&t.overflow<0&&!t.empty&&!t.invalidMonth&&!t.invalidWeekday&&!t.nullInput&&!t.invalidFormat&&!t.userInvalidated&&(!t.meridiem||t.meridiem&&n)
if(e._strict&&(i=i&&0===t.charsLeftOver&&0===t.unusedTokens.length&&void 0===t.bigHour),null!=Object.isFrozen&&Object.isFrozen(e))return i
e._isValid=i}return e._isValid}function h(e){var t=d(NaN)
...
return D(i)?i.call(t,n):i}function M(e){var t=this._longDateFormat[e],n=this._longDateFormat[e.toUpperCase()]
return t||!n?t:(this._longDateFormat[e]=n.replace(/MMMM|MM|DD|dddd/g,function(e){return e.slice(1)}),this._longDateFormat[e])}function A(){return this._invalidDate}function L(e){return this._ordinal.replace("%d",e)}function F(e,t,n,i){var o=this._relativeTime[n]
return D(o)?o(e,t,n,i):o.replace(/%d/i,e)}function P(e,t){var n=this._relativeTime[e>0?"future":"past"]
return D(n)?n(t):n.replace(/%s/i,t)}function O(e,t){var n=e.toLowerCase()
Mi[n]=Mi[n+"s"]=Mi[t]=e}function N(e){return"string"==typeof e?Mi[e]||Mi[e.toLowerCase()]:void 0}function $(e){var t,n,i={}
for(n in e)l(e,n)&&(t=N(n),t&&(i[t]=e[n]))
return i}function j(e,t){Ai[e]=t}function R(e){var t=[]
for(var n in e)t.push({unit:n,priority:Ai[n]})
return t.sort(function(e,t){return e.priority-t.priority}),t}function H(t,n){return function(i){return null!=i?(Y(this,t,i),e.updateOffset(this,n),this):W(this,t)}}function W(e,t){return e.isValid()?e._d["get"+(e._isUTC?"UTC":"")+t]():NaN}function Y(e,t,n){e.isValid()&&e._d["set"+(e._isUTC?"UTC":"")+t](n)}function z(e){return e=N(e),D(this[e])?this[e]():this}function q(e,t){if("object"==typeof e){e=$(e)
for(var n=R(e),i=0;i<n.length;i++)this[n[i].unit](e[n[i].unit])}else if(e=N(e),D(this[e]))return this[e](t)
...
"string"==typeof i&&(o=function(){return this[i]()}),e&&(Oi[e]=o),t&&(Oi[t[0]]=function(){return U(o.apply(this,arguments),t[1],t[2])}),n&&(Oi[n]=function(){return this.localeData().ordinal(o.apply(this,arguments),e)})}function V(e){return e.match(/\[[\s\S]/)?e.replace(/^\[|\]$/g,""):e.replace(/\\/g,"")}function G(e){var t,n,i=e.match(Li)
...
return r}}function Q(e,t){return e.isValid()?(t=J(t,e.localeData()),Pi[t]=Pi[t]||G(t),Pi[t](e)):e.localeData().invalidDate()}function J(e,t){function n(e){return t.longDateFormat(e)||e}var i=5
for(Fi.lastIndex=0;i>=0&&Fi.test(e);)e=e.replace(Fi,n),Fi.lastIndex=0,i-=1
return e}function Z(e,t,n){Ki[e]=D(t)?t:function(e,i){return e&&n?n:t}}function X(e,t){return l(Ki,e)?Ki[e](t._strict,t._locale):new RegExp(K(e))}function K(e){return ee(e.replace("\\","").replace(/\\(\[)|\\(\])|\[([^\]\[]*)\]|\\(.)/g,function(e,t,n,i,o){return t||n||i||o}))}function ee(e){return e.replace(/[-\/\\^$*+?.()|[\]{}]/g,"\\$&")}function te(e,t){var n,i=t
...
if(!this._monthsParse)for(this._monthsParse=[],this._longMonthsParse=[],this._shortMonthsParse=[],i=0;i<12;++i)r=d([2e3,i]),this._shortMonthsParse[i]=this.monthsShort(r,"").toLocaleLowerCase(),this._longMonthsParse[i]=this.months(r,"").toLocaleLowerCase()
...
for(this._monthsParse||(this._monthsParse=[],this._longMonthsParse=[],this._shortMonthsParse=[]),i=0;i<12;i++){if(o=d([2e3,i]),n&&!this._longMonthsParse[i]&&(this._longMonthsParse[i]=new RegExp("^"+this.months(o,"").replace(".","")+"$","i"),this._shortMonthsParse[i]=new RegExp("^"+this.monthsShort(o,"").replace(".","")+"$","i")),n||this._monthsParse[i]||(r="^"+this.months(o,"")+"|^"+this.monthsShort(o,""),this._monthsParse[i]=new RegExp(r.replace(".",""),"i")),n&&"MMMM"===t&&this._longMonthsParse[i].test(e))return i
...
return n=Math.min(e.date(),oe(e.year(),t)),e._d["set"+(e._isUTC?"UTC":"")+"Month"](t,n),e}function de(t){return null!=t?(ce(this,t),e.updateOffset(this,!0),this):W(this,"Month")}function ue(){return oe(this.year(),this.month())}function pe(e){return this._monthsParseExact?(l(this,"_monthsRegex")||he.call(this),e?this._monthsShortStrictRegex:this._monthsShortRegex):(l(this,"_monthsShortRegex")||(this._monthsShortRegex=mo),this._monthsShortStrictRegex&&e?this._monthsShortStrictRegex:this._monthsShortRegex)}function fe(e){return this._monthsParseExact?(l(this,"_monthsRegex")||he.call(this),e?this._monthsStrictRegex:this._monthsRegex):(l(this,"_monthsRegex")||(this._monthsRegex=go),this._monthsStrictRegex&&e?this._monthsStrictRegex:this._monthsRegex)}function he(){function e(e,t){return t.length-e.length}var t,n,i=[],o=[],r=[]
for(t=0;t<12;t++)n=d([2e3,t]),i.push(this.monthsShort(n,"")),o.push(this.months(n,"")),r.push(this.months(n,"")),r.push(this.monthsShort(n,""))
...
return null==e?t:this.add(7*(e-t),"d")}function Ie(e,t){return"string"!=typeof e?e:isNaN(e)?(e=t.weekdaysParse(e),"number"==typeof e?e:null):parseInt(e,10)}function Me(e,t){return"string"==typeof e?t.weekdaysParse(e)%7||7:isNaN(e)?null:e}function Ae(e,t){return e?n(this._weekdays)?this._weekdays[e.day()]:this._weekdays[this._weekdays.isFormat.test(t)?"format":"standalone"][e.day()]:this._weekdays}function Le(e){return e?this._weekdaysShort[e.day()]:this._weekdaysShort}function Fe(e){return e?this._weekdaysMin[e.day()]:this._weekdaysMin}function Pe(e,t,n){var i,o,r,a=e.toLocaleLowerCase()
...
return this.day(this.day()%7?t:t-7)}return this.day()||7}function Re(e){return this._weekdaysParseExact?(l(this,"_weekdaysRegex")||Ye.call(this),e?this._weekdaysStrictRegex:this._weekdaysRegex):(l(this,"_weekdaysRegex")||(this._weekdaysRegex=_o),this._weekdaysStrictRegex&&e?this._weekdaysStrictRegex:this._weekdaysRegex)}function He(e){return this._weekdaysParseExact?(l(this,"_weekdaysRegex")||Ye.call(this),e?this._weekdaysShortStrictRegex:this._weekdaysShortRegex):(l(this,"_weekdaysShortRegex")||(this._weekdaysShortRegex=Co),this._weekdaysShortStrictRegex&&e?this._weekdaysShortStrictRegex:this._weekdaysShortRegex)}function We(e){return this._weekdaysParseExact?(l(this,"_weekdaysRegex")||Ye.call(this),e?this._weekdaysMinStrictRegex:this._weekdaysMinRegex):(l(this,"_weekdaysMinRegex")||(this._weekdaysMinRegex=So),this._weekdaysMinStrictRegex&&e?this._weekdaysMinStrictRegex:this._weekdaysMinRegex)}function Ye(){function e(e,t){return t.length-e.length}var t,n,i,o,r,a=[],s=[],l=[],c=[]
for(t=0;t<7;t++)n=d([2e3,1]).day(t),i=this.weekdaysMin(n,""),o=this.weekdaysShort(n,""),r=this.weekdays(n,""),a.push(i),s.push(o),l.push(r),c.push(i),c.push(o),c.push(r)
for(a.sort(e),s.sort(e),l.sort(e),c.sort(e),t=0;t<7;t++)s[t]=ee(s[t]),l[t]=ee(l[t]),c[t]=ee(c[t])
this._weekdaysRegex=new RegExp("^("+c.join("|")+")","i"),this._weekdaysShortRegex=this._weekdaysRegex,this._weekdaysMinRegex=this._weekdaysRegex,this._weekdaysStrictRegex=new RegExp("^("+l.join("|")+")","i"),this._weekdaysShortStrictRegex=new RegExp("^("+s.join("|")+")","i"),this._weekdaysMinStrictRegex=new RegExp("^("+a.join("|")+")","i")}function ze(){return this.hours()%12||12}function qe(){return this.hours()||24}function Ue(e,t){B(e,0,0,function(){return this.localeData().meridiem(this.hours(),this.minutes(),t)})}function Be(e,t){return t._meridiemParse}function Ve(e){return"p"===(e+"").toLowerCase().charAt(0)}function Ge(e,t,n){return e>11?n?"pm":"PM":n?"am":"AM"}function Qe(e){return e?e.toLowerCase().replace("_","-"):e}function Je(e){for(var t,n,i,o,r=0;r<e.length;){for(o=Qe(e[r]).split("-"),t=o.length,n=Qe(e[r+1]),n=n?n.split("-"):null;t>0;){if(i=Ze(o.slice(0,t).join("-")))return i
if(n&&n.length>=t&&x(o,n,!0)>=t-1)break
t--}r++}return null}function Ze(e){var t=null
if(!Io[e]&&"undefined"!=typeof module&&module&&module.exports)try{t=Do._abbr,require("./locale/"+e),Xe(t)}catch(e){}return Io[e]}function Xe(e,t){var n
...
else if(null!=t.parentLocale){if(null==Io[t.parentLocale])return Mo[t.parentLocale]||(Mo[t.parentLocale]=[]),Mo[t.parentLocale].push({name:e,config:t}),null
n=Io[t.parentLocale]._config}return Io[e]=new E(k(n,t)),Mo[e]&&Mo[e].forEach(function(e){Ke(e.name,e.config)}),Xe(e),Io[e]}return delete Io[e],null}function et(e,t){if(null!=t){var n,i=Eo
null!=Io[e]&&(i=Io[e]._config),t=k(i,t),n=new E(t),n.parentLocale=Io[e],Io[e]=n,Xe(e)}else null!=Io[e]&&(null!=Io[e].parentLocale?Io[e]=Io[e].parentLocale:null!=Io[e]&&delete Io[e])
...
return n&&p(e).overflow===-2&&(t=n[no]<0||n[no]>11?no:n[io]<1||n[io]>oe(n[to],n[no])?io:n[oo]<0||n[oo]>24||24===n[oo]&&(0!==n[ro]||0!==n[ao]||0!==n[so])?oo:n[ro]<0||n[ro]>59?ro:n[ao]<0||n[ao]>59?ao:n[so]<0||n[so]>999?so:-1,p(e)._overflowDayOfYear&&(t<to||t>io)&&(t=io),p(e)._overflowWeeks&&t===-1&&(t=lo),p(e)._overflowWeekday&&t===-1&&(t=co),p(e).overflow=t),e}function ot(e){var t,n,i,o,r,a,s=e._i,l=Ao.exec(s)||Lo.exec(s)
if(l){for(p(e).iso=!0,t=0,n=Po.length;t<n;t++)if(Po[t][1].exec(l[1])){o=Po[t][0],i=Po[t][2]!==!1
break}if(null==o)return void(e._isValid=!1)
if(l[3]){for(t=0,n=Oo.length;t<n;t++)if(Oo[t][1].exec(l[3])){r=(l[2]||" ")+Oo[t][0]
break}if(null==r)return void(e._isValid=!1)}if(!i&&null!=r)return void(e._isValid=!1)
if(l[4]){if(!Fo.exec(l[4]))return void(e._isValid=!1)
a="Z"}e._f=o+(r||"")+(a||""),dt(e)}else e._isValid=!1}function rt(t){var n=No.exec(t._i)
...
var c=_e(yt(),r,a)
n=at(t.gg,e._a[to],c.year),i=at(t.w,c.week),null!=t.d?(o=t.d,(o<0||o>6)&&(l=!0)):null!=t.e?(o=t.e+r,(t.e<0||t.e>6)&&(l=!0)):o=r}i<1||i>Ce(n,r,a)?p(e)._overflowWeeks=!0:null!=l?p(e)._overflowWeekday=!0:(s=xe(n,i,o,r,a),e._a[to]=s.year,e._dayOfYear=s.dayOfYear)}function dt(t){if(t._f===e.ISO_8601)return void ot(t)
t._a=[],p(t).empty=!0
var n,i,o,r,a,s=""+t._i,l=s.length,c=0
for(o=J(t._f,t._locale).match(Li)||[],n=0;n<o.length;n++)r=o[n],i=(s.match(X(r,t))||[])[0],i&&(a=s.substr(0,s.indexOf(i)),a.length>0&&p(t).unusedInput.push(a),s=s.slice(s.indexOf(i)+i.length),c+=i.length),Oi[r]?(i?p(t).empty=!1:p(t).unusedTokens.push(r),ie(r,i,t)):t._strict&&!i&&p(t).unusedTokens.push(r)
p(t).charsLeftOver=l-c,s.length>0&&p(t).unusedInput.push(s),t._a[oo]<=12&&p(t).bigHour===!0&&t._a[oo]>0&&(p(t).bigHour=void 0),p(t).parsedDateParts=t._a.slice(0),p(t).meridiem=t._meridiem,t._a[oo]=ut(t._locale,t._a[oo],t._meridiem),lt(t),it(t)}function ut(e,t,n){var i
...
for(o=0;o<e._f.length;o++)r=0,t=g({},e),null!=e._useUTC&&(t._useUTC=e._useUTC),t._f=e._f[o],dt(t),f(t)&&(r+=p(t).charsLeftOver,r+=10*p(t).unusedTokens.length,p(t).score=r,(null==i||r<i)&&(i=r,n=t))
...
return e._locale=e._locale||tt(e._l),null===t||void 0===i&&""===t?h({nullInput:!0}):("string"==typeof t&&(e._i=t=e._locale.preparse(t)),y(t)?new v(it(t)):(a(t)?e._d=t:n(i)?pt(e):i?dt(e):gt(e),f(e)||(e._d=null),e))}function gt(t){var i=t._i
...
return bt("isAfter",e)}function _t(e){var t=$(e),n=t.year||0,i=t.quarter||0,o=t.month||0,r=t.week||0,a=t.day||0,s=t.hour||0,l=t.minute||0,c=t.second||0,d=t.millisecond||0
this._milliseconds=+d+1e3*c+6e4*l+1e3*s*60*60,this._days=+a+7*r,this._months=+o+3*i+12*n,this._data={},this._locale=tt(),this._bubble()}function Ct(e){return e instanceof _t}function St(e){return e<0?Math.round(-1*e)*-1:Math.round(e)}function Dt(e,t){B(e,0,0,function(){var e=this.utcOffset(),n="+"
return e<0&&(e=-e,n="-"),n+U(~~(e/60),2)+t+U(~~e%60,2)})}function Tt(e,t){var n=(t||"").match(e)
...
if(null!=t){if("string"==typeof t){if(t=Tt(Ji,t),null===t)return this}else Math.abs(t)<16&&(t*=60)
return!this._isUTC&&n&&(i=Et(this)),this._offset=t,this._isUTC=!0,null!=i&&this.add(i,"m"),o!==t&&(!n||this._changeInProgress?Ut(this,Ht(t-o,"m"),1,!1):this._changeInProgress||(this._changeInProgress=!0,e.updateOffset(this,!0),this._changeInProgress=null)),this}return this._isUTC?o:Et(this)}function Mt(e,t){return null!=e?("string"!=typeof e&&(e=-e),this.utcOffset(e,t),this):-this.utcOffset()}function At(e){return this.utcOffset(0,e)}function Lt(e){return this._isUTC&&(this.utcOffset(0,e),this._isUTC=!1,e&&this.subtract(Et(this),"m")),this}function Ft(){if(null!=this._tzm)this.utcOffset(this._tzm)
else if("string"==typeof this._i){var e=Tt(Qi,this._i)
null!=e?this.utcOffset(e):this.utcOffset(0,!0)}return this}function Pt(e){return!!this.isValid()&&(e=e?yt(e).utcOffset():0,(this.utcOffset()-e)%60===0)}function Ot(){return this.utcOffset()>this.clone().month(0).utcOffset()||this.utcOffset()>this.clone().month(5).utcOffset()}function Nt(){if(!m(this._isDSTShifted))return this._isDSTShifted
var e={}
if(g(e,this),e=mt(e),e._a){var t=e._isUTC?d(e._a):yt(e._a)
...
return Ct(e)?a={ms:e._milliseconds,d:e._days,M:e._months}:r(e)?(a={},t?a[t]=e:a.milliseconds=e):(s=Wo.exec(e))?(n="-"===s[1]?-1:1,a={y:0,d:w(s[io])*n,h:w(s[oo])*n,m:w(s[ro])*n,s:w(s[ao])*n,ms:w(St(1e3*s[so]))*n}):(s=Yo.exec(e))?(n="-"===s[1]?-1:1,a={y:Wt(s[2],n),M:Wt(s[3],n),w:Wt(s[4],n),d:Wt(s[5],n),h:Wt(s[6],n),m:Wt(s[7],n),s:Wt(s[8],n)}):null==a?a={}:"object"==typeof a&&("from"in a||"to"in a)&&(o=zt(yt(a.from),yt(a.to)),a={},a.ms=o.milliseconds,a.M=o.months),i=new _t(a),Ct(e)&&l(e,"_locale")&&(i._locale=e._locale),i}function Wt(e,t){var n=e&&parseFloat(e.replace(",","."))
...
return e.isValid()&&t.isValid()?(t=kt(t,e),e.isBefore(t)?n=Yt(e,t):(n=Yt(t,e),n.milliseconds=-n.milliseconds,n.months=-n.months),n):{milliseconds:0,months:0}}function qt(e,t){return function(n,i){var o,r
...
t.isValid()&&(o=null==o||o,r&&t._d.setTime(t._d.valueOf()+r*i),a&&Y(t,"Date",W(t,"Date")+a*i),s&&ce(t,W(t,"Month")+s*i),o&&e.updateOffset(t,a||s))}function Bt(e,t){var n=e.diff(t,"days",!0)
...
return!(!this.isValid()||!n.isValid())&&(t=N(m(t)?"millisecond":t),"millisecond"===t?this.valueOf()<n.valueOf():this.clone().endOf(t).valueOf()<n.valueOf())}function Zt(e,t,n,i){return i=i||"()",("("===i[0]?this.isAfter(e,n):!this.isBefore(e,n))&&(")"===i[1]?this.isBefore(t,n):!this.isAfter(t,n))}function Xt(e,t){var n,i=y(e)?e:yt(e)
...
var n=Q(this,t)
return this.localeData().postformat(n)}function ln(e,t){return this.isValid()&&(y(e)&&e.isValid()||yt(e).isValid())?Ht({to:this,from:e}).locale(this.locale()).humanize(!t):this.localeData().invalidDate()}function cn(e){return this.from(yt(),e)}function dn(e,t){return this.isValid()&&(y(e)&&e.isValid()||yt(e).isValid())?Ht({from:this,to:e}).locale(this.locale()).humanize(!t):this.localeData().invalidDate()}function un(e){return this.to(yt(),e)}function pn(e){var t
...
return{years:e.year(),months:e.month(),date:e.date(),hours:e.hours(),minutes:e.minutes(),seconds:e.seconds(),milliseconds:e.milliseconds()}}function xn(){return this.isValid()?this.toISOString():null}function _n(){return f(this)}function Cn(){return c({},p(this))}function Sn(){return p(this).overflow}function Dn(){return{input:this._i,format:this._f,locale:this._locale,isUTC:this._isUTC,strict:this._strict}}function Tn(e,t){B(0,[e,e.length],0,t)}function kn(e){return An.call(this,e,this.week(),this.weekday(),this.localeData()._week.dow,this.localeData()._week.doy)}function En(e){return An.call(this,e,this.isoWeek(),this.isoWeekday(),1,4)}function In(){return Ce(this.year(),1,4)}function Mn(){var e=this.localeData()._week
return Ce(this.year(),e.dow,e.doy)}function An(e,t,n,i,o){var r
return null==e?_e(this,i,o).year:(r=Ce(e,i,o),t>r&&(t=r),Ln.call(this,e,t,n,i,o))}function Ln(e,t,n,i,o){var r=xe(e,t,n,i,o),a=be(r.year,0,r.dayOfYear)
return this.year(a.getUTCFullYear()),this.month(a.getUTCMonth()),this.date(a.getUTCDate()),this}function Fn(e){return null==e?Math.ceil((this.month()+1)/3):this.month(3*(e-1)+this.month()%3)}function Pn(e){var t=Math.round((this.clone().startOf("day")-this.clone().startOf("year"))/864e5)+1
return null==e?t:this.add(e-t,"d")}function On(e,t){t[so]=w(1e3*("0."+e))}function Nn(){return this._isUTC?"UTC":""}function $n(){return this._isUTC?"Coordinated Universal Time":""}function jn(e){return yt(1e3*e)}function Rn(){return yt.apply(null,arguments).parseZone()}function Hn(e){return e}function Wn(e,t,n,i){var o=tt(),r=d().set(i,t)
return o[n](r,e)}function Yn(e,t,n){if(r(e)&&(t=e,e=void 0),e=e||"",null!=t)return Wn(e,t,n,"month")
var i,o=[]
...
return l}function qn(e,t){return Yn(e,t,"months")}function Un(e,t){return Yn(e,t,"monthsShort")}function Bn(e,t,n){return zn(e,t,n,"weekdays")}function Vn(e,t,n){return zn(e,t,n,"weekdaysShort")}function Gn(e,t,n){return zn(e,t,n,"weekdaysMin")}function Qn(){var e=this._data
...
return e._milliseconds+=i*o._milliseconds,e._days+=i*o._days,e._months+=i*o._months,e._bubble()}function Zn(e,t){return Jn(this,e,t,1)}function Xn(e,t){return Jn(this,e,t,-1)}function Kn(e){return e<0?Math.floor(e):Math.ceil(e)}function ei(){var e,t,n,i,o,r=this._milliseconds,a=this._days,s=this._months,l=this._data
...
default:throw new Error("Unknown unit "+e)}}function oi(){return this._milliseconds+864e5*this._days+this._months%12*2592e6+31536e6*w(this._months/12)}function ri(e){return function(){return this.as(e)}}function ai(e){return e=N(e),this[e+"s"]()}function si(e){return function(){return this._data[e]}}function li(){return b(this.days()/7)}function ci(e,t,n,i,o){return o.relativeTime(t||1,!!n,e,i)}function di(e,t,n){var i=Ht(e).abs(),o=mr(i.as("s")),r=mr(i.as("m")),a=mr(i.as("h")),s=mr(i.as("d")),l=mr(i.as("M")),c=mr(i.as("y")),d=o<gr.s&&["s",o]||r<=1&&["m"]||r<gr.m&&["mm",r]||a<=1&&["h"]||a<gr.h&&["hh",a]||s<=1&&["d"]||s<gr.d&&["dd",s]||l<=1&&["M"]||l<gr.M&&["MM",l]||c<=1&&["y"]||["yy",c]
return d[2]=t,d[3]=+e>0,d[4]=n,ci.apply(null,d)}function ui(e){return void 0===e?mr:"function"==typeof e&&(mr=e,!0)}function pi(e,t){return void 0!==gr[e]&&(void 0===t?gr[e]:(gr[e]=t,!0))}function fi(e){var t=this.localeData(),n=di(this,!e,t)
...
var a=n,s=r,l=o,c=t,d=e,u=i,p=this.asSeconds()
return p?(p<0?"-":"")+"P"+(a?a+"Y":"")+(s?s+"M":"")+(l?l+"D":"")+(c||d||u?"T":"")+(c?c+"H":"")+(d?d+"M":"")+(u?u+"S":""):"P0D"}var mi,gi
...
return n}
var _i,Ci=xi,Si={sameDay:"[Today at] LT",nextDay:"[Tomorrow at] LT",nextWeek:"dddd [at] LT",lastDay:"[Yesterday at] LT",lastWeek:"[Last] dddd [at] LT",sameElse:"L"},Di={LTS:"h:mm:ss A",LT:"h:mm A",L:"MM/DD/YYYY",LL:"MMMM D, YYYY",LLL:"MMMM D, YYYY h:mm A",LLLL:"dddd, MMMM D, YYYY h:mm A"},Ti="Invalid date",ki="%d",Ei=/\d{1,2}/,Ii={future:"in %s",past:"%s ago",s:"a few seconds",m:"a minute",mm:"%d minutes",h:"an hour",hh:"%d hours",d:"a day",dd:"%d days",M:"a month",MM:"%d months",y:"a year",yy:"%d years"},Mi={},Ai={},Li=/(\[[^\[]*\])|(\\)?([Hh]mm(ss)?|Mo|MM?M?M?|Do|DDDo|DD?D?D?|ddd?d?|do?|w[o|w]?|W[o|W]?|Qo?|YYYYYY|YYYYY|YYYY|YY|gg(ggg?)?|GG(GGG?)?|e|E|a|A|hh?|HH?|kk?|mm?|ss?|S{1,9}|x|X|zz?|ZZ?|.)/g,Fi=/(\[[^\[]*\])|(\\)?(LTS|LT|LL?L?L?|l{1,4})/g,Pi={},Oi={},Ni=/\d/,$i=/\d\d/,ji=/\d{3}/,Ri=/\d{4}/,Hi=/[+-]?\d{6}/,Wi=/\d\d?/,Yi=/\d\d\d\d?/,zi=/\d\d\d\d\d\d?/,qi=/\d{1,3}/,Ui=/\d{1,4}/,Bi=/[+-]?\d{1,6}/,Vi=/\d+/,Gi=/[+-]?\d+/,Qi=/Z|[+-]\d\d:?\d\d/gi,Ji=/Z|[+-]\d\d(?::?\d\d)?/gi,Zi=/[+-]?\d+(\.\d{1,3})?/,Xi=/[0-9]*['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]+|[\u0600-\u06FF\/]+(\s*?[\u0600-\u06FF]+){1,2}/i,Ki={},eo={},to=0,no=1,io=2,oo=3,ro=4,ao=5,so=6,lo=7,co=8
_i=Array.prototype.indexOf?Array.prototype.indexOf:function(e){var t
for(t=0;t<this.length;++t)if(this[t]===e)return t
return-1}
var uo=_i
B("M",["MM",2],"Mo",function(){return this.month()+1}),B("MMM",0,0,function(e){return this.localeData().monthsShort(this,e)}),B("MMMM",0,0,function(e){return this.localeData().months(this,e)}),O("month","M"),j("month",8),Z("M",Wi),Z("MM",Wi,$i),Z("MMM",function(e,t){return t.monthsShortRegex(e)}),Z("MMMM",function(e,t){return t.monthsRegex(e)}),te(["M","MM"],function(e,t){t[no]=w(e)-1}),te(["MMM","MMMM"],function(e,t,n,i){var o=n._locale.monthsParse(e,i,n._strict)
null!=o?t[no]=o:p(n).invalidMonth=e})
var po=/D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/,fo="January_February_March_April_May_June_July_August_September_October_November_December".split("_"),ho="Jan_Feb_Mar_Apr_May_Jun_Jul_Aug_Sep_Oct_Nov_Dec".split("_"),mo=Xi,go=Xi
B("Y",0,0,function(){var e=this.year()
return e<=9999?""+e:"+"+e}),B(0,["YY",2],0,function(){return this.year()%100}),B(0,["YYYY",4],0,"year"),B(0,["YYYYY",5],0,"year"),B(0,["YYYYYY",6,!0],0,"year"),O("year","y"),j("year",1),Z("Y",Gi),Z("YY",Wi,$i),Z("YYYY",Ui,Ri),Z("YYYYY",Bi,Hi),Z("YYYYYY",Bi,Hi),te(["YYYYY","YYYYYY"],to),te("YYYY",function(t,n){n[to]=2===t.length?e.parseTwoDigitYear(t):w(t)}),te("YY",function(t,n){n[to]=e.parseTwoDigitYear(t)}),te("Y",function(e,t){t[to]=parseInt(e,10)}),e.parseTwoDigitYear=function(e){return w(e)+(w(e)>68?1900:2e3)}
var vo=H("FullYear",!0)
B("w",["ww",2],"wo","week"),B("W",["WW",2],"Wo","isoWeek"),O("week","w"),O("isoWeek","W"),j("week",5),j("isoWeek",5),Z("w",Wi),Z("ww",Wi,$i),Z("W",Wi),Z("WW",Wi,$i),ne(["w","ww","W","WW"],function(e,t,n,i){t[i.substr(0,1)]=w(e)})
var yo={dow:0,doy:6}
B("d",0,"do","day"),B("dd",0,0,function(e){return this.localeData().weekdaysMin(this,e)}),B("ddd",0,0,function(e){return this.localeData().weekdaysShort(this,e)}),B("dddd",0,0,function(e){return this.localeData().weekdays(this,e)}),B("e",0,0,"weekday"),B("E",0,0,"isoWeekday"),O("day","d"),O("weekday","e"),O("isoWeekday","E"),j("day",11),j("weekday",11),j("isoWeekday",11),Z("d",Wi),Z("e",Wi),Z("E",Wi),Z("dd",function(e,t){return t.weekdaysMinRegex(e)}),Z("ddd",function(e,t){return t.weekdaysShortRegex(e)}),Z("dddd",function(e,t){return t.weekdaysRegex(e)}),ne(["dd","ddd","dddd"],function(e,t,n,i){var o=n._locale.weekdaysParse(e,i,n._strict)
...
B("H",["HH",2],0,"hour"),B("h",["hh",2],0,ze),B("k",["kk",2],0,qe),B("hmm",0,0,function(){return""+ze.apply(this)+U(this.minutes(),2)}),B("hmmss",0,0,function(){return""+ze.apply(this)+U(this.minutes(),2)+U(this.seconds(),2)}),B("Hmm",0,0,function(){return""+this.hours()+U(this.minutes(),2)}),B("Hmmss",0,0,function(){return""+this.hours()+U(this.minutes(),2)+U(this.seconds(),2)}),Ue("a",!0),Ue("A",!1),O("hour","h"),j("hour",13),Z("a",Be),Z("A",Be),Z("H",Wi),Z("h",Wi),Z("HH",Wi,$i),Z("hh",Wi,$i),Z("hmm",Yi),Z("hmmss",zi),Z("Hmm",Yi),Z("Hmmss",zi),te(["H","HH"],oo),te(["a","A"],function(e,t,n){n._isPm=n._locale.isPM(e),n._meridiem=e}),te(["h","hh"],function(e,t,n){t[oo]=w(e),p(n).bigHour=!0}),te("hmm",function(e,t,n){var i=e.length-2
...
var Do,To=/[ap]\.?m?\.?/i,ko=H("Hours",!0),Eo={calendar:Si,longDateFormat:Di,invalidDate:Ti,ordinal:ki,ordinalParse:Ei,relativeTime:Ii,months:fo,monthsShort:ho,week:yo,weekdays:bo,weekdaysMin:xo,weekdaysShort:wo,meridiemParse:To},Io={},Mo={},Ao=/^\s*((?:[+-]\d{6}|\d{4})-(?:\d\d-\d\d|W\d\d-\d|W\d\d|\d\d\d|\d\d))(?:(T| )(\d\d(?::\d\d(?::\d\d(?:[.,]\d+)?)?)?)([\+\-]\d\d(?::?\d\d)?|\s*Z)?)?$/,Lo=/^\s*((?:[+-]\d{6}|\d{4})(?:\d\d\d\d|W\d\d\d|W\d\d|\d\d\d|\d\d))(?:(T| )(\d\d(?:\d\d(?:\d\d(?:[.,]\d+)?)?)?)([\+\-]\d\d(?::?\d\d)?|\s*Z)?)?$/,Fo=/Z|[+-]\d\d(?::?\d\d)?/,Po=[["YYYYYY-MM-DD",/[+-]\d{6}-\d\d-\d\d/],["YYYY-MM-DD",/\d{4}-\d\d-\d\d/],["GGGG-[W]WW-E",/\d{4}-W\d\d-\d/],["GGGG-[W]WW",/\d{4}-W\d\d/,!1],["YYYY-DDD",/\d{4}-\d{3}/],["YYYY-MM",/\d{4}-\d\d/,!1],["YYYYYYMMDD",/[+-]\d{10}/],["YYYYMMDD",/\d{8}/],["GGGG[W]WWE",/\d{4}W\d{3}/],["GGGG[W]WW",/\d{4}W\d{2}/,!1],["YYYYDDD",/\d{7}/]],Oo=[["HH:mm:ss.SSSS",/\d\d:\d\d:\d\d\.\d+/],["HH:mm:ss,SSSS",/\d\d:\d\d:\d\d,\d+/],["HH:mm:ss",/\d\d:\d\d:\d\d/],["HH:mm",/\d\d:\d\d/],["HHmmss.SSSS",/\d\d\d\d\d\d\.\d+/],["HHmmss,SSSS",/\d\d\d\d\d\d,\d+/],["HHmmss",/\d\d\d\d\d\d/],["HHmm",/\d\d\d\d/],["HH",/\d\d/]],No=/^\/?Date\((\-?\d+)/i
...
Dt("Z",":"),Dt("ZZ",""),Z("Z",Ji),Z("ZZ",Ji),te(["Z","ZZ"],function(e,t,n){n._useUTC=!0,n._tzm=Tt(Ji,e)})
var Ho=/([\+\-]|\d\d)/gi
e.updateOffset=function(){}
var Wo=/^(\-)?(?:(\d*)[. ])?(\d+)\:(\d+)(?:\:(\d+)(\.\d*)?)?$/,Yo=/^(-)?P(?:(-?[0-9,.]*)Y)?(?:(-?[0-9,.]*)M)?(?:(-?[0-9,.]*)W)?(?:(-?[0-9,.]*)D)?(?:T(?:(-?[0-9,.]*)H)?(?:(-?[0-9,.]*)M)?(?:(-?[0-9,.]*)S)?)?$/
Ht.fn=_t.prototype
var zo=qt(1,"add"),qo=qt(-1,"subtract")
...
B(0,["gg",2],0,function(){return this.weekYear()%100}),B(0,["GG",2],0,function(){return this.isoWeekYear()%100}),Tn("gggg","weekYear"),Tn("ggggg","weekYear"),Tn("GGGG","isoWeekYear"),Tn("GGGGG","isoWeekYear"),O("weekYear","gg"),O("isoWeekYear","GG"),j("weekYear",1),j("isoWeekYear",1),Z("G",Gi),Z("g",Gi),Z("GG",Wi,$i),Z("gg",Wi,$i),Z("GGGG",Ui,Ri),Z("gggg",Ui,Ri),Z("GGGGG",Bi,Hi),Z("ggggg",Bi,Hi),ne(["gggg","ggggg","GGGG","GGGGG"],function(e,t,n,i){t[i.substr(0,2)]=w(e)}),ne(["gg","GG"],function(t,n,i,o){n[o]=e.parseTwoDigitYear(t)}),B("Q",0,"Qo","quarter"),O("quarter","Q"),j("quarter",7),Z("Q",Ni),te("Q",function(e,t){t[no]=3*(w(e)-1)}),B("D",["DD",2],"Do","date"),O("date","D"),j("date",9),Z("D",Wi),Z("DD",Wi,$i),Z("Do",function(e,t){return e?t._ordinalParse:t._ordinalParseLenient}),te(["D","DD"],io),te("Do",function(e,t){t[io]=w(e.match(Wi)[0],10)})
var Bo=H("Date",!0)
B("DDD",["DDDD",3],"DDDo","dayOfYear"),O("dayOfYear","DDD"),j("dayOfYear",4),Z("DDD",qi),Z("DDDD",ji),te(["DDD","DDDD"],function(e,t,n){n._dayOfYear=w(e)}),B("m",["mm",2],0,"minute"),O("minute","m"),j("minute",14),Z("m",Wi),Z("mm",Wi,$i),te(["m","mm"],ro)
var Vo=H("Minutes",!1)
B("s",["ss",2],0,"second"),O("second","s"),j("second",15),Z("s",Wi),Z("ss",Wi,$i),te(["s","ss"],ao)
var Go=H("Seconds",!1)
B("S",0,0,function(){return~~(this.millisecond()/100)}),B(0,["SS",2],0,function(){return~~(this.millisecond()/10)}),B(0,["SSS",3],0,"millisecond"),B(0,["SSSS",4],0,function(){return 10*this.millisecond()}),B(0,["SSSSS",5],0,function(){return 100*this.millisecond()}),B(0,["SSSSSS",6],0,function(){return 1e3*this.millisecond()}),B(0,["SSSSSSS",7],0,function(){return 1e4*this.millisecond()}),B(0,["SSSSSSSS",8],0,function(){return 1e5*this.millisecond()}),B(0,["SSSSSSSSS",9],0,function(){return 1e6*this.millisecond()}),O("millisecond","ms"),j("millisecond",16),Z("S",qi,Ni),Z("SS",qi,$i),Z("SSS",qi,ji)
var Qo
for(Qo="SSSS";Qo.length<=9;Qo+="S")Z(Qo,Vi)
for(Qo="S";Qo.length<=9;Qo+="S")te(Qo,On)
var Jo=H("Milliseconds",!1)
B("z",0,0,"zoneAbbr"),B("zz",0,0,"zoneName")
var Zo=v.prototype
Zo.add=zo,Zo.calendar=Vt,Zo.clone=Gt,Zo.diff=tn,Zo.endOf=mn,Zo.format=sn,Zo.from=ln,Zo.fromNow=cn,Zo.to=dn,Zo.toNow=un,Zo.get=z,Zo.invalidAt=Sn,Zo.isAfter=Qt,Zo.isBefore=Jt,Zo.isBetween=Zt,Zo.isSame=Xt,Zo.isSameOrAfter=Kt,Zo.isSameOrBefore=en,Zo.isValid=_n,Zo.lang=Uo,Zo.locale=pn,Zo.localeData=fn,Zo.max=jo,Zo.min=$o,Zo.parsingFlags=Cn,Zo.set=q,Zo.startOf=hn,Zo.subtract=qo,Zo.toArray=bn,Zo.toObject=wn,Zo.toDate=yn,Zo.toISOString=rn,Zo.inspect=an,Zo.toJSON=xn,Zo.toString=on,Zo.unix=vn,Zo.valueOf=gn,Zo.creationData=Dn,Zo.year=vo,Zo.isLeapYear=ve,Zo.weekYear=kn,Zo.isoWeekYear=En,Zo.quarter=Zo.quarters=Fn,Zo.month=de,Zo.daysInMonth=ue,Zo.week=Zo.weeks=ke,Zo.isoWeek=Zo.isoWeeks=Ee,Zo.weeksInYear=Mn,Zo.isoWeeksInYear=In,Zo.date=Bo,Zo.day=Zo.days=Ne,Zo.weekday=$e,Zo.isoWeekday=je,Zo.dayOfYear=Pn,Zo.hour=Zo.hours=ko,Zo.minute=Zo.minutes=Vo,Zo.second=Zo.seconds=Go,Zo.millisecond=Zo.milliseconds=Jo,Zo.utcOffset=It,Zo.utc=At,Zo.local=Lt,Zo.parseZone=Ft,Zo.hasAlignedHourOffset=Pt,Zo.isDST=Ot,Zo.isLocal=$t,Zo.isUtcOffset=jt,Zo.isUtc=Rt,Zo.isUTC=Rt,Zo.zoneAbbr=Nn,Zo.zoneName=$n,Zo.dates=C("dates accessor is deprecated. Use date instead.",Bo),Zo.months=C("months accessor is deprecated. Use month instead",de),Zo.years=C("years accessor is deprecated. Use year instead",vo),Zo.zone=C("moment().zone is deprecated, use moment().utcOffset instead. http://momentjs.com/guides/#/warnings/zone/",Mt),Zo.isDSTShifted=C("isDSTShifted is deprecated. See http://momentjs.com/guides/#/warnings/dst-shifted/ for more information",Nt)
var Xo=E.prototype
Xo.calendar=I,Xo.longDateFormat=M,Xo.invalidDate=A,Xo.ordinal=L,Xo.preparse=Hn,Xo.postformat=Hn,Xo.relativeTime=F,Xo.pastFuture=P,Xo.set=T,Xo.months=re,Xo.monthsShort=ae,Xo.monthsParse=le,Xo.monthsRegex=fe,Xo.monthsShortRegex=pe,Xo.week=Se,Xo.firstDayOfYear=Te,Xo.firstDayOfWeek=De,Xo.weekdays=Ae,Xo.weekdaysMin=Fe,Xo.weekdaysShort=Le,Xo.weekdaysParse=Oe,Xo.weekdaysRegex=Re,Xo.weekdaysShortRegex=He,Xo.weekdaysMinRegex=We,Xo.isPM=Ve,Xo.meridiem=Ge,Xe("en",{ordinalParse:/\d{1,2}(th|st|nd|rd)/,ordinal:function(e){var t=e%10,n=1===w(e%100/10)?"th":1===t?"st":2===t?"nd":3===t?"rd":"th"
...
var Ko=Math.abs,er=ri("ms"),tr=ri("s"),nr=ri("m"),ir=ri("h"),or=ri("d"),rr=ri("w"),ar=ri("M"),sr=ri("y"),lr=si("milliseconds"),cr=si("seconds"),dr=si("minutes"),ur=si("hours"),pr=si("days"),fr=si("months"),hr=si("years"),mr=Math.round,gr={s:45,m:45,h:22,d:26,M:11},vr=Math.abs,yr=_t.prototype
return yr.abs=Qn,yr.add=Zn,yr.subtract=Xn,yr.as=ii,yr.asMilliseconds=er,yr.asSeconds=tr,yr.asMinutes=nr,yr.asHours=ir,yr.asDays=or,yr.asWeeks=rr,yr.asMonths=ar,yr.asYears=sr,yr.valueOf=oi,yr._bubble=ei,yr.get=ai,yr.milliseconds=lr,yr.seconds=cr,yr.minutes=dr,yr.hours=ur,yr.days=pr,yr.weeks=li,yr.months=fr,yr.years=hr,yr.humanize=fi,yr.toISOString=hi,yr.toString=hi,yr.toJSON=hi,yr.locale=pn,yr.localeData=fn,yr.toIsoString=C("toIsoString() is deprecated. Please use toISOString() instead (notice the capitals)",hi),yr.lang=Uo,B("X",0,0,"unix"),B("x",0,0,"valueOf"),Z("x",Gi),Z("X",Zi),te("X",function(e,t,n){n._d=new Date(1e3*parseFloat(e,10))}),te("x",function(e,t,n){n._d=new Date(w(e))}),e.version="2.17.1",t(yt),e.fn=Zo,e.min=wt,e.max=xt,e.now=Ro,e.utc=d,e.unix=jn,e.months=qn,e.isDate=a,e.locale=Xe,e.invalid=h,e.duration=Ht,e.isMoment=y,e.weekdays=Bn,e.parseZone=Rn,e.localeData=tt,e.isDuration=Ct,e.monthsShort=Un,e.weekdaysMin=Gn,e.defineLocale=Ke,e.updateLocale=et,e.locales=nt,e.weekdaysShort=Vn,e.normalizeUnits=N,e.relativeTimeRounding=ui,e.relativeTimeThreshold=pi,e.calendarFormat=Bt,e.prototype=Zo,e}),function(e,t){"object"==typeof exports&&"undefined"!=typeof module?t(require("../moment")):"function"==typeof define&&define.amd?define(["moment"],t):t(e.moment)}(this,function(e){"use strict"
...
return i}),window.Modernizr=function(e,t,n){function i(e){h.cssText=e}function o(e,t){return typeof e===t}var r,a,s,l="2.6.2",c={},d=!0,u=t.documentElement,p="modernizr",f=t.createElement(p),h=f.style,m=({}.toString,{}),g=[],v=g.slice,y={}.hasOwnProperty
...
t="function"==typeof t?t():t,"undefined"!=typeof d&&d&&(u.className+=" "+(t?"":"no-")+e),c[e]=t}return c},i(""),f=r=null,function(e,t){function n(e,t){var n=e.createElement("p"),i=e.getElementsByTagName("head")[0]||e.documentElement
...
return t||(t={},m++,e[h]=m,g[m]=t),t}function r(e,n,i){if(n||(n=t),d)return n.createElement(e)
i||(i=o(n))
var r
return r=i.cache[e]?i.cache[e].cloneNode():f.test(e)?(i.cache[e]=i.createElem(e)).cloneNode():i.createElem(e),r.canHaveChildren&&!p.test(e)?i.frag.appendChild(r):r}function a(e,n){if(e||(e=t),d)return e.createDocumentFragment()
n=n||o(e)
...
return"undefined"==typeof e.cloneNode||"undefined"==typeof e.createDocumentFragment||"undefined"==typeof e.createElement}()}catch(e){c=!0,d=!0}}()
var v={elements:u.elements||"abbr article aside audio bdi canvas data datalist details figcaption figure footer header hgroup mark meter nav output progress section summary time video",shivCSS:u.shivCSS!==!1,supportsUnknownElements:d,shivMethods:u.shivMethods!==!1,type:"default",shivDocument:l,createElement:r,createDocumentFragment:a}
e.html5=v,l(t)}(this,t),c._version=l,u.className=u.className.replace(/(^|\s)no-js(\s|$)/,"$1$2")+(d?" js "+g.join(" "):""),c}(this,this.document),function(e,t,n){function i(e){return"[object Function]"==g.call(e)}function o(e){return"string"==typeof e}function r(){}function a(e){return!e||"loaded"==e||"complete"==e||"uninitialized"==e}function s(){var e=v.shift()
y=1,e?e.t?h(function(){("c"==e.t?p.injectCss:p.injectJs)(e.s,0,e.a,e.x,e.e,1)},0):(e(),s()):y=0}function l(e,n,i,o,r,l,c){function d(t){if(!f&&a(u.readyState)&&(b.r=f=1,!y&&s(),u.onload=u.onreadystatechange=null,t)){"img"!=e&&h(function(){x.removeChild(u)},50)
for(var i in T[n])T[n].hasOwnProperty(i)&&T[n][i].onload()}}var c=c||p.errorTimeout,u=t.createElement(e),f=0,g=0,b={t:i,s:n,e:r,a:l,x:c}
1===T[n]&&(g=1,T[n]=[]),"object"==e?u.data=n:(u.src=n,u.type=e),u.width=u.height="0",u.onerror=u.onload=u.onreadystatechange=function(){d.call(this,g)},v.splice(o,0,b),"img"!=e&&(g||2===T[n]?(x.insertBefore(u,w?null:m),h(d,c)):T[n].push(u))}function c(e,t,n,i,r){return y=0,t=t||"j",o(e)?l("c"==t?C:_,e,t,this.i++,n,i,r):(v.splice(this.i++,0,e),1==v.length&&s()),this}function d(){var e=p
return e.loader={load:c,i:0},e}var u,p,f=t.documentElement,h=e.setTimeout,m=t.getElementsByTagName("script")[0],g={}.toString,v=[],y=0,b="MozAppearance"in f.style,w=b&&!!t.createRange().compareNode,x=w?f:m.parentNode,f=e.opera&&"[object Opera]"==g.call(e.opera),f=!!t.attachEvent&&!f,_=b?"object":f?"script":"img",C=f?"script":_,S=Array.isArray||function(e){return"[object Array]"==g.call(e)},D=[],T={},k={timeout:function(e,t){return t.length&&(e.timeout=t[0]),e}}
...
l.url.split(".").pop().split("?").shift(),l.bypass||(o&&(o=i(o)?o:o[e]||o[a]||o[e.split("/").pop().split("?")[0]]),l.instead?l.instead(e,o,r,a,s):(T[l.url]?l.noexec=!0:T[l.url]=1,r.load(l.url,l.forceCSS||!l.forceJS&&"css"==l.url.split(".").pop().split("?").shift()?"c":n,l.noexec,l.attrs,l.timeout),(i(o)||i(c))&&r.load(function(){d(),o&&o(l.origUrl,s,a),c&&c(l.origUrl,s,a),T[l.url]=2})))}function s(e,t){function n(e,n){if(e){if(o(e))n||(u=function(){var e=[].slice.call(arguments)
p.apply(this,e),f()}),a(e,u,t,0,c)
else if(Object(e)===e)for(l in s=function(){var t,n=0
for(t in e)e.hasOwnProperty(t)&&n++
return n}(),e)e.hasOwnProperty(l)&&(!n&&!--s&&(i(u)?u=function(){var e=[].slice.call(arguments)
p.apply(this,e),f()}:u[l]=function(e){return function(){var t=[].slice.call(arguments)
e&&e.apply(this,t),f()}}(p[l])),a(e[l],u,t,l,c))}else!n&&f()}var s,l,c=!!e.test,d=e.load||e.both,u=e.callback||r,p=u,f=e.complete||r
n(c?e.yep:e.nope,!!d),d&&n(d)}var l,c,u=this.yepnope.loader
if(o(e))a(e,0,u,0)
else if(S(e))for(l=0;l<e.length;l++)c=e[l],o(c)?a(c,0,u,0):S(c)?p(c):Object(c)===c&&s(c,u)
else Object(e)===e&&s(e,u)},p.addPrefix=function(e,t){k[e]=t},p.addFilter=function(e){D.push(e)},p.errorTimeout=1e4,null==t.readyState&&t.addEventListener&&(t.readyState="loading",t.addEventListener("DOMContentLoaded",u=function(){t.removeEventListener("DOMContentLoaded",u,0),t.readyState="complete"},0)),e.yepnope=d(),e.yepnope.executeStack=s,e.yepnope.injectJs=function(e,n,i,o,l,c){var d,u,f=t.createElement("script"),o=o||p.errorTimeout
f.src=e
for(u in i)f.setAttribute(u,i[u])
n=c?s:n||r,f.onreadystatechange=f.onload=function(){!d&&a(f.readyState)&&(d=1,n(),f.onload=f.onreadystatechange=null)},h(function(){d||(d=1,n(1))},o),l?f.onload():m.parentNode.insertBefore(f,m)},e.yepnope.injectCss=function(e,n,i,o,a,l){var c,o=t.createElement("link"),n=l?s:n||r
o.href=e,o.rel="stylesheet",o.type="text/css"
for(c in i)o.setAttribute(c,i[c])
a||(m.parentNode.insertBefore(o,m),h(n,0))}}(this,document),Modernizr.load=function(){yepnope.apply(window,[].slice.call(arguments,0))},function(){var e,t,n,i,o,r,a,s,l=[].slice,c={}.hasOwnProperty,d=function(e,t){function n(){this.constructor=e}for(var i in t)c.call(t,i)&&(e[i]=t[i])
...
return i=document.createElement("img"),i.onload=function(t){return function(){var o,a,s,l,c,d,u,p
if(e.width=i.width,e.height=i.height,s=t.options.resize.call(t,e),null==s.trgWidth&&(s.trgWidth=s.optWidth),null==s.trgHeight&&(s.trgHeight=s.optHeight),o=document.createElement("canvas"),a=o.getContext("2d"),o.width=s.trgWidth,o.height=s.trgHeight,r(a,i,null!=(c=s.srcX)?c:0,null!=(d=s.srcY)?d:0,s.srcWidth,s.srcHeight,null!=(u=s.trgX)?u:0,null!=(p=s.trgY)?p:0,s.trgWidth,s.trgHeight),l=o.toDataURL("image/png"),t.emit("thumbnail",e,l),null!=n)return n()}}(this),null!=n&&(i.onerror=n),i.src=t},n.prototype.processQueue=function(){var e,t,n,i
...
return t=arguments[0],e=2<=arguments.length?l.call(arguments,1):[],"function"==typeof t?t.apply(this,e):t},n.prototype.uploadFile=function(e){return this.uploadFiles([e])},n.prototype.uploadFiles=function(e){var t,r,a,s,l,c,d,u,p,f,h,m,g,v,y,b,w,x,_,C,S,D,T,k,E,I,M,A,L,F,P,O,N,$
...
return r}}(this),b=function(n){return function(i){var o,r,a,s,l,c,d,u,p
if(null!=i)for(r=100*i.loaded/i.total,a=0,c=e.length;a<c;a++)t=e[a],t.upload={progress:r,total:i.total,bytesSent:i.loaded}
else{for(o=!0,r=100,s=0,d=e.length;s<d;s++)t=e[s],100===t.upload.progress&&t.upload.bytesSent===t.upload.total||(o=!1),t.upload.progress=r,t.upload.bytesSent=t.upload.total
if(o)return}for(p=[],l=0,u=e.length;l<u;l++)t=e[l],p.push(n.emit("uploadprogress",t,r,t.upload.bytesSent))
return p}}(this),_.onload=function(t){return function(i){var o
if(e[0].status!==n.CANCELED&&4===_.readyState){if(y=_.responseText,_.getResponseHeader("content-type")&&~_.getResponseHeader("content-type").indexOf("application/json"))try{y=JSON.parse(y)}catch(e){i=e,y="Invalid JSON response from server."}return b(),200<=(o=_.status)&&o<300?t._finished(e,y,i):a()}}}(this),_.onerror=function(t){return function(){if(e[0].status!==n.CANCELED)return a()}}(this),v=null!=(L=_.upload)?L:_,v.onprogress=b,c={Accept:"application/json","Cache-Control":"no-cache","X-Requested-With":"XMLHttpRequest"},this.options.headers&&i(c,this.options.headers)
for(s in c)l=c[s],_.setRequestHeader(s,l)
if(r=new FormData,this.options.params){F=this.options.params
for(h in F)x=F[h],r.append(h,x)}for(S=0,E=e.length;S<E;S++)t=e[S],this.emit("sending",t,_,r)
if(this.options.uploadMultiple&&this.emit("sendingmultiple",e,_,r),"FORM"===this.element.tagName)for(P=this.element.querySelectorAll("input, textarea, select, button"),D=0,I=P.length;D<I;D++)if(u=P[D],p=u.getAttribute("name"),f=u.getAttribute("type"),"SELECT"===u.tagName&&u.hasAttribute("multiple"))for(O=u.options,T=0,M=O.length;T<M;T++)g=O[T],g.selected&&r.append(p,g.value)
else(!f||"checkbox"!==(N=f.toLowerCase())&&"radio"!==N||u.checked)&&r.append(p,u.value)
for(d=A=0,$=e.length-1;0<=$?A<=$:A>=$;d=0<=$?++A:--A)r.append(this._getParamName(d),e[d],e[d].name)
...
return!1},"undefined"!=typeof jQuery&&null!==jQuery&&(jQuery.fn.dropzone=function(t){return this.each(function(){return new e(this,t)})}),"undefined"!=typeof module&&null!==module?module.exports=e:window.Dropzone=e,e.ADDED="added",e.QUEUED="queued",e.ACCEPTED=e.QUEUED,e.UPLOADING="uploading",e.PROCESSING=e.UPLOADING,e.CANCELED="canceled",e.ERROR="error",e.SUCCESS="success",o=function(e){var t,n,i,o,r,a,s,l,c,d
for(s=e.naturalWidth,a=e.naturalHeight,n=document.createElement("canvas"),n.width=1,n.height=a,i=n.getContext("2d"),i.drawImage(e,0,0),o=i.getImageData(0,0,1,a).data,d=0,r=a,l=a;l>d;)t=o[4*(l-1)+3],0===t?r=l:d=l,l=r+d>>1
return c=l/a,0===c?1:c},r=function(e,t,n,i,r,a,s,l,c,d){var u
return u=o(t),e.drawImage(t,n,i,r,a,s,l,c,d/u)},i=function(e,t){var n,i,o,r,a,s,l,c,d
...
try{c.doScroll("left")}catch(t){return e=t,void setTimeout(a,50)}return r("poll")},"complete"!==i.readyState){if(i.createEventObject&&c.doScroll){try{d=!e.frameElement}catch(e){}d&&a()}return i[n](s+"DOMContentLoaded",r,!1),i[n](s+"readystatechange",r,!1),e[n](s+"load",r,!1)}},e._autoDiscoverFunction=function(){if(e.autoDiscover)return e.discover()},i(window,e._autoDiscoverFunction)}.call(this),function(e){window.console||(window.console={}),window.console.log||(window.console.log=function(){}),e.fn.gMapsLatLonPicker=function(){var t=this
...
t.barWidth=o[0].offsetWidth-o[0].clientWidth,t.bScrollOversize=100===r[0].offsetWidth&&100!==o[0].clientWidth,t.bScrollbarLeft=1!==Math.round(r.offset().left),t.bBounding=!!n[0].getBoundingClientRect().width,n.remove()}i.extend(e.oBrowser,qe.__browser),e.oScroll.iBarWidth=qe.__browser.barWidth}function d(e,t,i,o,r,a){var s,l=!1
for(i!==n&&(s=i,l=!0);o!==r;)e.hasOwnProperty(o)&&(s=l?t(s,e[o],o,e):e[o],l=!0,o+=a)
return s}function u(e,n){var o=qe.defaults.column,r=e.aoColumns.length,o=i.extend({},qe.models.oColumn,o,{nTh:n?n:t.createElement("th"),sTitle:o.sTitle?o.sTitle:n?n.innerHTML:"",aDataSort:o.aDataSort?o.aDataSort:[r],mData:o.mData?o.mData:r,idx:r})
...
c&&(t.sWidthOrig=c[1])}o!==n&&null!==o&&(l(o),r(qe.defaults.column,o),o.mDataProp!==n&&!o.mData&&(o.mData=o.mDataProp),o.sType&&(t._sManualType=o.sType),o.className&&!o.sClass&&(o.sClass=o.className),i.extend(t,o),Fe(t,o,"sWidth","sWidthOrig"),o.iDataSort!==n&&(t.aDataSort=[o.iDataSort]),Fe(t,o,"aDataSort"))
var d=t.mData,u=D(d),p=t.mRender?D(t.mRender):null,o=function(e){return"string"==typeof e&&-1!==e.indexOf("@")}
t._bAttrSrc=i.isPlainObject(d)&&(o(d.sort)||o(d.type)||o(d.filter)),t.fnGetData=function(e,t,i){var o=u(e,t,n,i)
return p&&t?p(o,t,e,i):o},t.fnSetData=function(e,t,n){return T(d)(e,t,n)},"number"!=typeof d&&(e._rowReadObject=!0),e.oFeatures.bSort||(t.bSortable=!1,s.addClass(a.sSortableNone)),e=-1!==i.inArray("asc",t.asSorting),o=-1!==i.inArray("desc",t.asSorting),t.bSortable&&(e||o)?e&&!o?(t.sSortingClass=a.sSortableAsc,t.sSortingClassJUI=a.sSortJUIAscAllowed):!e&&o?(t.sSortingClass=a.sSortableDesc,t.sSortingClassJUI=a.sSortJUIDescAllowed):(t.sSortingClass=a.sSortable,t.sSortingClassJUI=a.sSortJUI):(t.sSortingClass=a.sSortableNone,t.sSortingClassJUI="")}function f(e){if(!1!==e.oFeatures.bAutoWidth){var t=e.aoColumns
ge(e)
...
return i.map(e.aoColumns,function(e,i){e[t]&&n.push(i)}),n}function y(e){var t,i,o,r,a,s,l,c,d,u=e.aoColumns,p=e.aoData,f=qe.ext.type.detect
for(t=0,i=u.length;t<i;t++)if(l=u[t],d=[],!l.sType&&l._sManualType)l.sType=l._sManualType
else if(!l.sType){for(o=0,r=f.length;o<r;o++){for(a=0,s=p.length;a<s&&(d[a]===n&&(d[a]=_(e,a,t,"type")),c=f[o](d[a],e),c||o===f.length-1)&&"html"!==c;a++);if(c){l.sType=c
break}}l.sType||(l.sType="string")}}function b(e,t,o,r){var a,s,l,c,d,p,f=e.aoColumns
if(t)for(a=t.length-1;0<=a;a--){p=t[a]
var h=p.targets!==n?p.targets:p.aTargets
for(i.isArray(h)||(h=[h]),s=0,l=h.length;s<l;s++)if("number"==typeof h[s]&&0<=h[s]){for(;f.length<=h[s];)u(e)
r(h[s],p)}else if("number"==typeof h[s]&&0>h[s])r(f.length+h[s],p)
else if("string"==typeof h[s])for(c=0,d=f.length;c<d;c++)("_all"==h[s]||i(f[c].nTh).hasClass(h[s]))&&r(c,p)}if(o)for(a=0,e=o.length;a<e;a++)r(a,o[a])}function w(e,t,o,r){var a=e.aoData.length,s=i.extend(!0,{},qe.models.oRow,{src:o?"dom":"data",idx:a})
s._aData=t,e.aoData.push(s)
for(var l=e.aoColumns,c=0,d=l.length;c<d;c++)l[c].sType=null
return e.aiDisplayMaster.push(a),t=e.rowIdFn(t),t!==n&&(e.aIds[t]=s),(o||!e.oFeatures.bDeferRender)&&L(e,a,o,r),a}function x(e,t){var n
return t instanceof i||(t=i(t)),t.map(function(t,i){return n=A(e,i),w(e,n.data,i,n.cells)})}function _(e,t,i,o){var r=e.iDraw,a=e.aoColumns[i],s=e.aoData[t]._aData,l=a.sDefaultContent,i=a.fnGetData(s,o,{settings:e,row:t,col:i})
if(i===n)return e.iDrawError!=r&&null===l&&(Le(e,0,"Requested unknown parameter "+("function"==typeof a.mData?"{function}":"'"+a.mData+"'")+" for row "+t,4),e.iDrawError=r),l
...
a=r[r.length-1]
for(var s,l,c=0,d=r.length-1;c<d;c++){if(s=r[c].match(ft),l=r[c].match(ht),s){if(r[c]=r[c].replace(ft,""),e[r[c]]=[],a=r.slice(),a.splice(0,c+1),s=a.join("."),i.isArray(o))for(l=0,d=o.length;l<d;l++)a={},t(a,o[l],s),e[r[c]].push(a)
else e[r[c]]=o
return}l&&(r[c]=r[c].replace(ht,""),e=e[r[c]](o)),null!==e[r[c]]&&e[r[c]]!==n||(e[r[c]]={}),e=e[r[c]]}a.match(ht)?e[a.replace(ht,"")](o):e[a.replace(ft,"")]=o}
return function(n,i){return t(n,i,e)}}return function(t,n){t[e]=n}}function k(e){return st(e.aoData,"_aData")}function E(e){e.aoData.length=0,e.aiDisplayMaster.length=0,e.aiDisplay.length=0,e.aIds={}}function I(e,t,i){for(var o=-1,r=0,a=e.length;r<a;r++)e[r]==t?o=r:e[r]>t&&e[r]--;-1!=o&&i===n&&e.splice(o,1)}function M(e,t,i,o){var r,a=e.aoData[t],s=function(n,i){for(;n.childNodes.length;)n.removeChild(n.firstChild)
n.innerHTML=_(e,t,i,"display")}
if("dom"!==i&&(i&&"auto"!==i||"dom"!==a.src)){var l=a.anCells
if(l)if(o!==n)s(l[o],o)
else for(i=0,r=l.length;i<r;i++)s(l[i],i)}else a._aData=A(e,a,o,o===n?n:a._aData).data
if(a._aSortData=null,a._aFilterData=null,s=e.aoColumns,o!==n)s[o].sType=null
else{for(i=0,r=s.length;i<r;i++)s[i].sType=null
F(e,a)}}function A(e,t,o,r){var a,s,l,c=[],d=t.firstChild,u=0,p=e.aoColumns,f=e._rowReadObject,r=r!==n?r:f?{}:[],h=function(e,t){if("string"==typeof e){var n=e.indexOf("@");-1!==n&&(n=e.substring(n+1),T(e)(r,t.getAttribute(n)))}},m=function(e){o!==n&&o!==u||(s=p[u],l=i.trim(e.innerHTML),s&&s._bAttrSrc?(T(s.mData._)(r,l),h(s.mData.sort,e),h(s.mData.type,e),h(s.mData.filter,e)):f?(s._setter||(s._setter=T(s.mData)),s._setter(r,l)):r[u]=l),u++}
if(d)for(;d;)a=d.nodeName.toUpperCase(),"TD"!=a&&"TH"!=a||(m(d),c.push(d)),d=d.nextSibling
else{c=t.anCells,a=0
for(var g=c.length;a<g;a++)m(c[a])}return(t=d?t:t.nTr)&&(t=t.getAttribute("id"))&&T(e.rowId)(r,t),{data:r,cells:c}}function L(e,n,i,o){var r,a,s,l,c,d=e.aoData[n],u=d._aData,p=[]
if(null===d.nTr){for(r=i||t.createElement("tr"),d.nTr=r,d.anCells=p,r._DT_RowIndex=n,F(e,d),l=0,c=e.aoColumns.length;l<c;l++)s=e.aoColumns[l],a=i?o[l]:t.createElement(s.sCellType),p.push(a),i&&!s.mRender&&s.mData===l||(a.innerHTML=_(e,n,l,"display")),s.sClass&&(a.className+=" "+s.sClass),s.bVisible&&!i?r.appendChild(a):!s.bVisible&&i&&a.parentNode.removeChild(a),s.fnCreatedCell&&s.fnCreatedCell.call(e.oInstance,a,_(e,n,l),u,n,l)
$e(e,"aoRowCreatedCallback",null,[r,u,n])}d.nTr.setAttribute("role","row")}function F(e,t){var n=t.nTr,o=t._aData
if(n){var r=e.rowIdFn(o)
r&&(n.id=r),o.DT_RowClass&&(r=o.DT_RowClass.split(" "),t.__rowc=t.__rowc?ut(t.__rowc.concat(r)):r,i(n).removeClass(t.__rowc.join(" ")).addClass(o.DT_RowClass)),o.DT_RowAttr&&i(n).attr(o.DT_RowAttr),o.DT_RowData&&i(n).data(o.DT_RowData)}}function P(e){var t,n,o,r,a,s=e.nTHead,l=e.nTFoot,c=0===i("th, td",s).length,d=e.oClasses,u=e.aoColumns
for(c&&(r=i("<tr/>").appendTo(s)),t=0,n=u.length;t<n;t++)a=u[t],o=i(a.nTh).addClass(a.sClass),c&&o.appendTo(r),e.oFeatures.bSort&&(o.addClass(a.sSortingClass),!1!==a.bSortable&&(o.attr("tabindex",e.iTabIndex).attr("aria-controls",e.sTableId),Te(e,a.nTh,t))),a.sTitle!=o[0].innerHTML&&o.html(a.sTitle),Re(e,"header")(e,o,a,d)
if(c&&R(e.aoHeader,s),i(s).find(">tr").attr("role","row"),i(s).find(">tr>th, >tr>td").addClass(d.sHeaderTH),i(l).find(">tr>th, >tr>td").addClass(d.sFooterTH),null!==l)for(e=e.aoFooter[0],t=0,n=e.length;t<n;t++)a=u[t],a.nTf=e[t].cell,a.sClass&&i(a.nTf).addClass(a.sClass)}function O(e,t,o){var r,a,s,l,c=[],d=[],u=e.aoColumns.length
if(t){for(o===n&&(o=!1),r=0,a=t.length;r<a;r++){for(c[r]=t[r].slice(),c[r].nTr=t[r].nTr,s=u-1;0<=s;s--)!e.aoColumns[s].bVisible&&!o&&c[r].splice(s,1)
d.push([])}for(r=0,a=c.length;r<a;r++){if(e=c[r].nTr)for(;s=e.firstChild;)e.removeChild(s)
for(s=0,t=c[r].length;s<t;s++)if(l=u=1,d[r][s]===n){for(e.appendChild(c[r][s].cell),d[r][s]=1;c[r+u]!==n&&c[r][s].cell==c[r+u][s].cell;)d[r+u][s]=1,u++
for(;c[r][s+l]!==n&&c[r][s].cell==c[r][s+l].cell;){for(o=0;o<u;o++)d[r+o][s+l]=1
l++}i(c[r][s].cell).attr("rowspan",u).attr("colspan",l)}}}}function N(e){var t=$e(e,"aoPreDrawCallback","preDraw",[e])
if(-1!==i.inArray(!1,t))pe(e,!1)
else{var t=[],o=0,r=e.asStripeClasses,a=r.length,s=e.oLanguage,l=e.iInitDisplayStart,c="ssp"==He(e),d=e.aiDisplay
...
else if(c){if(!e.bDestroying&&!Y(e))return}else e.iDraw++
if(0!==d.length)for(s=c?e.aoData.length:u,c=c?0:l;c<s;c++){var p=d[c],f=e.aoData[p]
if(null===f.nTr&&L(e,p),p=f.nTr,0!==a){var h=r[o%a]
...
$e(e,"aoHeaderCallback","header",[i(e.nTHead).children("tr")[0],k(e),l,u,d]),$e(e,"aoFooterCallback","footer",[i(e.nTFoot).children("tr")[0],k(e),l,u,d]),r=i(e.nTBody),r.children().detach(),r.append(i(t)),$e(e,"aoDrawCallback","draw",[e]),e.bSorted=!1,e.bFiltered=!1,e.bDrawing=!1}}function $(e,t){var n=e.oFeatures,i=n.bFilter
...
for(var a,s,l,c,d,u,p=e.sDom.split(""),f=0;f<p.length;f++){if(a=null,s=p[f],"<"==s){if(l=i("<div/>")[0],c=p[f+1],"'"==c||'"'==c){for(d="",u=2;p[f+u]!=c;)d+=p[f+u],u++
"H"==d?d=t.sJUIHeader:"F"==d&&(d=t.sJUIFooter),-1!=d.indexOf(".")?(c=d.split("."),l.id=c[0].substr(1,c[0].length-1),l.className=c[1]):"#"==d.charAt(0)?l.id=d.substr(1,d.length-1):l.className=d,f+=u}r.append(l),r=i(l)}else if(">"==s)r=r.parent()
else if("l"==s&&o.bPaginate&&o.bLengthChange)a=le(e)
else if("f"==s&&o.bFilter)a=B(e)
else if("r"==s&&o.bProcessing)a=ue(e)
else if("t"==s)a=fe(e)
else if("i"==s&&o.bInfo)a=ne(e)
else if("p"==s&&o.bPaginate)a=ce(e)
else if(0!==qe.ext.feature.length)for(l=qe.ext.feature,u=0,c=l.length;u<c;u++)if(s==l[u].cFeature){a=l[u].fnInit(e)
break}a&&(l=e.aanFeatures,l[s]||(l[s]=[]),l[s].push(a),r.append(a))}n.replaceWith(r),e.nHolding=null}function R(e,t){var n,o,r,a,s,l,c,d,u,p,f=i(t).children("tr")
for(e.splice(0,e.length),r=0,l=f.length;r<l;r++)e.push([])
for(r=0,l=f.length;r<l;r++)for(n=f[r],o=n.firstChild;o;){if("TD"==o.nodeName.toUpperCase()||"TH"==o.nodeName.toUpperCase()){for(d=1*o.getAttribute("colspan"),u=1*o.getAttribute("rowspan"),d=d&&0!==d&&1!==d?d:1,u=u&&0!==u&&1!==u?u:1,a=0,s=e[r];s[a];)a++
for(c=a,p=1===d,s=0;s<d;s++)for(a=0;a<u;a++)e[r+a][c+s]={cell:o,unique:p},e[r+a].nTr=n}o=o.nextSibling}}function H(e,t,n){var i=[]
...
var d=i.isFunction(a)?a(t,e):a,t=i.isFunction(a)&&d?d:i.extend(!0,t,d)
delete s.data}d={data:t,success:function(t){var n=t.error||t.sError
n&&Le(e,0,n),e.json=t,c(t)},dataType:"json",cache:!1,type:e.sServerMethod,error:function(t,n){var o=$e(e,null,"xhr",[e,null,e.jqXHR]);-1===i.inArray(!0,o)&&("parsererror"==n?Le(e,0,"Invalid JSON response",1):4===t.readyState&&Le(e,0,"Ajax error",7)),pe(e,!1)}},e.oAjaxData=t,$e(e,null,"preXhr",[e,t]),e.fnServerData?e.fnServerData.call(l,e.sAjaxSource,i.map(t,function(e,t){return{name:t,value:e}}),c,e):e.sAjaxSource||"string"==typeof s?e.jqXHR=i.ajax(i.extend(d,{url:s||e.sAjaxSource})):i.isFunction(s)?e.jqXHR=s.call(l,t,c,e):(e.jqXHR=i.ajax(i.extend(d,s)),s.data=a)}function Y(e){return!e.bAjaxDataGet||(e.iDraw++,pe(e,!0),W(e,z(e),function(t){q(e,t)}),!1)}function z(e){var t,n,o,r,a=e.aoColumns,s=a.length,l=e.oFeatures,c=e.oPreviousSearch,d=e.aoPreSearchCols,u=[],p=_e(e)
t=e._iDisplayStart,n=!1!==l.bPaginate?e._iDisplayLength:-1
var f=function(e,t){u.push({name:e,value:t})}
...
return i(e.nTable).on("search.dt.DT",function(n,i){if(e===i)try{d[0]!==t.activeElement&&d.val(a.sSearch)}catch(e){}}),n[0]}function V(e,t,i){var o=e.oPreviousSearch,r=e.aoPreSearchCols,a=function(e){o.sSearch=e.sSearch,o.bRegex=e.bRegex,o.bSmart=e.bSmart,o.bCaseInsensitive=e.bCaseInsensitive}
...
G(e)}else a(t)
e.bFiltered=!0,$e(e,null,"search",[e])}function G(e){for(var t,n,o=qe.ext.search,r=e.aiDisplay,a=0,s=o.length;a<s;a++){for(var l=[],c=0,d=r.length;c<d;c++)n=r[c],t=e.aoData[n],o[a](e,t._aFilterData,n,t._aData,c)&&l.push(n)
r.length=0,i.merge(r,l)}}function Q(e,t,n,i,o,r){if(""!==t)for(var a=e.aiDisplay,i=Z(t,i,o,r),o=a.length-1;0<=o;o--)t=e.aoData[a[o]]._aFilterData[n],i.test(t)||a.splice(o,1)}function J(e,t,n,i,o,r){var a,i=Z(t,i,o,r),o=e.oPreviousSearch.sSearch,r=e.aiDisplayMaster
if(0!==qe.ext.search.length&&(n=!0),a=K(e),0>=t.length)e.aiDisplay=r.slice()
else for((a||n||o.length>t.length||0!==t.indexOf(o)||e.bSorted)&&(e.aiDisplay=r.slice()),t=e.aiDisplay,n=t.length-1;0<=n;n--)i.test(e.aoData[t[n]]._sFilterRow)||t.splice(n,1)}function Z(e,t,n,o){return e=t?e:X(e),n&&(e="^(?=.*?"+i.map(e.match(/"[^"]+"|[^ ]+/g)||[""],function(e){if('"'===e.charAt(0))var t=e.match(/^"(.*)"$/),e=t?t[1]:e
return e.replace('"',"")}).join(")(?=.*?")+").*$"),RegExp(e,o?"i":"")}function X(e){return e.replace(et,"\\$1")}function K(e){var t,n,i,o,r,a,s,l,c=e.aoColumns,d=qe.ext.type.search
for(t=!1,n=0,o=e.aoData.length;n<o;n++)if(l=e.aoData[n],!l._aFilterData){for(a=[],i=0,r=c.length;i<r;i++)t=c[i],t.bSearchable?(s=_(e,n,i,"filter"),d[t.sType]&&(s=d[t.sType](s)),null===s&&(s=""),"string"!=typeof s&&s.toString&&(s=s.toString())):s="",s.indexOf&&-1!==s.indexOf("&")&&(mt.innerHTML=s,s=gt?mt.textContent:mt.innerText),s.replace&&(s=s.replace(/[\r\n]/g,"")),a.push(s)
...
if(e.bInitialised){for(j(e),P(e),O(e,e.aoHeader),O(e,e.aoFooter),pe(e,!0),n.bAutoWidth&&ge(e),t=0,n=r.length;t<n;t++)i=r[t],i.sWidth&&(i.nTh.style.width=xe(i.sWidth))
...
for(t=a.p.length;c<t;c++)Re(e,"pageButton")(e,a.p[c],c,l,i,s)}else n.fnUpdate(e,r)},sName:"pagination"})),t}function de(e,t,n){var i=e._iDisplayStart,o=e._iDisplayLength,r=e.fnRecordsDisplay()
return 0===r||-1===o?i=0:"number"==typeof t?(i=t*o,i>r&&(i=0)):"first"==t?i=0:"previous"==t?(i=0<=o?i-o:0,0>i&&(i=0)):"next"==t?i+o<r&&(i+=o):"last"==t?i=Math.floor((r-1)/o)*o:Le(e,0,"Unknown paging action: "+t,5),t=e._iDisplayStart!==i,e._iDisplayStart=i,t&&($e(e,null,"page",[e]),n&&N(e)),t}function ue(e){return i("<div/>",{id:e.aanFeatures.r?null:e.sTableId+"_processing",class:e.oClasses.sProcessing}).html(e.oLanguage.sProcessing).insertBefore(e.nTable)[0]}function pe(e,t){e.oFeatures.bProcessing&&i(e.aanFeatures.r).css("display",t?"block":"none"),$e(e,null,"processing",[e,t])}function fe(e){var t=i(e.nTable)
t.attr("role","grid")
var n=e.oScroll
if(""===n.sX&&""===n.sY)return e.nTable
var o=n.sX,r=n.sY,a=e.oClasses,s=t.children("caption"),l=s.length?s[0]._captionSide:null,c=i(t[0].cloneNode(!1)),d=i(t[0].cloneNode(!1)),u=t.children("tfoot")
n.sX&&"100%"===t.attr("width")&&t.removeAttr("width"),u.length||(u=null),c=i("<div/>",{class:a.sScrollWrapper}).append(i("<div/>",{class:a.sScrollHead}).css({overflow:"hidden",position:"relative",border:0,width:o?o?xe(o):null:"100%"}).append(i("<div/>",{class:a.sScrollHeadInner}).css({"box-sizing":"content-box",width:n.sXInner||"100%"}).append(c.removeAttr("id").css("margin-left",0).append("top"===l?s:null).append(t.children("thead"))))).append(i("<div/>",{class:a.sScrollBody}).css({position:"relative",overflow:"auto",width:o?xe(o):null}).append(t)),u&&c.append(i("<div/>",{class:a.sScrollFoot}).css({overflow:"hidden",border:0,width:o?o?xe(o):null:"100%"}).append(i("<div/>",{class:a.sScrollFootInner}).append(d.removeAttr("id").css("margin-left",0).append("bottom"===l?s:null).append(t.children("tfoot")))))
var t=c.children(),p=t[0],a=t[1],f=u?t[2]:null
return o&&i(a).on("scroll.DT",function(){var e=this.scrollLeft
p.scrollLeft=e,u&&(f.scrollLeft=e)}),i(a).css(r&&n.bCollapse?"max-height":"height",r),e.nScrollHead=p,e.nScrollBody=a,e.nScrollFoot=f,e.aoDrawCallback.push({fn:he,sName:"scrolling"}),c[0]}function he(e){var t,n,o,r,a,s=e.oScroll,l=s.sX,c=s.sXInner,d=s.sY,s=s.iBarWidth,u=i(e.nScrollHead),p=u[0].style,f=u.children("div"),m=f[0].style,g=f.children("table"),f=e.nScrollBody,v=i(f),y=f.style,b=i(e.nScrollFoot).children("div"),w=b.children("table"),x=i(e.nTHead),_=i(e.nTable),C=_[0],S=C.style,D=e.nTFoot?i(e.nTFoot):null,T=e.oBrowser,k=T.bScrollOversize,E=[],I=[],M=[],A=function(e){e=e.style,e.paddingTop="0",e.paddingBottom="0",e.borderTopWidth="0",e.borderBottomWidth="0",e.height=0}
_.children("thead, tfoot").remove(),r=x.clone().prependTo(_),x=x.find("tr"),n=r.find("tr"),r.find("th, td").removeAttr("tabindex"),D&&(o=D.clone().prependTo(_),t=D.find("tr"),o=o.find("tr")),l||(y.width="100%",u[0].style.width="100%"),i.each(H(e,r),function(t,n){a=h(e,t),n.style.width=e.aoColumns[a].sWidth}),D&&me(function(e){e.style.width=""},o),u=_.outerWidth(),""===l?(S.width="100%",k&&(_.find("tbody").height()>f.offsetHeight||"scroll"==v.css("overflow-y"))&&(S.width=xe(_.outerWidth()-s)),u=_.outerWidth()):""!==c&&(S.width=xe(c),u=_.outerWidth()),me(A,n),me(function(e){M.push(e.innerHTML),E.push(xe(i(e).css("width")))},n),me(function(e,t){e.style.width=E[t]},x),i(n).height(0),D&&(me(A,o),me(function(e){I.push(xe(i(e).css("width")))},o),me(function(e,t){e.style.width=I[t]},t),i(o).height(0)),me(function(e,t){e.innerHTML='<div class="dataTables_sizing" style="height:0;overflow:hidden;">'+M[t]+"</div>",e.style.width=E[t]},n),D&&me(function(e,t){e.innerHTML="",e.style.width=I[t]},o),_.outerWidth()<u?(t=f.scrollHeight>f.offsetHeight||"scroll"==v.css("overflow-y")?u+s:u,k&&(f.scrollHeight>f.offsetHeight||"scroll"==v.css("overflow-y"))&&(S.width=xe(t-s)),(""===l||""!==c)&&Le(e,1,"Possible column misalignment",6)):t="100%",y.width=xe(t),p.width=xe(t),D&&(e.nScrollFoot.style.width=xe(t)),!d&&k&&(y.height=xe(C.offsetHeight+s)),l=_.outerWidth(),g[0].style.width=xe(l),m.width=xe(l),c=_.height()>f.clientHeight||"scroll"==v.css("overflow-y"),d="padding"+(T.bScrollbarLeft?"Left":"Right"),m[d]=c?s+"px":"0px",D&&(w[0].style.width=xe(l),b[0].style.width=xe(l),b[0].style[d]=c?s+"px":"0px"),v.scroll(),!e.bSorted&&!e.bFiltered||e._drawHold||(f.scrollTop=0)}function me(e,t,n){for(var i,o,r=0,a=0,s=t.length;a<s;){for(i=t[a].firstChild,o=n?n[a].firstChild:null;i;)1===i.nodeType&&(n?e(i,o,r):e(i,r),r++),i=i.nextSibling,o=n?o.nextSibling:null
a++}}function ge(t){var n,o,r,a=t.nTable,s=t.aoColumns,l=t.oScroll,c=l.sY,d=l.sX,u=l.sXInner,p=s.length,m=v(t,"bVisible"),y=i("th",t.nTHead),b=a.getAttribute("width"),w=a.parentNode,x=!1
...
if(l||!x&&!d&&!c&&p==g(t)&&p==y.length)for(n=0;n<p;n++)(m=h(t,n))&&(s[m].sWidth=xe(y.eq(n).width()))
...
if(x=i("<div/>").css(d||c?{position:"absolute",top:0,left:0,height:1,right:0,overflow:"hidden"}:{}).append(p).appendTo(w),d&&u?p.width(u):d?(p.css("width","auto"),p.width()<w.clientWidth&&p.width(w.clientWidth)):c?p.width(w.clientWidth):b&&p.width(b),d){for(n=u=0;n<m.length;n++)o=s[m[n]],c=r.bBounding?y[n].getBoundingClientRect().width:i(y[n]).outerWidth(),u+=null===o.sWidthOrig?c:parseInt(o.sWidth,10)+c-i(y[n]).width()
p.width(xe(u)),a.style.width=xe(u)}for(n=0;n<m.length;n++)o=s[m[n]],(r=i(y[n]).width())&&(o.sWidth=xe(r))
a.style.width=xe(p.css("width")),x.remove()}b&&(a.style.width=xe(b)),!b&&!d||t._reszEvt||(a=function(){i(e).bind("resize.DT-"+t.sInstance,ve(function(){f(t)}))},l?setTimeout(a,1e3):a(),t._reszEvt=!0)}function ve(e,t){var i,o,r=t!==n?t:200
...
return o}function xe(e){return null===e?"0px":"number"==typeof e?0>e?"0px":e+"px":e.match(/\d$/)?e+"px":e}function _e(e){var t,o,r,a,s,l,c=[],d=e.aoColumns
t=e.aaSortingFixed,o=i.isPlainObject(t)
var u=[]
for(r=function(e){e.length&&!i.isArray(e[0])?u.push(e):i.merge(u,e)},i.isArray(t)&&r(t),o&&t.pre&&r(t.pre),r(e.aaSorting),o&&t.post&&r(t.post),e=0;e<u.length;e++)for(l=u[e][0],r=d[l].aDataSort,t=0,o=r.length;t<o;t++)a=r[t],s=d[a].sType||"string",u[e]._idx===n&&(u[e]._idx=i.inArray(u[e][1],d[a].asSorting)),c.push({src:l,col:a,dir:u[e][1],index:u[e]._idx,type:s,formatter:qe.ext.type.order[s+"-pre"]})
...
l===o.length?c.sort(function(e,t){var n,i,a,l,c=o.length,d=s[e]._aSortData,u=s[t]._aSortData
for(a=0;a<c;a++)if(l=o[a],n=d[l.col],i=u[l.col],n=n<i?-1:n>i?1:0,0!==n)return"asc"===l.dir?n:-n
return n=r[e],i=r[t],n<i?-1:n>i?1:0}):c.sort(function(e,t){var n,i,l,c,d=o.length,u=s[e]._aSortData,p=s[t]._aSortData
for(l=0;l<d;l++)if(c=o[l],n=u[c.col],i=p[c.col],c=a[c.type+"-"+c.dir]||a["string-"+c.dir],n=c(n,i),0!==n)return n
...
Oe(t,{},function(t){!1!==o.bSortable&&(e.oFeatures.bProcessing?(pe(e,!0),setTimeout(function(){De(e,n,t.shiftKey,i),"ssp"!==He(e)&&pe(e,!1)},0)):De(e,n,t.shiftKey,i))})}function ke(e){var t,n,o=e.aLastSort,r=e.oClasses.sSortColumn,a=_e(e),s=e.oFeatures
...
$e(e,"aoStateSaveParams","stateSaveParams",[e,t]),e.oSavedState=t,e.fnStateSaveCallback.call(e.oInstance,e,t)}}function Me(e){var t,o,r=e.aoColumns
...
s.visible!==n&&(r[t].bVisible=s.visible),s.search!==n&&i.extend(e.aoPreSearchCols[t],te(s.search))}$e(e,"aoStateLoaded","stateLoaded",[e,a])}}}function Ae(e){var t=qe.settings,e=i.inArray(e,st(t,"nTable"))
return-1!==e?t[e]:null}function Le(t,n,i,o){if(i="DataTables warning: "+(t?"table id="+t.sTableId+" - ":"")+i,o&&(i+=". For more information about this error, please see http://datatables.net/tn/"+o),n)e.console&&console.log&&console.log(i)
else if(n=qe.ext,n=n.sErrMode||n.errMode,t&&$e(t,null,"error",[t,o,i]),"alert"==n)alert(i)
else{if("throw"==n)throw Error(i)
"function"==typeof n&&n(t,o,i)}}function Fe(e,t,o,r){i.isArray(o)?i.each(o,function(n,o){i.isArray(o)?Fe(e,t,o[0],o[1]):Fe(e,t,o)}):(r===n&&(r=o),t[o]!==n&&(e[r]=t[o]))}function Pe(e,t,n){var o,r
...
return e}function Oe(e,t,n){i(e).bind("click.DT",t,function(t){e.blur(),n(t)}).bind("keypress.DT",t,function(e){13===e.which&&(e.preventDefault(),n(e))}).bind("selectstart.DT",function(){return!1})}function Ne(e,t,n,i){n&&e[t].push({fn:n,sName:i})}function $e(e,t,n,o){var r=[]
...
return i.isPlainObject(n)&&n[t]?o[n[t]]||o._:"string"==typeof n?o[n]||o._:o._}function He(e){return e.oFeatures.bServerSide?"ssp":e.ajax||e.sAjaxSource?"ajax":"dom"}function We(e,t){var n=[],n=Pt.numbers_length,i=Math.floor(n/2)
return t<=n?n=ct(0,t):e<=i?(n=ct(0,n-2),n.push("ellipsis"),n.push(t-1)):(e>=t-1-i?n=ct(t-(n-2),t):(n=ct(e-i+2,e+i-1),n.push("ellipsis"),n.push(t-1)),n.splice(0,0,"ellipsis"),n.splice(0,0,0)),n.DT_el="span",n}function Ye(e){i.each({num:function(t){return Ot(t,e)},"num-fmt":function(t){return Ot(t,e,tt)},"html-num":function(t){return Ot(t,e,Ze)},"html-num-fmt":function(t){return Ot(t,e,Ze,tt)}},function(t,n){Ue.type.order[t+e+"-pre"]=n,t.match(/^html\-/)&&(Ue.type.search[t+e]=Ue.type.search.html)})}function ze(e){return function(){var t=[Ae(this[qe.ext.iApiIndex])].concat(Array.prototype.slice.call(arguments))
return qe.ext.internal[e].apply(this,t)}}var qe,Ue,Be,Ve,Ge,Qe={},Je=/[\r\n]/g,Ze=/<.*?>/g,Xe=/^[\w\+\-]/,Ke=/[\w\+\-]$/,et=RegExp("(\\/|\\.|\\*|\\+|\\?|\\||\\(|\\)|\\[|\\]|\\{|\\}|\\\\|\\$|\\^|\\-)","g"),tt=/[',$£€¥%\u2009\u202F\u20BD\u20a9\u20BArfk]/gi,nt=function(e){return!e||!0===e||"-"===e},it=function(e){var t=parseInt(e,10)
...
return!!nt(e)||(t&&i&&(e=ot(e,t)),n&&i&&(e=e.replace(tt,"")),!isNaN(parseFloat(e))&&isFinite(e))},at=function(e,t,n){return!!nt(e)||(nt(e)||"string"==typeof e?!!rt(e.replace(Ze,""),t,n)||null:null)},st=function(e,t,i){var o=[],r=0,a=e.length
...
return o},dt=function(e){for(var t=[],n=0,i=e.length;n<i;n++)e[n]&&t.push(e[n])
return t},ut=function(e){var t,n,i,o=[],r=e.length,a=0
n=0
...
qe=function(e){this.$=function(e,t){return this.api(!0).$(e,t)},this._=function(e,t){return this.api(!0).rows(e,t).data()},this.api=function(e){return new Be(e?Ae(this[Ue.iApiIndex]):this)},this.fnAddData=function(e,t){var o=this.api(!0),r=i.isArray(e)&&(i.isArray(e[0])||i.isPlainObject(e[0]))?o.rows.add(e):o.row.add(e)
...
return"TR"==n?t.row(e).index():"TD"==n||"TH"==n?(e=t.cell(e).index(),[e.row,e.columnVisible,e.column]):null},this.fnIsOpen=function(e){return this.api(!0).row(e).child.isShown()},this.fnOpen=function(e,t,n){return this.api(!0).row(e).child(t,n).show().child()[0]},this.fnPageChange=function(e,t){var i=this.api(!0).page(e);(t===n||t)&&i.draw(!1)},this.fnSetColumnVis=function(e,t,i){e=this.api(!0).column(e).visible(t),(i===n||i)&&e.columns.adjust().draw()},this.fnSettings=function(){return Ae(this[Ue.iApiIndex])},this.fnSort=function(e){this.api(!0).order(e).draw()},this.fnSortListener=function(e,t,n){this.api(!0).order.listener(e,t,n)},this.fnUpdate=function(e,t,i,o,r){var a=this.api(!0)
...
var t=this,o=e===n,d=this.length
o&&(e={}),this.oApi=this.internal=Ue.internal
for(var f in qe.ext.internal)f&&(this[f]=ze(f))
return this.each(function(){var f,h={},h=1<d?Pe(h,e,!0):e,m=0,g=this.getAttribute("id"),v=!1,y=qe.defaults,_=i(this)
...
break}return void Le(S,0,"Cannot reinitialise DataTable",3)}if(S.sTableId==this.id){C.splice(m,1)
break}}null!==g&&""!==g||(this.id=g="DataTables_Table_"+qe.ext._unique++)
var T=i.extend(!0,{},qe.models.oSettings,{sDestroyWidth:_[0].style.width,sInstance:g,sTableId:g})
T.nTable=this,T.oApi=t.internal,T.oInit=h,C.push(T),T.oInstance=1===t.length?t:_.dataTable(),s(h),h.oLanguage&&a(h.oLanguage),h.aLengthMenu&&!h.iDisplayLength&&(h.iDisplayLength=i.isArray(h.aLengthMenu[0])?h.aLengthMenu[0][0]:h.aLengthMenu[0]),h=Pe(i.extend(!0,{},y),h),Fe(T.oFeatures,h,"bPaginate bLengthChange bFilter bSort bSortMulti bInfo bProcessing bAutoWidth bSortClasses bServerSide bDeferRender".split(" ")),Fe(T,h,["asStripeClasses","ajax","fnServerData","fnFormatNumber","sServerMethod","aaSorting","aaSortingFixed","aLengthMenu","sPaginationType","sAjaxSource","sAjaxDataProp","iStateDuration","sDom","bSortCellsTop","iTabIndex","fnStateLoadCallback","fnStateSaveCallback","renderer","searchDelay","rowId",["iCookieDuration","iStateDuration"],["oSearch","oPreviousSearch"],["aoSearchCols","aoPreSearchCols"],["iDisplayLength","_iDisplayLength"],["bJQueryUI","bJUI"]]),Fe(T.oScroll,h,[["sScrollX","sX"],["sScrollXInner","sXInner"],["sScrollY","sY"],["bScrollCollapse","bCollapse"]]),Fe(T.oLanguage,h,"fnInfoCallback"),Ne(T,"aoDrawCallback",h.fnDrawCallback,"user"),Ne(T,"aoServerParams",h.fnServerParams,"user"),Ne(T,"aoStateSaveParams",h.fnStateSaveParams,"user"),Ne(T,"aoStateLoadParams",h.fnStateLoadParams,"user"),Ne(T,"aoStateLoaded",h.fnStateLoaded,"user"),Ne(T,"aoRowCallback",h.fnRowCallback,"user"),Ne(T,"aoRowCreatedCallback",h.fnCreatedRow,"user"),Ne(T,"aoHeaderCallback",h.fnHeaderCallback,"user"),Ne(T,"aoFooterCallback",h.fnFooterCallback,"user"),Ne(T,"aoInitComplete",h.fnInitComplete,"user"),Ne(T,"aoPreDrawCallback",h.fnPreDrawCallback,"user"),T.rowIdFn=D(h.rowId),c(T),g=T.oClasses,h.bJQueryUI?(i.extend(g,qe.ext.oJUIClasses,h.oClasses),h.sDom===y.sDom&&"lfrtip"===y.sDom&&(T.sDom='<"H"lfr>t<"F"ip>'),T.renderer?i.isPlainObject(T.renderer)&&!T.renderer.header&&(T.renderer.header="jqueryui"):T.renderer="jqueryui"):i.extend(g,qe.ext.classes,h.oClasses),_.addClass(g.sTable),T.iInitDisplayStart===n&&(T.iInitDisplayStart=h.iDisplayStart,T._iDisplayStart=h.iDisplayStart),null!==h.iDeferLoading&&(T.bDeferLoading=!0,m=i.isArray(h.iDeferLoading),T._iRecordsDisplay=m?h.iDeferLoading[0]:h.iDeferLoading,T._iRecordsTotal=m?h.iDeferLoading[1]:h.iDeferLoading)
var k=T.oLanguage
i.extend(!0,k,h.oLanguage),""!==k.sUrl&&(i.ajax({dataType:"json",url:k.sUrl,success:function(e){a(e),r(y.oLanguage,e),i.extend(!0,k,e),re(T)},error:function(){re(T)}}),v=!0),null===h.asStripeClasses&&(T.asStripeClasses=[g.sStripeOdd,g.sStripeEven])
var m=T.asStripeClasses,E=_.children("tbody").find("tr").eq(0)
if(-1!==i.inArray(!0,i.map(m,function(e){return E.hasClass(e)}))&&(i("tbody tr",this).removeClass(m.join(" ")),T.asDestroyStripes=m.slice()),C=[],m=this.getElementsByTagName("thead"),0!==m.length&&(R(T.aoHeader,m[0]),C=H(T)),null===h.aoColumns)for(S=[],m=0,f=C.length;m<f;m++)S.push(null)
else S=h.aoColumns
for(m=0,f=S.length;m<f;m++)u(T,C?C[m]:null)
if(b(T,h.aoColumnDefs,S,function(e,t){p(T,e,t)}),E.length){var I=function(e,t){return null!==e.getAttribute("data-"+t)?t:null}
i(E[0]).children("th, td").each(function(e,t){var i=T.aoColumns[e]
if(i.mData===e){var o=I(t,"sort")||I(t,"order"),r=I(t,"filter")||I(t,"search")
null===o&&null===r||(i.mData={_:e+".display",sort:null!==o?e+".@data-"+o:n,type:null!==o?e+".@data-"+o:n,filter:null!==r?e+".@data-"+r:n},p(T,e))}})}var M=T.oFeatures
if(h.bStateSave&&(M.bStateSave=!0,Me(T,h),Ne(T,"aoDrawCallback",Ie,"state_save")),h.aaSorting===n)for(C=T.aaSorting,m=0,f=C.length;m<f;m++)C[m][1]=T.aoColumns[m].asSorting[0]
if(ke(T),M.bSort&&Ne(T,"aoDrawCallback",function(){if(T.bSorted){var e=_e(T),t={}
i.each(e,function(e,n){t[n.src]=n.dir}),$e(T,null,"order",[T,e,t]),Se(T)}}),Ne(T,"aoDrawCallback",function(){(T.bSorted||"ssp"===He(T)||M.bDeferRender)&&ke(T)},"sc"),m=_.children("caption").each(function(){this._captionSide=_.css("caption-side")}),f=_.children("thead"),0===f.length&&(f=i("<thead/>").appendTo(this)),T.nTHead=f[0],f=_.children("tbody"),0===f.length&&(f=i("<tbody/>").appendTo(this)),T.nTBody=f[0],f=_.children("tfoot"),0===f.length&&0<m.length&&(""!==T.oScroll.sX||""!==T.oScroll.sY)&&(f=i("<tfoot/>").appendTo(this)),0===f.length||0===f.children().length?_.addClass(g.sNoFooter):0<f.length&&(T.nTFoot=f[0],R(T.aoFooter,T.nTFoot)),h.aaData)for(m=0;m<h.aaData.length;m++)w(T,h.aaData[m])
...
return-1},iterator:function(e,t,i,o){var r,a,s,l,c,d,u,p=[],f=this.context,h=this.selector
...
else if("column"===t||"column-rows"===t||"row"===t||"cell"===t)for(u=this[a],"column-rows"===t&&(d=Dt(f[a],h.opts)),l=0,c=u.length;l<c;l++)r=u[l],r="cell"===t?i.call(m,f[a],r.row,r.column,a,l):i.call(m,f[a],r,a,l,d),r!==n&&p.push(r)}return p.length||o?(e=new Be(f,e?p.concat.apply([],p):p),t=e.selector,t.rows=h.rows,t.cols=h.cols,t.opts=h.opts,e):this},lastIndexOf:bt.lastIndexOf||function(e,t){return this.indexOf.apply(this.toArray.reverse(),arguments)},length:0,map:function(e){var t=[]
if(bt.map)t=bt.map.call(this,e,this)
else for(var n=0,i=this.length;n<i;n++)t.push(e.call(this,this[n],n))
return new Be(this.context,t)},pluck:function(e){return this.map(function(t){return t[e]})},pop:bt.pop,push:bt.push,reduce:bt.reduce||function(e,t){return d(this,e,t,0,this.length,1)},reduceRight:bt.reduceRight||function(e,t){return d(this,e,t,this.length-1,-1,-1)},reverse:bt.reverse,selector:null,shift:bt.shift,sort:bt.sort,splice:bt.splice,toArray:function(){return bt.slice.call(this)},to$:function(){return i(this)},toJQuery:function(){return i(this)},unique:function(){return new Be(this.context,ut(this))},unshift:bt.unshift}),Be.extend=function(e,t,n){if(n.length&&t&&(t instanceof Be||t.__dt_wrapper)){var o,r,a,s=function(e,t,n){return function(){var i=t.apply(e,arguments)
...
var c
e:{c=0
for(var d=l.length;c<d;c++)if(l[c].name===r){c=l[c]
...
var _t=function(e,t,o,r,a){var s,l,c,d,u,p,f=[]
for(c=typeof t,t&&"string"!==c&&"function"!==c&&t.length!==n||(t=[t]),c=0,d=t.length;c<d;c++)for(l=t[c]&&t[c].split?t[c].split(","):[t[c]],u=0,p=l.length;u<p;u++)(s=o("string"==typeof l[u]?i.trim(l[u]):l[u]))&&s.length&&(f=f.concat(s))
if(e=Ue.selector[e],e.length)for(c=0,d=e.length;c<d;c++)f=e[c](r,a,f)
return ut(f)},Ct=function(e){return e||(e={}),e.filter&&e.search===n&&(e.search=e.filter),i.extend({search:"none",order:"current",page:"all"},e)},St=function(e){for(var t=0,n=e.length;t<n;t++)if(0<e[t].length)return e[0]=e[t],e[0].length=1,e.length=1,e.context=[e.context[t]],e
...
return e(t,n._aData,n.nTr)?t:null}):(t=dt(lt(o.aoData,a,"nTr")),e.nodeName&&i.inArray(e,t)!==-1?[e._DT_RowIndex]:"string"==typeof e&&"#"===e.charAt(0)&&(a=o.aIds[e.replace(/^#/,"")],a!==n)?[a.idx]:i(t).filter(e).map(function(){return this._DT_RowIndex}).toArray()):a},o,r)},1)
...
return"search"===e?i._aFilterData:i._aSortData},1)}),Ge("rows().invalidate()","row().invalidate()",function(e){return this.iterator("row",function(t,n){M(t,n,e)})}),Ge("rows().indexes()","row().index()",function(){return this.iterator("row",function(e,t){return t},1)}),Ge("rows().ids()","row().id()",function(e){for(var t=[],n=this.context,i=0,o=n.length;i<o;i++)for(var r=0,a=this[i].length;r<a;r++){var s=n[i].rowIdFn(n[i].aoData[this[i][r]]._aData)
...
return e===n?t.length&&this.length?t[0].aoData[this[0]]._aData:n:(t[0].aoData[this[0]]._aData=e,M(t[0],this[0],"data"),this)}),Ve("row().node()",function(){var e=this.context
...
switch(c[2]){case"visIdx":case"visible":if(t=parseInt(c[1],10),t<0){var d=i.map(a,function(e,t){return e.bVisible?t:null})
return[d[d.length+t]]}return[h(n,t)]
...
return t?new Be(n):n},qe.util={throttle:ve,escapeRegex:X},qe.camelToHungarian=r,Ve("$()",function(e,t){var n=this.rows(t).nodes(),n=i(n)
...
var Mt="",Mt="",At=Mt+"ui-state-default",Lt=Mt+"css_right ui-icon ui-icon-",Ft=Mt+"fg-toolbar ui-toolbar ui-widget-header ui-helper-clearfix"
i.extend(qe.ext.oJUIClasses,qe.ext.classes,{sPageButton:"fg-button ui-button "+At,sPageButtonActive:"ui-state-disabled",sPageButtonDisabled:"ui-state-disabled",sPaging:"dataTables_paginate fg-buttonset ui-buttonset fg-buttonset-multi ui-buttonset-multi paging_",sSortAsc:At+" sorting_asc",sSortDesc:At+" sorting_desc",sSortable:At+" sorting",sSortableAsc:At+" sorting_asc_disabled",sSortableDesc:At+" sorting_desc_disabled",sSortableNone:At+" sorting_disabled",sSortJUIAsc:Lt+"triangle-1-n",sSortJUIDesc:Lt+"triangle-1-s",sSortJUI:Lt+"carat-2-n-s",sSortJUIAscAllowed:Lt+"carat-1-n",sSortJUIDescAllowed:Lt+"carat-1-s",sSortJUIWrapper:"DataTables_sort_wrapper",sSortIcon:"DataTables_sort_icon",sScrollHead:"dataTables_scrollHead "+At,sScrollFoot:"dataTables_scrollFoot "+At,sHeaderTH:At,sFooterTH:At,sJUIHeader:Ft+" ui-corner-tl ui-corner-tr",sJUIFooter:Ft+" ui-corner-bl ui-corner-br"})
var Pt=qe.ext.pager
i.extend(Pt,{simple:function(){return["previous","next"]},full:function(){return["first","previous","next","last"]},numbers:function(e,t){return[We(e,t)]},simple_numbers:function(e,t){return["previous",We(e,t),"next"]},full_numbers:function(e,t){return["first","previous",We(e,t),"next","last"]},_numbers:We,numbers_length:7}),i.extend(!0,qe.ext.renderer,{pageButton:{_:function(e,n,o,r,a,s){var l,c,d,u=e.oClasses,p=e.oLanguage.oPaginate,f=0,h=function(t,n){var r,d,m,g,v=function(t){de(e,t.data.action,!0)}
for(r=0,d=n.length;r<d;r++)if(g=n[r],i.isArray(g))m=i("<"+(g.DT_el||"div")+"/>").appendTo(t),h(m,g)
else{switch(l=null,c="",g){case"ellipsis":t.append('<span class="ellipsis">&#x2026;</span>')
break
case"first":l=p.sFirst,c=g+(a>0?"":" "+u.sPageButtonDisabled)
break
case"previous":l=p.sPrevious,c=g+(a>0?"":" "+u.sPageButtonDisabled)
break
case"next":l=p.sNext,c=g+(a<s-1?"":" "+u.sPageButtonDisabled)
break
case"last":l=p.sLast,c=g+(a<s-1?"":" "+u.sPageButtonDisabled)
break
default:l=g+1,c=a===g?u.sPageButtonActive:""}null!==l&&(m=i("<a>",{class:u.sPageButton+" "+c,"aria-controls":e.sTableId,"data-dt-idx":f,tabindex:e.iTabIndex,id:0===o&&"string"==typeof g?e.sTableId+"_"+g:null}).html(l).appendTo(t),Oe(m,{action:g},v),f++)}}
try{d=i(n).find(t.activeElement).data("dt-idx")}catch(e){}h(i(n).empty(),r),d&&i(n).find("[data-dt-idx="+d+"]").focus()}}}),i.extend(qe.ext.type.detect,[function(e,t){var n=t.oLanguage.sDecimal
...
return at(e,n,!0)?"html-num-fmt"+n:null},function(e){return nt(e)||"string"==typeof e&&-1!==e.indexOf("<")?"html":null}]),i.extend(qe.ext.type.search,{html:function(e){return nt(e)?e:"string"==typeof e?e.replace(Je," ").replace(Ze,""):""},string:function(e){return nt(e)?e:"string"==typeof e?e.replace(Je," "):e}})
var Ot=function(e,t,n,i){return 0===e||e&&"-"!==e?(t&&(e=ot(e,t)),e.replace&&(n&&(e=e.replace(n,"")),i&&(e=e.replace(i,""))),1*e):-(1/0)}
...
return a+(i||"")+s.toString().replace(/\B(?=(\d{3})+(?!\d))/g,e)+r+(o||"")}}}},i.extend(qe.ext.internal,{_fnExternApiFunc:ze,_fnBuildAjax:W,_fnAjaxUpdate:Y,_fnAjaxParameters:z,_fnAjaxUpdateDraw:q,_fnAjaxDataSrc:U,_fnAddColumn:u,_fnColumnOptions:p,_fnAdjustColumnSizing:f,_fnVisibleToColumnIndex:h,_fnColumnIndexToVisible:m,_fnVisbleColumns:g,_fnGetColumns:v,_fnColumnTypes:y,_fnApplyColumnDefs:b,_fnHungarianMap:o,_fnCamelToHungarian:r,_fnLanguageCompat:a,_fnBrowserDetect:c,_fnAddData:w,_fnAddTr:x,_fnNodeToDataIndex:function(e,t){return t._DT_RowIndex!==n?t._DT_RowIndex:null},_fnNodeToColumnIndex:function(e,t,n){return i.inArray(n,e.aoData[t].anCells)},_fnGetCellData:_,_fnSetCellData:C,_fnSplitObjNotation:S,_fnGetObjectDataFn:D,_fnSetObjectDataFn:T,_fnGetDataMaster:k,_fnClearTable:E,_fnDeleteIndex:I,_fnInvalidate:M,_fnGetRowElements:A,_fnCreateTr:L,_fnBuildHead:P,_fnDrawHead:O,_fnDraw:N,_fnReDraw:$,_fnAddOptionsHtml:j,_fnDetectHeader:R,_fnGetUniqueThs:H,_fnFeatureHtmlFilter:B,_fnFilterComplete:V,_fnFilterCustom:G,_fnFilterColumn:Q,_fnFilter:J,_fnFilterCreateSearch:Z,_fnEscapeRegex:X,_fnFilterData:K,_fnFeatureHtmlInfo:ne,_fnUpdateInfo:ie,_fnInfoMacros:oe,_fnInitialise:re,_fnInitComplete:ae,_fnLengthChange:se,_fnFeatureHtmlLength:le,_fnFeatureHtmlPaginate:ce,_fnPageChange:de,_fnFeatureHtmlProcessing:ue,_fnProcessingDisplay:pe,_fnFeatureHtmlTable:fe,_fnScrollDraw:he,_fnApplyToChildren:me,_fnCalculateColumnWidths:ge,_fnThrottle:ve,_fnConvertToWidth:ye,_fnGetWidestNode:be,_fnGetMaxLenString:we,_fnStringToCss:xe,_fnSortFlatten:_e,_fnSort:Ce,_fnSortAria:Se,_fnSortListener:De,_fnSortAttachListener:Te,_fnSortingClasses:ke,_fnSortData:Ee,_fnSaveState:Ie,_fnLoadState:Me,_fnSettingsFromNode:Ae,_fnLog:Le,_fnMap:Fe,_fnBindAction:Oe,_fnCallbackReg:Ne,_fnCallbackFire:$e,_fnLengthOverflow:je,_fnRenderer:Re,_fnDataSource:He,_fnRowAttributes:F,_fnCalculateEnd:function(){}}),i.fn.dataTable=qe,i.fn.dataTableSettings=qe.settings,i.fn.dataTableExt=qe.ext,i.fn.DataTable=function(e){return i(this).dataTable(e).api()},i.each(qe,function(e,t){i.fn.DataTable[e]=t}),i.fn.dataTable}
...
var c=r[0],d=e.Event("slide.bs.carousel",{relatedTarget:c,direction:s})
...
u&&u.addClass("active")}var p=e.Event("slid.bs.carousel",{relatedTarget:c,direction:s})
...
var d=this.getPosition(),u=r[0].offsetWidth,p=r[0].offsetHeight
if(c){var f=s,h=this.getPosition(this.$viewport)
s="bottom"==s&&d.bottom+p>h.bottom?"top":"top"==s&&d.top-p<h.top?"bottom":"right"==s&&d.right+u>h.width?"left":"left"==s&&d.left-u<h.left?"right":s,r.removeClass(f).addClass(s)}var m=this.getCalculatedOffset(s,d,u,p)
...
var u=/top|bottom/.test(n),p=u?2*d.left-o+l:2*d.top-r+c,f=u?"offsetWidth":"offsetHeight"
i.offset(t),this.replaceArrow(p,i[0][f],u)},n.prototype.replaceArrow=function(e,t,n){this.arrow().css(n?"left":"top",50*(1-e/t)+"%").css(n?"top":"left","")},n.prototype.setContent=function(){var e=this.tip(),t=this.getTitle()
...
s<a.top?o.top=a.top-s:l>a.top+a.height&&(o.top=a.top+a.height-l)}else{var c=t.left-r,d=t.left+r+n
c<a.left?o.left=a.left-c:d>a.right&&(o.left=a.left+a.width-d)}return o},n.prototype.getTitle=function(){var e,t=this.$element,n=this.options
...
c=c.charAt(0).toUpperCase()+c.slice(1),t["init"+c].call(t)}S("BeforeOpen"),t.st.showCloseBtn&&(t.st.closeBtnInside?(_(u,function(e,t,n,i){n.close_replaceWith=D(i.type)}),r+=" mfp-close-btn-in"):t.wrap.append(D())),t.st.alignTop&&(r+=" mfp-align-top"),t.fixedContentPos?t.wrap.css({overflow:t.st.overflowY,overflowX:"hidden",overflowY:t.st.overflowY}):t.wrap.css({top:x.scrollTop(),position:"absolute"}),(t.st.fixedBgPos===!1||"auto"===t.st.fixedBgPos&&!t.fixedContentPos)&&t.bgOverlay.css({height:i.height(),position:"absolute"}),t.st.enableEscapeKey&&i.on("keyup"+m,function(e){27===e.keyCode&&t.close()}),x.on("resize"+m,function(){t.updateSize()}),t.st.closeOnContentClick||(r+=" mfp-auto-cursor"),r&&t.wrap.addClass(r)
var d=t.wH=x.height(),f={}
if(t.fixedContentPos&&t._hasScrollBar(d)){var h=t._getScrollbarSize()
h&&(f.marginRight=h)}t.fixedContentPos&&(t.isIE7?e("body, html").css("overflow","hidden"):f.overflow="hidden")
var v=t.st.mainClass
return t.isIE7&&(v+=" mfp-ie7"),v&&t._addClassToMFP(v),t.updateItemHTML(),S("BuildControls"),e("html").css(f),t.bgOverlay.add(t.wrap).prependTo(t.st.prependTo||e(document.body)),t._lastFocusedEl=document.activeElement,setTimeout(function(){t.content?(t._addClassToMFP(g),t._setFocus()):t.bgOverlay.addClass(g),i.on("focusin"+m,t._onFocusIn)},16),t.isOpen=!0,t.updateSize(d),S(p),n},close:function(){t.isOpen&&(S(l),t.isOpen=!1,t.st.removalDelay&&!t.isLowIE&&t.supportsTransition?(t._addClassToMFP(v),setTimeout(function(){t._close()},t.st.removalDelay)):t._close())},_close:function(){S(s)
var n=v+" "+g+" "
...
t.appendContent(a,i),n.preloaded=!0,S(f,n),o=n.type,t.container.prepend(t.contentContainer),S("AfterChange")},appendContent:function(e,n){t.content=e,e?t.st.showCloseBtn&&t.st.closeBtnInside&&t.currTemplate[n]===!0?t.content.find(".mfp-close").length||t.content.append(D()):t.content=e:t.content="",S(d),t.container.addClass("mfp-"+n+"-holder"),t.contentContainer.append(t.content)},parseEl:function(n){var i,o=t.items[n]
...
i.data&&(n=e.extend(i.data,n)),S(u,[t,n,i]),e.each(n,function(n,i){if(void 0===i||i===!1)return!0
...
return i}
var E,I,M,A="inline",L=function(){M&&(I.after(M.addClass(E)).detach(),M=null)}
e.magnificPopup.registerModule(A,{options:{hiddenClass:"hide",markup:"",tNotFound:"Content not found"},proto:{initInline:function(){t.types.push(A),_(s+"."+A,function(){L()})},getInline:function(n,i){if(L(),n.src){var o=t.st.inline,r=e(n.src)
if(r.length){var a=r[0].parentNode
a&&a.tagName&&(I||(E=o.hiddenClass,I=C(E),E="mfp-"+E),M=r.after(I).detach().removeClass(E)),t.updateStatus("ready")}else t.updateStatus("error",o.tNotFound),r=e("<div>")
return n.inlineElement=r,r}return t.updateStatus("ready"),t._parseMarkup(i,{},n),i}}})
var F,P="ajax",O=function(){F&&e(document.body).removeClass(F)},N=function(){O(),t.req&&t.req.abort()}
e.magnificPopup.registerModule(P,{options:{settings:null,cursor:"mfp-ajax-cur",tError:'<a href="%url%">The content</a> could not be loaded.'},proto:{initAjax:function(){t.types.push(P),F=t.st.ajax.cursor,_(s+"."+P,N),_("BeforeChange."+P,N)},getAjax:function(n){F&&e(document.body).addClass(F),t.updateStatus("loading")
var i=e.extend({url:n.src,success:function(i,o,r){var a={data:i,xhr:r}
S("ParseAjax",a),t.appendContent(e(a.data),P),n.finished=!0,O(),t._setFocus(),setTimeout(function(){t.wrap.addClass(g)},16),t.updateStatus("ready"),S("AjaxContentAdded")},error:function(){O(),n.finished=n.loadError=!0,t.updateStatus("error",t.st.ajax.tError.replace("%url%",n.src))}},t.st.ajax.settings)
...
_("BuildControls"+i,function(){if(t._allowZoom()){if(clearTimeout(o),t.content.css("visibility","hidden"),e=t._getItemToZoom(),!e)return void d()
r=c(e),r.css(t._getOffset()),t.wrap.append(r),o=setTimeout(function(){r.css(t._getOffset(!0)),o=setTimeout(function(){d(),setTimeout(function(){r.remove(),e=r=null,S("ZoomAnimationEnded")},16)},a)},16)}}),_(l+i,function(){if(t._allowZoom()){if(clearTimeout(o),t.st.removalDelay=a,!e){if(e=t._getItemToZoom(),!e)return
...
var W="iframe",Y="//about:blank",z=function(e){if(t.currTemplate[W]){var n=t.currTemplate[W].find("iframe")
n.length&&(e||(n[0].src=Y),t.isIE8&&n.css("display",e?"block":"none"))}}
e.magnificPopup.registerModule(W,{options:{markup:'<div class="mfp-iframe-scaler"><div class="mfp-close"></div><iframe class="mfp-iframe" src="//about:blank" frameborder="0" allowfullscreen></iframe></div>',srcAction:"iframe_src",patterns:{youtube:{index:"youtube.com",id:"v=",src:"//www.youtube.com/embed/%id%?autoplay=1"},vimeo:{index:"vimeo.com/",id:"/",src:"//player.vimeo.com/video/%id%?autoplay=1"},gmaps:{index:"//maps.google.",src:"%id%&output=embed"}}},proto:{initIframe:function(){t.types.push(W),_("BeforeChange",function(e,t,n){t!==n&&(t===W?z():n===W&&z(!0))}),_(s+"."+W,function(){z()})},getIframe:function(n,i){var o=n.src,r=t.st.iframe
...
return t.direction=!0,!(!n||!n.enabled)&&(r+=" mfp-gallery",_(p+o,function(){n.navigateByImgClick&&t.wrap.on("click"+o,".mfp-img",function(){if(t.items.length>1)return t.next(),!1}),i.on("keydown"+o,function(e){37===e.keyCode?t.prev():39===e.keyCode&&t.next()})}),_("UpdateStatus"+o,function(e,n){n.text&&(n.text=U(n.text,t.currItem.index,t.items.length))}),_(u+o,function(e,i,o,r){var a=t.items.length
...
void 0!==t[n]&&(o[e]=t[n])}),o},P=function(){var t,o=(f||n).position(),r=(f||n).offset(),a=i.widgetPositioning.vertical,s=i.widgetPositioning.horizontal
...
h.css({top:"top"===a?"auto":o.top+n.outerHeight(),bottom:"top"===a?t.outerHeight()-(t===n?0:o.top):"auto",left:"left"===s?t===n?0:o.left:"auto",right:"left"===s?"auto":t.outerWidth()-n.outerWidth()-(t===n?0:o.left)})},O=function(e){"dp.change"===e.type&&(e.date&&e.date.isSame(e.oldDate)||!e.date&&!e.oldDate)||n.trigger(e)},N=function(e){"y"===e&&(e="YYYY"),O({type:"dp.update",change:e,viewDate:r.clone()})},$=function(e){h&&(e&&(d=Math.max(m,Math.min(3,d+e))),h.find(".datepicker > div").hide().filter(".datepicker-"+g[d].clsName).show())},j=function(){var t=e("<tr>"),n=r.clone().startOf("w").startOf("d")
...
h.find(".datepicker-days thead").append(t)},R=function(e){return i.disabledDates[e.format("YYYY-MM-DD")]===!0},H=function(e){return i.enabledDates[e.format("YYYY-MM-DD")]===!0},W=function(e){return i.disabledHours[e.format("H")]===!0},Y=function(e){return i.enabledHours[e.format("H")]===!0},z=function(t,n){if(!t.isValid())return!1
...
n.eq(0).find("span").attr("title",i.tooltips.prevYear),n.eq(1).attr("title",i.tooltips.selectYear),n.eq(2).find("span").attr("title",i.tooltips.nextYear),t.find(".disabled").removeClass("disabled"),z(r.clone().subtract(1,"y"),"y")||n.eq(0).addClass("disabled"),n.eq(1).text(r.year()),z(r.clone().add(1,"y"),"y")||n.eq(2).addClass("disabled"),a.removeClass("active"),o.isSame(r,"y")&&!p&&a.eq(o.month()).addClass("active"),a.each(function(t){z(r.clone().month(t),"M")||e(this).addClass("disabled")})},B=function(){var e=h.find(".datepicker-years"),t=e.find("th"),n=r.clone().subtract(5,"y"),a=r.clone().add(6,"y"),s=""
...
t.empty().append(i)},J=function(){for(var t=h.find(".timepicker-minutes table"),n=r.clone().startOf("h"),o=[],a=e("<tr>"),s=1===i.stepping?5:i.stepping;r.isSame(n,"h");)n.minute()%(4*s)===0&&(a=e("<tr>"),o.push(a)),a.append('<td data-action="selectMinute" class="minute'+(z(n,"m")?"":" disabled")+'">'+n.format("mm")+"</td>"),n.add(s,"m")
t.empty().append(o)},Z=function(){for(var t=h.find(".timepicker-seconds table"),n=r.clone().startOf("m"),i=[],o=e("<tr>");r.isSame(n,"m");)n.second()%20===0&&(o=e("<tr>"),i.push(o)),o.append('<td data-action="selectSecond" class="second'+(z(n,"s")?"":" disabled")+'">'+n.format("ss")+"</td>"),n.add(5,"s")
t.empty().append(i)},X=function(){var e,t,n=h.find(".timepicker span[data-time-component]")
s||(e=h.find(".timepicker [data-action=togglePeriod]"),t=o.clone().add(o.hours()>=12?-12:12,"h"),e.text(o.format("A")),z(t,"h")?e.removeClass("disabled"):e.addClass("disabled")),n.filter("[data-time-component=hours]").text(o.format(s?"HH":"hh")),n.filter("[data-time-component=minutes]").text(o.format("mm")),n.filter("[data-time-component=seconds]").text(o.format("ss")),Q(),J(),Z()},K=function(){h&&(G(),X())},ee=function(e){var t=p?null:o
if(!e)return p=!0,a.val(""),n.data("date",""),O({type:"dp.change",date:!1,oldDate:t}),void K()
...
z(e)?(o=e,r=o.clone(),a.val(o.format(l)),n.data("date",o.format(l)),p=!1,K(),O({type:"dp.change",date:o.clone(),oldDate:t})):(i.keepInvalid?O({type:"dp.change",date:e,oldDate:t}):a.val(p?"":o.format(l)),O({type:"dp.error",date:e,oldDate:t}))},te=function(){var t=!1
return h?(h.find(".collapse").each(function(){var n=e(this).data("collapse")
return!n||!n.transitioning||(t=!0,!1)}),t?u:(f&&f.hasClass("btn")&&f.toggleClass("active"),h.hide(),e(window).off("resize",P),h.off("click","[data-action]"),h.off("mousedown",!1),h.remove(),h=!1,O({type:"dp.hide",date:o.clone()}),a.blur(),r=o.clone(),u)):u},ne=function(){ee(null)},ie=function(e){return void 0===i.parseInputDate?(!t.isMoment(e)||e instanceof Date)&&(e=S(e)):e=i.parseInputDate(e),e},oe={next:function(){var e=g[d].navFnc
r.add(g[d].navStep,e),G(),N(e)},previous:function(){var e=g[d].navFnc
r.subtract(g[d].navStep,e),G(),N(e)},pickerSwitch:function(){$(1)},selectMonth:function(t){var n=e(t.target).closest("tbody").find("span").index(e(t.target))
r.month(n),d===m?(ee(o.clone().year(r.year()).month(r.month())),i.inline||te()):($(-1),G()),N("M")},selectYear:function(t){var n=parseInt(e(t.target).text(),10)||0
r.year(n),d===m?(ee(o.clone().year(r.year())),i.inline||te()):($(-1),G()),N("YYYY")},selectDecade:function(t){var n=parseInt(e(t.target).data("selection"),10)||0
r.year(n),d===m?(ee(o.clone().year(r.year())),i.inline||te()):($(-1),G()),N("YYYY")},selectDay:function(t){var n=r.clone()
...
s||(o.hours()>=12?12!==n&&(n+=12):12===n&&(n=0)),ee(o.clone().hours(n)),oe.showPicker.call(u)},selectMinute:function(t){ee(o.clone().minutes(parseInt(e(t.target).text(),10))),oe.showPicker.call(u)},selectSecond:function(t){ee(o.clone().seconds(parseInt(e(t.target).text(),10))),oe.showPicker.call(u)},clear:ne,today:function(){var e=S()
z(e,"d")&&ee(e)},close:te},re=function(t){return!e(t.currentTarget).is(".disabled")&&(oe[e(t.currentTarget).data("action")].apply(u,arguments),!1)},ae=function(){var t,n={year:function(e){return e.month(0).date(1).hours(0).seconds(0).minutes(0)},month:function(e){return e.date(1).hours(0).seconds(0).minutes(0)},day:function(e){return e.hours(0).seconds(0).minutes(0)},hour:function(e){return e.seconds(0).minutes(0)},minute:function(e){return e.seconds(0)}}
return a.prop("disabled")||!i.ignoreReadonly&&a.prop("readonly")||h?u:(void 0!==a.val()&&0!==a.val().trim().length?ee(ie(a.val().trim())):p&&i.useCurrent&&(i.inline||a.is("input")&&0===a.val().trim().length)&&(t=S(),"string"==typeof i.useCurrent&&(t=n[i.useCurrent](t)),ee(t)),h=L(),j(),q(),h.find(".timepicker-hours").hide(),h.find(".timepicker-minutes").hide(),h.find(".timepicker-seconds").hide(),K(),$(),e(window).on("resize",P),h.on("click","[data-action]",re),h.on("mousedown",!1),f&&f.hasClass("btn")&&f.toggleClass("active"),P(),h.show(),i.focusOnShow&&!a.is(":focus")&&a.focus(),O({type:"dp.show"}),u)},se=function(){return h?te():ae()},le=function(e){var t,n,o,r,a=null,s=[],l={},c=e.which,d="p"
_[c]=d
for(t in _)_.hasOwnProperty(t)&&_[t]===d&&(s.push(t),parseInt(t,10)!==c&&(l[t]=!0))
...
break}}a&&(a.call(u,h),e.stopPropagation(),e.preventDefault())},ce=function(e){_[e.which]="r",e.stopPropagation(),e.preventDefault()},de=function(t){var n=e(t.target).val().trim(),i=n?ie(n):null
return ee(i),t.stopImmediatePropagation(),!1},ue=function(){a.on({change:de,blur:i.debug?"":te,keydown:le,keyup:ce,focus:i.allowInputToggle?ae:""}),n.is("input")?a.on({focus:ae}):f&&(f.on("click",se),f.on("mousedown",!1))},pe=function(){a.off({change:de,blur:blur,keydown:le,keyup:ce,focus:i.allowInputToggle?te:""}),n.is("input")?a.off({focus:ae}):f&&(f.off("click",se),f.off("mousedown",!1))},fe=function(t){var n={}
...
return t.replace(/(\[[^\[]*\])|(\\)?(LTS|LT|LL?L?L?|l{1,4})/g,function(e){return o.localeData().longDateFormat(e)||e})}),c=i.extraFormats?i.extraFormats.slice():[],c.indexOf(e)<0&&c.indexOf(l)<0&&c.push(l),s=l.toLowerCase().indexOf("a")<1&&l.replace(/\[.*?\]/g,"").indexOf("h")<1,D("y")&&(m=2),D("M")&&(m=1),D("d")&&(m=0),d=Math.max(m,d),p||ee(o)}
if(u.destroy=function(){te(),pe(),n.removeData("DateTimePicker"),n.removeData("date")},u.toggle=se,u.show=ae,u.hide=te,u.disable=function(){return te(),f&&f.hasClass("btn")&&f.addClass("disabled"),a.prop("disabled",!0),u},u.enable=function(){return f&&f.hasClass("btn")&&f.removeClass("disabled"),a.prop("disabled",!1),u},u.ignoreReadonly=function(e){if(0===arguments.length)return i.ignoreReadonly
if("boolean"!=typeof e)throw new TypeError("ignoreReadonly () expects a boolean parameter")
return i.ignoreReadonly=e,u},u.options=function(t){if(0===arguments.length)return e.extend(!0,{},i)
if(!(t instanceof Object))throw new TypeError("options() options parameter should be an object")
return e.extend(!0,i,t),e.each(i,function(e,t){if(void 0===u[e])throw new TypeError("option "+e+" is not recognized!")
u[e](t)}),u},u.date=function(e){if(0===arguments.length)return p?null:o.clone()
if(!(null===e||"string"==typeof e||t.isMoment(e)||e instanceof Date))throw new TypeError("date() parameter must be one of [null, string, moment or Date]")
return ee(null===e?null:ie(e)),u},u.format=function(e){if(0===arguments.length)return i.format
if("string"!=typeof e&&("boolean"!=typeof e||e!==!1))throw new TypeError("format() expects a string or boolean:false parameter "+e)
return i.format=e,l&&me(),u},u.timeZone=function(e){if(0===arguments.length)return i.timeZone
if("string"!=typeof e)throw new TypeError("newZone() expects a string parameter")
return i.timeZone=e,u},u.dayViewHeaderFormat=function(e){if(0===arguments.length)return i.dayViewHeaderFormat
if("string"!=typeof e)throw new TypeError("dayViewHeaderFormat() expects a string parameter")
return i.dayViewHeaderFormat=e,u},u.extraFormats=function(e){if(0===arguments.length)return i.extraFormats
if(e!==!1&&!(e instanceof Array))throw new TypeError("extraFormats() expects an array or false parameter")
return i.extraFormats=e,c&&me(),u},u.disabledDates=function(t){if(0===arguments.length)return i.disabledDates?e.extend({},i.disabledDates):i.disabledDates
if(!t)return i.disabledDates=!1,K(),u
if(!(t instanceof Array))throw new TypeError("disabledDates() expects an array parameter")
return i.disabledDates=fe(t),i.enabledDates=!1,K(),u},u.enabledDates=function(t){if(0===arguments.length)return i.enabledDates?e.extend({},i.enabledDates):i.enabledDates
if(!t)return i.enabledDates=!1,K(),u
if(!(t instanceof Array))throw new TypeError("enabledDates() expects an array parameter")
return i.enabledDates=fe(t),i.disabledDates=!1,K(),u},u.daysOfWeekDisabled=function(e){if(0===arguments.length)return i.daysOfWeekDisabled.splice(0)
if("boolean"==typeof e&&!e)return i.daysOfWeekDisabled=!1,K(),u
...
t++}ee(o)}return K(),u},u.maxDate=function(e){if(0===arguments.length)return i.maxDate?i.maxDate.clone():i.maxDate
if("boolean"==typeof e&&e===!1)return i.maxDate=!1,K(),u
...
return i.maxDate=t,i.useCurrent&&!i.keepInvalid&&o.isAfter(e)&&ee(i.maxDate),r.isAfter(t)&&(r=t.clone().subtract(i.stepping,"m")),K(),u},u.minDate=function(e){if(0===arguments.length)return i.minDate?i.minDate.clone():i.minDate
if("boolean"==typeof e&&e===!1)return i.minDate=!1,K(),u
"string"==typeof e&&("now"!==e&&"moment"!==e||(e=S()))
var t=ie(e)
...
return i.minDate=t,i.useCurrent&&!i.keepInvalid&&o.isBefore(e)&&ee(i.minDate),r.isBefore(t)&&(r=t.clone().add(i.stepping,"m")),K(),u},u.defaultDate=function(e){if(0===arguments.length)return i.defaultDate?i.defaultDate.clone():i.defaultDate
...
return i.defaultDate=t,(i.defaultDate&&i.inline||""===a.val().trim())&&ee(i.defaultDate),u},u.locale=function(e){if(0===arguments.length)return i.locale
if(!t.localeData(e))throw new TypeError("locale() locale "+e+" is not loaded from moment locales!")
return i.locale=e,o.locale(i.locale),r.locale(i.locale),l&&me(),h&&(te(),ae()),u},u.stepping=function(e){return 0===arguments.length?i.stepping:(e=parseInt(e,10),(isNaN(e)||e<1)&&(e=1),i.stepping=e,u)},u.useCurrent=function(e){var t=["year","month","day","hour","minute"]
...
return i.useCurrent=e,u},u.collapse=function(e){if(0===arguments.length)return i.collapse
if("boolean"!=typeof e)throw new TypeError("collapse() expects a boolean parameter")
return i.collapse===e?u:(i.collapse=e,h&&(te(),ae()),u)},u.icons=function(t){if(0===arguments.length)return e.extend({},i.icons)
if(!(t instanceof Object))throw new TypeError("icons() expects parameter to be an Object")
return e.extend(i.icons,t),h&&(te(),ae()),u},u.tooltips=function(t){if(0===arguments.length)return e.extend({},i.tooltips)
if(!(t instanceof Object))throw new TypeError("tooltips() expects parameter to be an Object")
return e.extend(i.tooltips,t),h&&(te(),ae()),u},u.useStrict=function(e){if(0===arguments.length)return i.useStrict
if("boolean"!=typeof e)throw new TypeError("useStrict() expects a boolean parameter")
return i.useStrict=e,u},u.sideBySide=function(e){if(0===arguments.length)return i.sideBySide
if("boolean"!=typeof e)throw new TypeError("sideBySide() expects a boolean parameter")
return i.sideBySide=e,h&&(te(),ae()),u},u.viewMode=function(e){if(0===arguments.length)return i.viewMode
if("string"!=typeof e)throw new TypeError("viewMode() expects a string parameter")
if(v.indexOf(e)===-1)throw new TypeError("viewMode() parameter must be one of ("+v.join(", ")+") value")
return i.viewMode=e,d=Math.max(v.indexOf(e),m),$(),u},u.toolbarPlacement=function(e){if(0===arguments.length)return i.toolbarPlacement
if("string"!=typeof e)throw new TypeError("toolbarPlacement() expects a string parameter")
if(w.indexOf(e)===-1)throw new TypeError("toolbarPlacement() parameter must be one of ("+w.join(", ")+") value")
return i.toolbarPlacement=e,h&&(te(),ae()),u},u.widgetPositioning=function(t){if(0===arguments.length)return e.extend({},i.widgetPositioning)
...
i.widgetPositioning.vertical=t.vertical}return K(),u},u.calendarWeeks=function(e){if(0===arguments.length)return i.calendarWeeks
if("boolean"!=typeof e)throw new TypeError("calendarWeeks() expects parameter to be a boolean value")
return i.calendarWeeks=e,K(),u},u.showTodayButton=function(e){if(0===arguments.length)return i.showTodayButton
if("boolean"!=typeof e)throw new TypeError("showTodayButton() expects a boolean parameter")
return i.showTodayButton=e,h&&(te(),ae()),u},u.showClear=function(e){if(0===arguments.length)return i.showClear
if("boolean"!=typeof e)throw new TypeError("showClear() expects a boolean parameter")
return i.showClear=e,h&&(te(),ae()),u},u.widgetParent=function(t){if(0===arguments.length)return i.widgetParent
if("string"==typeof t&&(t=e(t)),null!==t&&"string"!=typeof t&&!(t instanceof e))throw new TypeError("widgetParent() expects a string or a jQuery object parameter")
return i.widgetParent=t,h&&(te(),ae()),u},u.keepOpen=function(e){if(0===arguments.length)return i.keepOpen
if("boolean"!=typeof e)throw new TypeError("keepOpen() expects a boolean parameter")
return i.keepOpen=e,u},u.focusOnShow=function(e){if(0===arguments.length)return i.focusOnShow
if("boolean"!=typeof e)throw new TypeError("focusOnShow() expects a boolean parameter")
return i.focusOnShow=e,u},u.inline=function(e){if(0===arguments.length)return i.inline
if("boolean"!=typeof e)throw new TypeError("inline() expects a boolean parameter")
return i.inline=e,u},u.clear=function(){return ne(),u},u.keyBinds=function(e){return 0===arguments.length?i.keyBinds:(i.keyBinds=e,u)},u.getMoment=function(e){return S(e)},u.debug=function(e){if("boolean"!=typeof e)throw new TypeError("debug() expects a boolean parameter")
return i.debug=e,u},u.allowInputToggle=function(e){if(0===arguments.length)return i.allowInputToggle
if("boolean"!=typeof e)throw new TypeError("allowInputToggle() expects a boolean parameter")
return i.allowInputToggle=e,u},u.showClose=function(e){if(0===arguments.length)return i.showClose
if("boolean"!=typeof e)throw new TypeError("showClose() expects a boolean parameter")
return i.showClose=e,u},u.keepInvalid=function(e){if(0===arguments.length)return i.keepInvalid
if("boolean"!=typeof e)throw new TypeError("keepInvalid() expects a boolean parameter")
return i.keepInvalid=e,u},u.datepickerInput=function(e){if(0===arguments.length)return i.datepickerInput
if("string"!=typeof e)throw new TypeError("datepickerInput() expects a string parameter")
return i.datepickerInput=e,u},u.parseInputDate=function(e){if(0===arguments.length)return i.parseInputDate
if("function"!=typeof e)throw new TypeError("parseInputDate() sholud be as function")
return i.parseInputDate=e,u},u.disabledTimeIntervals=function(t){if(0===arguments.length)return i.disabledTimeIntervals?e.extend({},i.disabledTimeIntervals):i.disabledTimeIntervals
if(!t)return i.disabledTimeIntervals=!1,K(),u
if(!(t instanceof Array))throw new TypeError("disabledTimeIntervals() expects an array parameter")
return i.disabledTimeIntervals=t,K(),u},u.disabledHours=function(t){if(0===arguments.length)return i.disabledHours?e.extend({},i.disabledHours):i.disabledHours
if(!t)return i.disabledHours=!1,K(),u
if(!(t instanceof Array))throw new TypeError("disabledHours() expects an array parameter")
if(i.disabledHours=he(t),i.enabledHours=!1,i.useCurrent&&!i.keepInvalid){for(var n=0;!z(o,"h");){if(o.add(1,"h"),24===n)throw"Tried 24 times to find a valid date"
n++}ee(o)}return K(),u},u.enabledHours=function(t){if(0===arguments.length)return i.enabledHours?e.extend({},i.enabledHours):i.enabledHours
if(!t)return i.enabledHours=!1,K(),u
if(!(t instanceof Array))throw new TypeError("enabledHours() expects an array parameter")
if(i.enabledHours=he(t),i.disabledHours=!1,i.useCurrent&&!i.keepInvalid){for(var n=0;!z(o,"h");){if(o.add(1,"h"),24===n)throw"Tried 24 times to find a valid date"
n++}ee(o)}return K(),u},u.viewDate=function(e){if(0===arguments.length)return r.clone()
if(!e)return r=o.clone(),u
if(!("string"==typeof e||t.isMoment(e)||e instanceof Date))throw new TypeError("viewDate() parameter must be one of [string, moment or Date]")
return r=ie(e),N(),u},n.is("input"))a=n
...
return o=S(),r=o.clone(),e.extend(!0,i,F()),u.options(i),me(),ue(),a.prop("disabled")&&u.disable(),a.is("input")&&0!==a.val().trim().length?ee(ie(a.val().trim())):i.defaultDate&&void 0===a.attr("placeholder")&&ee(i.defaultDate),i.inline&&ae(),u}
...
r(a[0]),a.find("*").each(function(){r(this)})},d=function(e,t,n,i,o,r){var a=new RegExp(l(n.name_prefix+"["+o+"]"),"g"),s=n.name_prefix+"["+r+"]"
c(t,i,a,s),a=new RegExp(l(e.attr("id")+"_"+o),"g"),s=e.attr("id")+"_"+r,c(t,i,a,s)},u=function(e,t,n,i,o){var r=new RegExp(l(t.name_prefix+"["+i+"]"),"g"),a=t.name_prefix+"["+o+"]"
...
return d(e,t,o,n,n,"__swap__"),d(e,t,o,i,i,n),d(e,t,o,n,"__swap__",i),t.eq(n).insertBefore(t.eq(i)),i>n?t.eq(i).insertBefore(t.eq(n)):t.eq(i).insertAfter(t.eq(n)),e.find(o.elements_selector)},h=function(e,t,n,i,o){for(var r=i+1;r<=o;r++)t=f(e,t,r,r-1)
...
if(n.allow_add&&r&&(t.append('<span class="'+n.prefix+'-tmp"></span>'),n.add&&t.append(e(n.add).addClass(n.prefix+"-action "+n.prefix+"-rescue-add").data("collection",t.attr("id")))),i)for(var s=e(n.container),l=t.find("."+n.prefix+"-add, ."+n.prefix+"-rescue-add, ."+n.prefix+"-duplicate").first();a.length<n.init_with_n_elements;){var c=a.length>0?a.last():void 0,d=a.length+1
a=w(s,l,t,n,a,c,d,!1)}if(a.each(function(i){var r=e(this),s=r.find("."+n.prefix+"-actions").addBack().filter("."+n.prefix+"-actions")
...
0===c.length&&l.html&&(c=e(l.html).appendTo(s).addClass(l.selector)),l.condition?(c.removeClass(n.prefix+"-action-disabled"),n.hide_useless_buttons&&c.css("display","")):(c.addClass(n.prefix+"-action-disabled"),n.hide_useless_buttons&&c.css("display","none")),c.addClass(n.prefix+"-action").data("collection",t.attr("id")).data(n.prefix+"-element",o(t.attr("id")+"_"+i,r))}else r.find("."+l.selector).css("display","none")})}),n.allow_add){var u=t.find("."+n.prefix+"-rescue-add").css("display",""),p=t.find("."+n.prefix+"-add");(!n.add_at_the_end&&p.length>0||n.custom_add_location)&&u.css("display","none"),a.length>=n.max&&n.hide_useless_buttons&&t.find("."+n.prefix+"-add, ."+n.prefix+"-rescue-add, ."+n.prefix+"-duplicate").css("display","none")}},b=function(t,n,i){i.children&&e.each(i.children,function(e,i){return i.selector?void(null!==n?n.find(i.selector).collection(i):t.find(i.selector).collection(i)):(console.log("jquery.collection.js: given collection "+t.attr("id")+" has children collections, but children's root selector is undefined."),!0)})},w=function(t,n,i,o,r,a,c,d){if(r.length<o.max&&(d&&s(o.before_duplicate(i,a))||s(o.before_add(i,a)))){var f=i.data("prototype"),h=r.length,m=new RegExp(l(o.prototype_name),"g"),y=e(f.replace(m,h)),w=i.find("> ."+o.prefix+"-tmp")
e(y).find("[id]").first().attr("id")
if(d){p(r.eq(c))
var x=e("<div/>").append(r.eq(c).clone()).html(),_=u(i,o,x,c,h)
...
c!==-1&&(r=v(i,r,o,c))}b(i,y,o),(d&&!s(o.after_duplicate(i,y))||!s(o.after_add(i,y)))&&(c!==-1&&(r=g(i,r,o,c+1)),y.remove())}return r},x=function(e,t,n,i,o){if(n.length>t.min&&s(t.before_remove(e,i))){n=g(e,n,t,o)
