...
return K.each(e.match(he)||[],function(e,n){t[n]=!0}),t}function s(){J.removeEventListener("DOMContentLoaded",s,!1),e.removeEventListener("load",s,!1),K.ready()}function a(){Object.defineProperty(this.cache={},0,{get:function(){return{}}}),this.expando=K.expando+a.uid++}function l(e,t,n){var i
...
for(o in c)for(n=0,i=c[o].length;i>n;n++)K.event.add(t,o,c[o][n])}ye.hasData(e)&&(a=ye.access(e),l=K.extend({},a),ye.set(t,l))}}function v(e,t){var n=e.getElementsByTagName?e.getElementsByTagName(t||"*"):e.querySelectorAll?e.querySelectorAll(t||"*"):[]
...
return n||(n=b(e,t),"none"!==n&&n||(Re=(Re||K("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement),t=Re[0].contentDocument,t.write(),t.close(),n=b(e,t),Re.detach()),He[e]=n),n}function x(e,t,n){var i,o,r,s,a=e.style
return n=n||ze(e),n&&(s=n.getPropertyValue(t)||n[t]),n&&(""!==s||K.contains(e.ownerDocument,e)||(s=K.style(e,t)),We.test(s)&&qe.test(t)&&(i=a.width,o=a.minWidth,r=a.maxWidth,a.minWidth=a.maxWidth=a.width=s,s=n.width,a.width=i,a.minWidth=o,a.maxWidth=r)),void 0!==s?s+"":s}function _(e,t){return{get:function(){return e()?void delete this.get:(this.get=t).apply(this,arguments)}}}function C(e,t){if(t in e)return t
...
return i?Math.max(0,i[1]-(n||0))+(i[2]||"px"):t}function D(e,t,n,i,o){for(var r=n===(i?"border":"content")?4:"width"===t?1:0,s=0;4>r;r+=2)"margin"===n&&(s+=K.css(e,n+_e[r],!0,o)),i?("content"===n&&(s-=K.css(e,"padding"+_e[r],!0,o)),"margin"!==n&&(s-=K.css(e,"border"+_e[r]+"Width",!0,o))):(s+=K.css(e,"padding"+_e[r],!0,o),"padding"!==n&&(s+=K.css(e,"border"+_e[r]+"Width",!0,o)))
return s}function T(e,t,n){var i=!0,o="width"===t?e.offsetWidth:e.offsetHeight,r=ze(e),s="border-box"===K.css(e,"boxSizing",!1,r)
...
return t&&(o.opacity=o.width=e),o}function I(e,t,n){for(var i,o=(nt[t]||[]).concat(nt["*"]),r=0,s=o.length;s>r;r++)if(i=o[r].call(n,t,e))return i}function O(e,t,n){var i,o,r,s,a,l,c,u,d=this,p={},h=e.style,f=e.nodeType&&Ce(e),m=ve.get(e,"fxshow")
...
for(i in p)s=I(f?m[i]:0,i,d),i in m||(m[i]=s.start,f&&(s.end=s.start,s.start="width"===i||"height"===i?1:0))}}function M(e,t){var n,i,o,r,s
for(n in e)if(i=K.camelCase(n),o=t[i],r=e[n],K.isArray(r)&&(o=r[1],r=e[n]=r[0]),n!==i&&(e[i]=r,delete e[n]),s=K.cssHooks[i],s&&"expand"in s){r=s.expand(r),delete e[i]
for(n in r)n in e||(e[n]=r[n],t[n]=o)}else t[i]=o}function L(e,t,n){var i,o,r=0,s=tt.length,a=K.Deferred().always(function(){delete l.elem}),l=function(){if(o)return!1
for(var t=Ze||A(),n=Math.max(0,c.startTime+c.duration-t),i=n/c.duration||0,r=1-i,s=0,l=c.tweens.length;l>s;s++)c.tweens[s].run(r)
return a.notifyWith(e,[c,r,n]),1>r&&l?n:(a.resolveWith(e,[c]),!1)},c=a.promise({elem:e,props:K.extend({},t),opts:K.extend(!0,{specialEasing:{}},n),originalProperties:t,originalOptions:n,startTime:Ze||A(),duration:n.duration,tweens:[],createTween:function(t,n){var i=K.Tween(e,c.opts,t,n,c.opts.specialEasing[t]||c.opts.easing)
...
for(M(u,c.opts.specialEasing);s>r;r++)if(i=tt[r].call(c,e,u,c.opts))return i
...
if(K.isFunction(n))for(;i=r[o++];)"+"===i[0]?(i=i.slice(1)||"*",(e[i]=e[i]||[]).unshift(n)):(e[i]=e[i]||[]).push(n)}}function F(e,t,n,i){function o(a){var l
return r[a]=!0,K.each(e[a]||[],function(e,a){var c=a(t,n,i)
...
return i&&K.extend(!0,e,i),e}function j(e,t,n){for(var i,o,r,s,a=e.contents,l=e.dataTypes;"*"===l[0];)l.shift(),void 0===i&&(i=e.mimeType||t.getResponseHeader("Content-Type"))
if(i)for(o in a)if(a[o]&&a[o].test(i)){l.unshift(o)
break}if(l[0]in n)r=l[0]
else{for(o in n){if(!l[0]||e.converters[o+" "+l[0]]){r=o
break}s||(s=o)}r=r||s}return r?(r!==l[0]&&l.unshift(r),n[r]):void 0}function R(e,t,n,i){var o,r,s,a,l,c={},u=e.dataTypes.slice()
...
else try{t=s(t)}catch(e){return{state:"parsererror",error:s?e:"No conversion from "+l+" to "+r}}}return{state:"success",data:t}}function H(e,t,n,i){var o
...
return this.pushStack(n>=0&&t>n?[this[n]]:[])},end:function(){return this.prevObject||this.constructor(null)},push:Y,sort:W.sort,splice:W.splice},K.extend=K.fn.extend=function(){var e,t,n,i,o,r,s=arguments[0]||{},a=1,l=arguments.length,c=!1
for("boolean"==typeof s&&(c=s,s=arguments[a]||{},a++),"object"==typeof s||K.isFunction(s)||(s={}),a===l&&(s=this,a--);l>a;a++)if(null!=(e=arguments[a]))for(t in e)n=s[t],i=e[t],s!==i&&(c&&i&&(K.isPlainObject(i)||(o=K.isArray(i)))?(o?(o=!1,r=n&&K.isArray(n)?n:[]):r=n&&K.isPlainObject(n)?n:{},s[t]=K.extend(c,r,i)):void 0!==i&&(s[t]=i))
...
e=K.trim(e),e&&(1===e.indexOf("use strict")?(t=J.createElement("script"),t.text=e,J.head.appendChild(t).parentNode.removeChild(t)):n(e))},camelCase:function(e){return e.replace(te,"ms-").replace(ne,ie)},nodeName:function(e,t){return e.nodeName&&e.nodeName.toLowerCase()===t.toLowerCase()},each:function(e,t,i){var o,r=0,s=e.length,a=n(e)
...
var oe=function(e){function t(e,t,n,i){var o,r,s,a,l,c,d,h,f,m
if((t?t.ownerDocument||t:H)!==O&&I(t),t=t||O,n=n||[],a=t.nodeType,"string"!=typeof e||!e||1!==a&&9!==a&&11!==a)return n
if(!i&&L){if(11!==a&&(o=ye.exec(e)))if(s=o[1]){if(9===a){if(r=t.getElementById(s),!r||!r.parentNode)return n
if(r.id===s)return n.push(r),n}else if(t.ownerDocument&&(r=t.ownerDocument.getElementById(s))&&j(t,r)&&r.id===s)return n.push(r),n}else{if(o[2])return X.apply(n,t.getElementsByTagName(e)),n
if((s=o[3])&&x.getElementsByClassName)return X.apply(n,t.getElementsByClassName(s)),n}if(x.qsa&&(!P||!P.test(e))){if(h=d=R,f=t,m=1!==a&&e,1===a&&"object"!==t.nodeName.toLowerCase()){for(c=D(e),(d=t.getAttribute("id"))?h=d.replace(we,"\\$&"):t.setAttribute("id",h),h="[id='"+h+"'] ",l=c.length;l--;)c[l]=h+p(c[l])
...
try{return!!e(t)}catch(e){return!1}finally{t.parentNode&&t.parentNode.removeChild(t),t=null}}function r(e,t){for(var n=e.split("|"),i=e.length;i--;)_.attrHandle[n[i]]=t}function s(e,t){var n=t&&e,i=n&&1===e.nodeType&&1===t.nodeType&&(~t.sourceIndex||V)-(~e.sourceIndex||V)
if(i)return i
...
return t.first?function(t,n,r){for(;t=t[i];)if(1===t.nodeType||o)return e(t,n,r)}:function(t,n,s){var a,l,c=[q,r]
if(s){for(;t=t[i];)if((1===t.nodeType||o)&&e(t,n,s))return!0}else for(;t=t[i];)if(1===t.nodeType||o){if(l=t[R]||(t[R]={}),(a=l[i])&&a[0]===q&&a[1]===r)return c[2]=a[2]
if(l[i]=c,c[2]=e(t,n,s))return!0}}}function f(e){return e.length>1?function(t,n,i){for(var o=e.length;o--;)if(!e[o](t,n,i))return!1
...
return s}function v(e,t,n,o,r,s){return o&&!o[R]&&(o=v(o)),r&&!r[R]&&(r=v(r,s)),i(function(i,s,a,l){var c,u,d,p=[],h=[],f=s.length,v=i||m(t||"*",a.nodeType?[a]:a,[]),y=!e||!i&&t?v:g(v,p,e,a,l),b=n?r||(i?e:f||o)?[]:s:y
if(n&&n(y,b,a,l),o)for(c=g(b,h),o(c,[],a,l),u=c.length;u--;)(d=c[u])&&(b[h[u]]=!(y[h[u]]=d))
if(i){if(r||e){if(r){for(c=[],u=b.length;u--;)(d=b[u])&&c.push(y[u]=d)
r(null,b=[],c,l)}for(u=b.length;u--;)(d=b[u])&&(c=r?ee(i,d):p[u])>-1&&(i[c]=!(s[c]=d))}}else b=g(b===s?b.splice(f,b.length):b),r?r(null,s,b,l):X.apply(s,b)})}function y(e){for(var t,n,i,o=e.length,r=_.relative[e[0].type],s=r||_.relative[" "],a=r?1:0,l=h(function(e){return e===t},s,!0),c=h(function(e){return ee(t,e)>-1},s,!0),u=[function(e,n,i){var o=!r&&(i||n!==E)||((t=n).nodeType?l(e,n,i):c(e,n,i))
return t=null,o}];o>a;a++)if(n=_.relative[e[a].type])u=[h(f(u),n)]
else{if(n=_.filter[e[a].type].apply(null,e[a].matches),n[R]){for(i=++a;o>i&&!_.relative[e[i].type];i++);return v(a>1&&f(u),a>1&&p(e.slice(0,a-1).concat({value:" "===e[a-2].type?"*":""})).replace(le,"$1"),n,i>a&&y(e.slice(a,i)),o>i&&y(e=e.slice(i)),o>i&&p(e))}u.push(n)}return f(u)}function b(e,n){var o=n.length>0,r=e.length>0,s=function(i,s,a,l,c){var u,d,p,h=0,f="0",m=i&&[],v=[],y=E,b=i||r&&_.find.TAG("*",c),w=q+=null==y?1:Math.random()||.1,x=b.length
for(c&&(E=s!==O&&s);f!==x&&null!=(u=b[f]);f++){if(r&&u){for(d=0;p=e[d++];)if(p(u,s,a)){l.push(u)
break}c&&(q=w)}o&&((u=!p&&u)&&h--,i&&m.push(u))}if(h+=f,o&&f!==h){for(d=0;p=n[d++];)p(m,v,s,a)
if(i){if(h>0)for(;f--;)m[f]||v[f]||(v[f]=Z.call(l))
v=g(v)}X.apply(l,v),c&&!i&&v.length>0&&h+n.length>1&&t.uniqueSort(l)}return c&&(q=w,E=y),m}
return o?i(s):s}var w,x,_,C,S,D,T,k,E,A,$,I,O,M,L,P,F,N,j,R="sizzle"+1*new Date,H=e.document,q=0,W=0,z=n(),U=n(),Y=n(),B=function(e,t){return e===t&&($=!0),0},V=1<<31,G={}.hasOwnProperty,Q=[],Z=Q.pop,J=Q.push,X=Q.push,K=Q.slice,ee=function(e,t){for(var n=0,i=e.length;i>n;n++)if(e[n]===t)return n
...
for(;l[o]===c[o];)o++
return o?s(l[o],c[o]):l[o]===H?-1:c[o]===H?1:0},i):O},t.matches=function(e,n){return t(e,null,null,n)},t.matchesSelector=function(e,n){if((e.ownerDocument||e)!==O&&I(e),n=n.replace(de,"='$1']"),!(!x.matchesSelector||!L||F&&F.test(n)||P&&P.test(n)))try{var i=N.call(e,n)
...
return 1===i&&0===o?function(e){return!!e.parentNode}:function(t,n,l){var c,u,d,p,h,f,m=r!==s?"nextSibling":"previousSibling",g=t.parentNode,v=a&&t.nodeName.toLowerCase(),y=!l&&!a
if(g){if(r){for(;m;){for(d=t;d=d[m];)if(a?d.nodeName.toLowerCase()===v:1===d.nodeType)return!1
f=m="only"===e&&!f&&"nextSibling"}return!0}if(f=[s?g.firstChild:g.lastChild],s&&y){for(u=g[R]||(g[R]={}),c=u[e]||[],h=c[0]===q&&c[1],p=c[0]===q&&c[2],d=h&&g.childNodes[h];d=++h&&d&&d[m]||(p=h=0)||f.pop();)if(1===d.nodeType&&++p&&d===t){u[e]=[q,h,p]
break}}else if(y&&(c=(t[R]||(t[R]={}))[e])&&c[0]===q)p=c[1]
else for(;(d=++h&&d&&d[m]||(p=h=0)||f.pop())&&((a?d.nodeName.toLowerCase()!==v:1!==d.nodeType)||!++p||(y&&((d[R]||(d[R]={}))[e]=[q,p]),d!==t)););return p-=o,p===i||p%i===0&&p/i>=0}}},PSEUDO:function(e,n){var o,r=_.pseudos[e]||_.setFilters[e.toLowerCase()]||t.error("unsupported pseudo: "+e)
return r[R]?r(n):r.length>1?(o=[e,e,"",n],_.setFilters.hasOwnProperty(e.toLowerCase())?i(function(e,t){for(var i,o=r(e,n),s=o.length;s--;)i=ee(e,o[s]),e[i]=!(t[i]=o[s])}):function(e){return r(e,0,o)}):r}},pseudos:{not:i(function(e){var t=[],n=[],o=T(e.replace(le,"$1"))
...
return d.prototype=_.filters=_.pseudos,_.setFilters=new d,D=t.tokenize=function(e,n){var i,o,r,s,a,l,c,u=U[e+" "]
if(u)return n?0:u.slice(0)
for(a=e,l=[],c=_.preFilter;a;){(!i||(o=ce.exec(a)))&&(o&&(a=a.slice(o[0].length)||a),l.push(r=[])),i=!1,(o=ue.exec(a))&&(i=o.shift(),r.push({value:i,type:o[0].replace(le," ")}),a=a.slice(i.length))
for(s in _.filter)!(o=fe[s].exec(a))||c[s]&&!(o=c[s](o))||(i=o.shift(),r.push({value:i,type:s,matches:o}),a=a.slice(i.length))
if(!i)break}return n?a.length:a?t.error(e):U(e,l).slice(0)},T=t.compile=function(e,t){var n,i=[],o=[],r=Y[e+" "]
if(!r){for(t||(t=D(e)),n=t.length;n--;)r=y(t[n]),r[R]?i.push(r):o.push(r)
r=Y(e,b(o,i)),r.selector=e}return r},k=t.select=function(e,t,n,i){var o,r,s,a,l,c="function"==typeof e&&e,d=!i&&D(e=c.selector||e)
if(n=n||[],1===d.length){if(r=d[0]=d[0].slice(0),r.length>2&&"ID"===(s=r[0]).type&&x.getById&&9===t.nodeType&&L&&_.relative[r[1].type]){if(t=(_.find.ID(s.matches[0].replace(xe,_e),t)||[])[0],!t)return n
c&&(t=t.parentNode),e=e.slice(r.shift().value.length)}for(o=fe.needsContext.test(e)?0:r.length;o--&&(s=r[o],!_.relative[a=s.type]);)if((l=_.find[a])&&(i=l(s.matches[0].replace(xe,_e),be.test(r[0].type)&&u(t.parentNode)||t))){if(r.splice(o,1),e=i.length&&p(r),!e)return X.apply(n,i),n
...
var re=K.expr.match.needsContext,se=/^<(\w+)\s*\/?>(?:<\/\1>|)$/,ae=/^.[^:#\[\.,]*$/
...
if(n[1]){if(t=t instanceof K?t[0]:t,K.merge(this,K.parseHTML(n[1],t&&t.nodeType?t.ownerDocument||t:J,!0)),se.test(n[1])&&K.isPlainObject(t))for(n in t)K.isFunction(this[n])?this[n](t[n]):this.attr(n,t[n])
...
return this.filter(function(){for(var e=0;n>e;e++)if(K.contains(this,t[e]))return!0})},closest:function(e,t){for(var n,i=0,o=this.length,r=[],s=re.test(e)||"string"!=typeof e?K(e,t||this.context):0;o>i;i++)for(n=this[i];n&&n!==t;n=n.parentNode)if(n.nodeType<11&&(s?s.index(n)>-1:1===n.nodeType&&K.find.matchesSelector(n,e))){r.push(n)
...
return K.Deferred(function(n){K.each(t,function(t,r){var s=K.isFunction(e[t])&&e[t]
o[r[1]](function(){var e=s&&s.apply(this,arguments)
e&&K.isFunction(e.promise)?e.promise().done(n.resolve).fail(n.reject).progress(n.notify):n[r[0]+"With"](this===i?n.promise():this,s?[e]:arguments)})}),e=null}).promise()},promise:function(e){return null!=e?K.extend(e,i):i}},o={}
return i.pipe=i.then,K.each(t,function(e,r){var s=r[2],a=r[3]
i[r[1]]=s.add,a&&s.add(function(){n=a},t[1^e][2].disable,t[2][2].lock),o[r[0]]=function(){return o[r[0]+"With"](this===o?i:this,arguments),this},o[r[0]+"With"]=s.fireWith}),i.promise(o),e&&e.call(o,o),o},when:function(e){var t,n,i,o=0,r=z.call(arguments),s=r.length,a=1!==s||e&&K.isFunction(e.promise)?s:0,l=1===a?e:K.Deferred(),c=function(e,n,i){return function(o){n[e]=this,i[e]=arguments.length>1?z.call(arguments):o,i===t?l.notifyWith(n,i):--a||l.resolveWith(n,i)}}
...
var me
K.fn.ready=function(e){return K.ready.promise().done(e),this},K.extend({isReady:!1,readyWait:1,holdReady:function(e){e?K.readyWait++:K.ready(!0)},ready:function(e){(e===!0?--K.readyWait:K.isReady)||(K.isReady=!0,e!==!0&&--K.readyWait>0||(me.resolveWith(J,[K]),K.fn.triggerHandler&&(K(J).triggerHandler("ready"),K(J).off("ready"))))}}),K.ready.promise=function(t){return me||(me=K.Deferred(),"complete"===J.readyState?setTimeout(K.ready):(J.addEventListener("DOMContentLoaded",s,!1),e.addEventListener("load",s,!1))),me.promise(t)},K.ready.promise()
var ge=K.access=function(e,t,n,i,o,r,s){var a=0,l=e.length,c=null==n
if("object"===K.type(n)){o=!0
for(a in n)K.access(e,t,a,n[a],!0,r,s)}else if(void 0!==i&&(o=!0,K.isFunction(i)||(s=!0),c&&(s?(t.call(e,i),t=null):(c=t,t=function(e,t,n){return c.call(K(e),n)})),t))for(;l>a;a++)t(e[a],n,s?i:i.call(e[a],a,t(e[a],n)))
...
return void 0===t||t&&"string"==typeof t&&void 0===n?(i=this.get(e,t),void 0!==i?i:this.get(e,K.camelCase(t))):(this.set(e,t,n),void 0!==n?n:t)},remove:function(e,t){var n,i,o,r=this.key(e),s=this.cache[r]
if(void 0===t)this.cache[r]={}
else{K.isArray(t)?i=t.concat(t.map(K.camelCase)):(o=K.camelCase(t),t in s?i=[t,o]:(i=o,i=i in s?[i]:i.match(he)||[])),n=i.length
for(;n--;)delete s[i[n]]}},hasData:function(e){return!K.isEmptyObject(this.cache[e[this.expando]]||{})},discard:function(e){e[this.expando]&&delete this.cache[e[this.expando]]}}
var ve=new a,ye=new a,be=/^(?:\{[\w\W]*\}|\[[\w\W]*\])$/,we=/([A-Z])/g
K.extend({hasData:function(e){return ye.hasData(e)||ve.hasData(e)},data:function(e,t,n){return ye.access(e,t,n)},removeData:function(e,t){ye.remove(e,t)},_data:function(e,t,n){return ve.access(e,t,n)},_removeData:function(e,t){ve.remove(e,t)}}),K.fn.extend({data:function(e,t){var n,i,o,r=this[0],s=r&&r.attributes
if(void 0===e){if(this.length&&(o=ye.get(r),1===r.nodeType&&!ve.get(r,"hasDataAttrs"))){for(n=s.length;n--;)s[n]&&(i=s[n].name,0===i.indexOf("data-")&&(i=K.camelCase(i.slice(5)),l(r,i,o[i])))
...
var n=K.queue(e,t),i=n.length,o=n.shift(),r=K._queueHooks(e,t),s=function(){K.dequeue(e,t)}
...
K._queueHooks(this,e),"fx"===e&&"inprogress"!==n[0]&&K.dequeue(this,e)})},dequeue:function(e){return this.each(function(){K.dequeue(this,e)})},clearQueue:function(e){return this.queue(e||"fx",[])},promise:function(e,t){var n,i=1,o=K.Deferred(),r=this,s=this.length,a=function(){--i||o.resolveWith(r,[r])}
...
K.event={global:{},add:function(e,t,n,i,o){var r,s,a,l,c,u,d,p,h,f,m,g=ve.get(e)
if(g)for(n.handler&&(r=n,n=r.handler,o=r.selector),n.guid||(n.guid=K.guid++),(l=g.events)||(l=g.events={}),(s=g.handle)||(s=g.handle=function(t){return typeof K!==De&&K.event.triggered!==t.type?K.event.dispatch.apply(e,arguments):void 0}),t=(t||"").match(he)||[""],c=t.length;c--;)a=Ae.exec(t[c])||[],h=m=a[1],f=(a[2]||"").split(".").sort(),h&&(d=K.event.special[h]||{},h=(o?d.delegateType:d.bindType)||h,d=K.event.special[h]||{},u=K.extend({type:h,origType:m,data:i,handler:n,guid:n.guid,selector:o,needsContext:o&&K.expr.match.needsContext.test(o),namespace:f.join(".")},r),(p=l[h])||(p=l[h]=[],p.delegateCount=0,d.setup&&d.setup.call(e,i,f,s)!==!1||e.addEventListener&&e.addEventListener(h,s,!1)),d.add&&(d.add.call(e,u),u.handler.guid||(u.handler.guid=n.guid)),o?p.splice(p.delegateCount++,0,u):p.push(u),K.event.global[h]=!0)},remove:function(e,t,n,i,o){var r,s,a,l,c,u,d,p,h,f,m,g=ve.hasData(e)&&ve.get(e)
if(g&&(l=g.events)){for(t=(t||"").match(he)||[""],c=t.length;c--;)if(a=Ae.exec(t[c])||[],h=m=a[1],f=(a[2]||"").split(".").sort(),h){for(d=K.event.special[h]||{},h=(i?d.delegateType:d.bindType)||h,p=l[h]||[],a=a[2]&&new RegExp("(^|\\.)"+f.join("\\.(?:.*\\.|)")+"(\\.|$)"),s=r=p.length;r--;)u=p[r],!o&&m!==u.origType||n&&n.guid!==u.guid||a&&!a.test(u.namespace)||i&&i!==u.selector&&("**"!==i||!u.selector)||(p.splice(r,1),u.selector&&p.delegateCount--,d.remove&&d.remove.call(e,u))
s&&!p.length&&(d.teardown&&d.teardown.call(e,f,g.handle)!==!1||K.removeEvent(e,h,g.handle),delete l[h])}else for(h in l)K.event.remove(e,h+t[c],n,i,!0)
K.isEmptyObject(l)&&(delete g.handle,ve.remove(e,"events"))}},trigger:function(t,n,i,o){var r,s,a,l,c,u,d,p=[i||J],h=Q.call(t,"type")?t.type:t,f=Q.call(t,"namespace")?t.namespace.split("."):[]
if(s=a=i=i||J,3!==i.nodeType&&8!==i.nodeType&&!Ee.test(h+K.event.triggered)&&(h.indexOf(".")>=0&&(f=h.split("."),h=f.shift(),f.sort()),c=h.indexOf(":")<0&&"on"+h,t=t[K.expando]?t:new K.Event(h,"object"==typeof t&&t),t.isTrigger=o?2:3,t.namespace=f.join("."),t.namespace_re=t.namespace?new RegExp("(^|\\.)"+f.join("\\.(?:.*\\.|)")+"(\\.|$)"):null,t.result=void 0,t.target||(t.target=i),n=null==n?[t]:K.makeArray(n,[t]),d=K.event.special[h]||{},o||!d.trigger||d.trigger.apply(i,n)!==!1)){if(!o&&!d.noBubble&&!K.isWindow(i)){for(l=d.delegateType||h,Ee.test(l+h)||(s=s.parentNode);s;s=s.parentNode)p.push(s),a=s
a===(i.ownerDocument||J)&&p.push(a.defaultView||a.parentWindow||e)}for(r=0;(s=p[r++])&&!t.isPropagationStopped();)t.type=r>1?l:d.bindType||h,u=(ve.get(s,"events")||{})[t.type]&&ve.get(s,"handle"),u&&u.apply(s,n),u=c&&s[c],u&&u.apply&&K.acceptData(s)&&(t.result=u.apply(s,n),t.result===!1&&t.preventDefault())
return t.type=h,o||t.isDefaultPrevented()||d._default&&d._default.apply(p.pop(),n)!==!1||!K.acceptData(i)||c&&K.isFunction(i[h])&&!K.isWindow(i)&&(a=i[c],a&&(i[c]=null),K.event.triggered=h,i[h](),K.event.triggered=void 0,a&&(i[c]=a)),t.result}},dispatch:function(e){e=K.event.fix(e)
var t,n,i,o,r,s=[],a=z.call(arguments),l=(ve.get(this,"events")||{})[e.type]||[],c=K.event.special[e.type]||{}
if(a[0]=e,e.delegateTarget=this,!c.preDispatch||c.preDispatch.call(this,e)!==!1){for(s=K.event.handlers.call(this,e,l),t=0;(o=s[t++])&&!e.isPropagationStopped();)for(e.currentTarget=o.elem,n=0;(r=o.handlers[n++])&&!e.isImmediatePropagationStopped();)(!e.namespace_re||e.namespace_re.test(r.namespace))&&(e.handleObj=r,e.data=r.data,i=((K.event.special[r.origType]||{}).handle||r.handler).apply(o.elem,a),void 0!==i&&(e.result=i)===!1&&(e.preventDefault(),e.stopPropagation()))
...
if(a&&l.nodeType&&(!e.button||"click"!==e.type))for(;l!==this;l=l.parentNode||this)if(l.disabled!==!0||"click"!==e.type){for(i=[],n=0;a>n;n++)r=t[n],o=r.selector+" ",void 0===i[o]&&(i[o]=r.needsContext?K(o,this).index(l)>=0:K.find(o,this,null,[l]).length),i[o]&&i.push(r)
...
for(s||(this.fixHooks[o]=s=ke.test(o)?this.mouseHooks:Te.test(o)?this.keyHooks:{}),i=s.props?this.props.concat(s.props):this.props,e=new K.Event(r),t=i.length;t--;)n=i[t],e[n]=r[n]
return e.target||(e.target=J),3===e.target.nodeType&&(e.target=e.target.parentNode),s.filter?s.filter(e,r):e},special:{load:{noBubble:!0},focus:{trigger:function(){return this!==d()&&this.focus?(this.focus(),!1):void 0},delegateType:"focusin"},blur:{trigger:function(){return this===d()&&this.blur?(this.blur(),!1):void 0},delegateType:"focusout"},click:{trigger:function(){return"checkbox"===this.type&&this.click&&K.nodeName(this,"input")?(this.click(),!1):void 0},_default:function(e){return K.nodeName(e.target,"a")}},beforeunload:{postDispatch:function(e){void 0!==e.result&&e.originalEvent&&(e.originalEvent.returnValue=e.result)}}},simulate:function(e,t,n,i){var o=K.extend(new K.Event,n,{type:e,isSimulated:!0,originalEvent:{}})
...
o?ve.access(i,t,o):(i.removeEventListener(e,n,!0),ve.remove(i,t))}}}),K.fn.extend({on:function(e,t,n,i,o){var r,s
...
je.optgroup=je.option,je.tbody=je.tfoot=je.colgroup=je.caption=je.thead,je.th=je.td,K.extend({clone:function(e,t,n){var i,o,r,s,a=e.cloneNode(!0),l=K.contains(e.ownerDocument,e)
if(!(Z.noCloneChecked||1!==e.nodeType&&11!==e.nodeType||K.isXMLDoc(e)))for(s=v(a),r=v(e),i=0,o=r.length;o>i;i++)y(r[i],s[i])
if(t)if(n)for(r=r||v(e),s=s||v(a),i=0,o=r.length;o>i;i++)g(r[i],s[i])
else g(e,a)
return s=v(a,"script"),s.length>0&&m(s,!l&&v(e,"script")),a},buildFragment:function(e,t,n,i){for(var o,r,s,a,l,c,u=t.createDocumentFragment(),d=[],p=0,h=e.length;h>p;p++)if(o=e[p],o||0===o)if("object"===K.type(o))K.merge(d,o.nodeType?[o]:o)
else if(Oe.test(o)){for(r=r||u.appendChild(t.createElement("div")),s=(Ie.exec(o)||["",""])[1].toLowerCase(),a=je[s]||je._default,r.innerHTML=a[1]+o.replace($e,"<$1></$2>")+a[2],c=a[0];c--;)r=r.lastChild
...
return u},cleanData:function(e){for(var t,n,i,o,r=K.event.special,s=0;void 0!==(n=e[s]);s++){if(K.acceptData(n)&&(o=n[ve.expando],o&&(t=ve.cache[o]))){if(t.events)for(i in t.events)r[i]?K.event.remove(n,i):K.removeEvent(n,i,t.handle)
...
if(c&&(n=K.buildFragment(e,this[0].ownerDocument,!1,this),i=n.firstChild,1===n.childNodes.length&&(n=i),i)){for(o=K.map(v(n,"script"),h),r=o.length;c>l;l++)s=n,l!==d&&(s=K.clone(s,!0,!0),r&&K.merge(o,v(s,"script"))),t.call(this[l],s,l)
if(r)for(a=o[o.length-1].ownerDocument,K.map(o,f),l=0;r>l;l++)s=o[l],Pe.test(s.type||"")&&!ve.access(s,"globalEval")&&K.contains(a,s)&&(s.src?K._evalUrl&&K._evalUrl(s.src):K.globalEval(s.textContent.replace(Ne,"")))}return this}}),K.each({appendTo:"append",prependTo:"prepend",insertBefore:"before",insertAfter:"after",replaceAll:"replaceWith"},function(e,t){K.fn[e]=function(e){for(var n,i=[],o=K(e),r=o.length-1,s=0;r>=s;s++)n=s===r?this:this.clone(!0),K(o[s])[t](n),Y.apply(i,n.get())
...
n="1%"!==t.top,i="4px"===t.width,o.removeChild(r)}var n,i,o=J.documentElement,r=J.createElement("div"),s=J.createElement("div")
s.style&&(s.style.backgroundClip="content-box",s.cloneNode(!0).style.backgroundClip="",Z.clearCloneStyle="content-box"===s.style.backgroundClip,r.style.cssText="border:0;width:0;height:0;top:0;left:-9999px;margin-top:1px;position:absolute",r.appendChild(s),e.getComputedStyle&&K.extend(Z,{pixelPosition:function(){return t(),n},boxSizingReliable:function(){return null==i&&t(),i},reliableMarginRight:function(){var t,n=s.appendChild(J.createElement("div"))
...
return""===n?"1":n}}}},cssNumber:{columnCount:!0,fillOpacity:!0,flexGrow:!0,flexShrink:!0,fontWeight:!0,lineHeight:!0,opacity:!0,order:!0,orphans:!0,widows:!0,zIndex:!0,zoom:!0},cssProps:{float:"cssFloat"},style:function(e,t,n,i){if(e&&3!==e.nodeType&&8!==e.nodeType&&e.style){var o,r,s,a=K.camelCase(t),l=e.style
return t=K.cssProps[a]||(K.cssProps[a]=C(l,a)),s=K.cssHooks[t]||K.cssHooks[a],void 0===n?s&&"get"in s&&void 0!==(o=s.get(e,!1,i))?o:l[t]:(r=typeof n,"string"===r&&(o=Be.exec(n))&&(n=(o[1]+1)*o[2]+parseFloat(K.css(e,t)),r="number"),void(null!=n&&n===n&&("number"!==r||K.cssNumber[a]||(n+="px"),Z.clearCloneStyle||""!==n||0!==t.indexOf("background")||(l[t]="inherit"),s&&"set"in s&&void 0===(n=s.set(e,n,i))||(l[t]=n))))}},css:function(e,t,n,i){var o,r,s,a=K.camelCase(t)
...
return o}},qe.test(e)||(K.cssHooks[e+t].set=S)}),K.fn.extend({css:function(e,t){return ge(this,function(e,t,n){var i,o,r={},s=0
if(K.isArray(t)){for(i=ze(e),o=t.length;o>s;s++)r[t[s]]=K.css(e,t[s],!1,i)
...
var Ze,Je,Xe=/^(?:toggle|show|hide)$/,Ke=new RegExp("^(?:([+-])=|)("+xe+")([a-z%]*)$","i"),et=/queueHooks$/,tt=[O],nt={"*":[function(e,t){var n=this.createTween(e,t),i=n.cur(),o=Ke.exec(t),r=o&&o[3]||(K.cssNumber[e]?"":"px"),s=(K.cssNumber[e]||"px"!==r&&+i)&&Ke.exec(K.css(n.elem,e)),a=1,l=20
if(s&&s[3]!==r){r=r||s[3],o=o||[],s=+i||1
do a=a||".5",s/=a,K.style(n.elem,e,s+r)
...
delete e.stop,t(n)}
return"string"!=typeof e&&(n=t,t=e,e=void 0),t&&e!==!1&&this.queue(e||"fx",[]),this.each(function(){var t=!0,o=null!=e&&e+"queueHooks",r=K.timers,s=ve.get(this)
if(o)s[o]&&s[o].stop&&i(s[o])
else for(o in s)s[o]&&s[o].stop&&et.test(o)&&i(s[o])
for(o=r.length;o--;)r[o].elem!==this||null!=e&&r[o].queue!==e||(r[o].anim.stop(n),t=!1,r.splice(o,1));(t||!n)&&K.dequeue(this,e)})},finish:function(e){return e!==!1&&(e=e||"fx"),this.each(function(){var t,n=ve.get(this),i=n[e+"queue"],o=n[e+"queueHooks"],r=K.timers,s=i?i.length:0
...
K.fn.extend({prop:function(e,t){return ge(this,K.prop,e,t,arguments.length>1)},removeProp:function(e){return this.each(function(){delete this[K.propFix[e]||e]})}}),K.extend({propFix:{for:"htmlFor",class:"className"},prop:function(e,t,n){var i,o,r,s=e.nodeType
if(e&&3!==s&&8!==s&&2!==s)return r=1!==s||!K.isXMLDoc(e),r&&(t=K.propFix[t]||t,o=K.propHooks[t]),void 0!==n?o&&"set"in o&&void 0!==(i=o.set(e,n,t))?i:e[t]=n:o&&"get"in o&&null!==(i=o.get(e,t))?i:e[t]},propHooks:{tabIndex:{get:function(e){return e.hasAttribute("tabindex")||st.test(e.nodeName)||e.href?e.tabIndex:-1}}}}),Z.optSelected||(K.propHooks.selected={get:function(e){var t=e.parentNode
...
var at=/[\t\r\n\f]/g
K.fn.extend({addClass:function(e){var t,n,i,o,r,s,a="string"==typeof e&&e,l=0,c=this.length
if(K.isFunction(e))return this.each(function(t){K(this).addClass(e.call(this,t,this.className))})
if(a)for(t=(e||"").match(he)||[];c>l;l++)if(n=this[l],i=1===n.nodeType&&(n.className?(" "+n.className+" ").replace(at," "):" ")){for(r=0;o=t[r++];)i.indexOf(" "+o+" ")<0&&(i+=o+" ")
s=K.trim(i),n.className!==s&&(n.className=s)}return this},removeClass:function(e){var t,n,i,o,r,s,a=0===arguments.length||"string"==typeof e&&e,l=0,c=this.length
if(K.isFunction(e))return this.each(function(t){K(this).removeClass(e.call(this,t,this.className))})
if(a)for(t=(e||"").match(he)||[];c>l;l++)if(n=this[l],i=1===n.nodeType&&(n.className?(" "+n.className+" ").replace(at," "):"")){for(r=0;o=t[r++];)for(;i.indexOf(" "+o+" ")>=0;)i=i.replace(" "+o+" "," ")
s=e?K.trim(i):"",n.className!==s&&(n.className=s)}return this},toggleClass:function(e,t){var n=typeof e
...
return null!=t?t:K.trim(K.text(e))}},select:{get:function(e){for(var t,n,i=e.options,o=e.selectedIndex,r="select-one"===e.type||0>o,s=r?null:[],a=r?o+1:i.length,l=0>o?a:r?o:0;a>l;l++)if(n=i[l],!(!n.selected&&l!==o||(Z.optDisabled?n.disabled:null!==n.getAttribute("disabled"))||n.parentNode.disabled&&K.nodeName(n.parentNode,"optgroup"))){if(t=K(n).val(),r)return t
s.push(t)}return s},set:function(e,t){for(var n,i,o=e.options,r=K.makeArray(t),s=o.length;s--;)i=o[s],(i.selected=K.inArray(i.value,r)>=0)&&(n=!0)
...
K.extend({active:0,lastModified:{},etag:{},ajaxSettings:{url:xt,type:"GET",isLocal:ft.test(_t[1]),global:!0,processData:!0,async:!0,contentType:"application/x-www-form-urlencoded; charset=UTF-8",accepts:{"*":wt,text:"text/plain",html:"text/html",xml:"application/xml, text/xml",json:"application/json, text/javascript"},contents:{xml:/xml/,html:/html/,json:/json/},responseFields:{xml:"responseXML",text:"responseText",json:"responseJSON"},converters:{"* text":String,"text html":!0,"text json":K.parseJSON,"text xml":K.parseXML},flatOptions:{url:!0,context:!0}},ajaxSetup:function(e,t){return t?N(N(e,K.ajaxSettings),t):N(K.ajaxSettings,e)},ajaxPrefilter:P(yt),ajaxTransport:P(bt),ajax:function(e,t){function n(e,t,n,s){var l,u,v,y,w,_=t
2!==b&&(b=2,a&&clearTimeout(a),i=void 0,r=s||"",x.readyState=e>0?4:0,l=e>=200&&300>e||304===e,n&&(y=j(d,x,n)),y=R(d,y,x,l),l?(d.ifModified&&(w=x.getResponseHeader("Last-Modified"),w&&(K.lastModified[o]=w),w=x.getResponseHeader("etag"),w&&(K.etag[o]=w)),204===e||"HEAD"===d.type?_="nocontent":304===e?_="notmodified":(_=y.state,u=y.data,v=y.error,l=!v)):(v=_,(e||!_)&&(_="error",0>e&&(e=0))),x.status=e,x.statusText=(t||_)+"",l?f.resolveWith(p,[u,_,x]):f.rejectWith(p,[x,_,v]),x.statusCode(g),g=void 0,c&&h.trigger(l?"ajaxSuccess":"ajaxError",[x,d,l?u:v]),m.fireWith(p,[x,_]),c&&(h.trigger("ajaxComplete",[x,d]),--K.active||K.event.trigger("ajaxStop")))}"object"==typeof e&&(t=e,e=void 0),t=t||{}
var i,o,r,s,a,l,c,u,d=K.ajaxSetup({},t),p=d.context||d,h=d.context&&(p.nodeType||p.jquery)?K(p):K.event,f=K.Deferred(),m=K.Callbacks("once memory"),g=d.statusCode||{},v={},y={},b=0,w="canceled",x={readyState:0,getResponseHeader:function(e){var t
if(2===b){if(!s)for(s={};t=ht.exec(r);)s[t[1].toLowerCase()]=t[2]
...
if(i=F(bt,d,t,x)){x.readyState=1,c&&h.trigger("ajaxSend",[x,d]),d.async&&d.timeout>0&&(a=setTimeout(function(){x.abort("timeout")},d.timeout))
...
return Z.cors||It&&!e.crossDomain?{send:function(n,i){var o,r=e.xhr(),s=++Et
if(r.open(e.type,e.url,e.async,e.username,e.password),e.xhrFields)for(o in e.xhrFields)r[o]=e.xhrFields[o]
e.mimeType&&r.overrideMimeType&&r.overrideMimeType(e.mimeType),e.crossDomain||n["X-Requested-With"]||(n["X-Requested-With"]="XMLHttpRequest")
for(o in n)r.setRequestHeader(o,n[o])
t=function(e){return function(){t&&(delete At[s],t=r.onload=r.onerror=null,"abort"===e?r.abort():"error"===e?i(r.status,r.statusText):i($t[r.status]||r.status,r.statusText,"string"==typeof r.responseText?{text:r.responseText}:void 0,r.getAllResponseHeaders()))}},r.onload=t(),r.onerror=t("error"),t=At[s]=t("abort")
...
return this[e]=!0,e}}),K.ajaxPrefilter("json jsonp",function(t,n,i){var o,r,s,a=t.jsonp!==!1&&(Mt.test(t.url)?"url":"string"==typeof t.data&&!(t.contentType||"").indexOf("application/x-www-form-urlencoded")&&Mt.test(t.data)&&"data")
return a||"jsonp"===t.dataTypes[0]?(o=t.jsonpCallback=K.isFunction(t.jsonpCallback)?t.jsonpCallback():t.jsonpCallback,a?t[a]=t[a].replace(Mt,"$1"+o):t.jsonp!==!1&&(t.url+=(ut.test(t.url)?"&":"?")+t.jsonp+"="+o),t.converters["script json"]=function(){return s||K.error(o+" was not called"),s[0]},t.dataTypes[0]="json",r=e[o],e[o]=function(){s=arguments},i.always(function(){e[o]=r,t[o]&&(t.jsonpCallback=n.jsonpCallback,Ot.push(o)),s&&K.isFunction(r)&&r(s[0]),s=r=void 0}),"script"):void 0}),K.parseHTML=function(e,t,n){if(!e||"string"!=typeof e)return null
...
return a>=0&&(i=K.trim(e.slice(a)),e=e.slice(0,a)),K.isFunction(t)?(n=t,t=void 0):t&&"object"==typeof t&&(o="POST"),s.length>0&&K.ajax({url:e,type:o,dataType:"html",data:t}).done(function(e){r=arguments,s.html(i?K("<div>").append(K.parseHTML(e)).find(i):e)}).complete(n&&function(e,t){s.each(n,r||[e.responseText,t,e])}),this},K.each(["ajaxStart","ajaxStop","ajaxComplete","ajaxError","ajaxSuccess","ajaxSend"],function(e,t){K.fn[t]=function(e){return this.on(t,e)}}),K.expr.filters.animated=function(e){return K.grep(K.timers,function(t){return e===t.elem}).length}
var Pt=e.document.documentElement
K.offset={setOffset:function(e,t,n){var i,o,r,s,a,l,c,u=K.css(e,"position"),d=K(e),p={}
"static"===u&&(e.style.position="relative"),a=d.offset(),r=K.css(e,"top"),l=K.css(e,"left"),c=("absolute"===u||"fixed"===u)&&(r+l).indexOf("auto")>-1,c?(i=d.position(),s=i.top,o=i.left):(s=parseFloat(r)||0,o=parseFloat(l)||0),K.isFunction(t)&&(t=t.call(e,n,a)),null!=t.top&&(p.top=t.top-a.top+s),null!=t.left&&(p.left=t.left-a.left+o),"using"in t?t.using.call(e,p):d.css(p)}},K.fn.extend({offset:function(e){if(arguments.length)return void 0===e?this:this.each(function(t){K.offset.setOffset(this,e,t)})
...
K.fn[t]=function(o){return ge(this,function(t,o,r){var s=q(t)
...
return K.isWindow(t)?t.document.documentElement["client"+e]:9===t.nodeType?(o=t.documentElement,Math.max(t.body["scroll"+e],o["scroll"+e],t.body["offset"+e],o["offset"+e],o["client"+e])):void 0===i?K.css(t,n,s):K.style(t,n,i,s)},t,r?i:void 0,r,null)}})}),K.fn.size=function(){return this.length},K.fn.andSelf=K.fn.addBack,"function"==typeof define&&define.amd&&define("jquery",[],function(){return K})
...
for(t in e)return!1
return!0}function r(e){return"number"==typeof e||"[object Number]"===Object.prototype.toString.call(e)}function s(e){return e instanceof Date||"[object Date]"===Object.prototype.toString.call(e)}function a(e,t){var n,i=[]
...
return 0!==t&&isFinite(t)&&(n=b(t)),n}function x(e,t,n){var i,o=Math.min(e.length,t.length),r=Math.abs(e.length-t.length),s=0
for(i=0;i<o;i++)(n&&e[i]!==t[i]||!n&&w(e[i])!==w(t[i]))&&s++
return s+r}function _(t){e.suppressDeprecationWarnings===!1&&"undefined"!=typeof console&&console.warn&&console.warn("Deprecation warning: "+t)}function C(t,n){var i=!0
return c(function(){if(null!=e.deprecationHandler&&e.deprecationHandler(null,t),i){for(var o,r=[],s=0;s<arguments.length;s++){if(o="","object"==typeof arguments[s]){o+="\n["+s+"] "
...
return n?"MMM"===t?(o=uo.call(this._shortMonthsParse,s),o!==-1?o:null):(o=uo.call(this._longMonthsParse,s),o!==-1?o:null):"MMM"===t?(o=uo.call(this._shortMonthsParse,s),o!==-1?o:(o=uo.call(this._longMonthsParse,s),o!==-1?o:null)):(o=uo.call(this._longMonthsParse,s),o!==-1?o:(o=uo.call(this._shortMonthsParse,s),o!==-1?o:null))}function le(e,t,n){var i,o,r
...
return-o+i-1}function xe(e,t,n,i,o){var r,s,a=(7+n-i)%7,l=we(e,i,o),c=1+7*(t-1)+a+l
return c<=0?(r=e-1,s=me(r)+c):c>me(e)?(r=e+1,s=c-me(e)):(r=e,s=c),{year:r,dayOfYear:s}}function _e(e,t,n){var i,o,r=we(e.year(),t,n),s=Math.floor((e.dayOfYear()-r-1)/7)+1
return s<1?(o=e.year()-1,i=s+Ce(o,t,n)):s>Ce(e.year(),t,n)?(i=s-Ce(e.year(),t,n),o=e.year()+1):(o=e.year(),i=s),{week:i,year:o}}function Ce(e,t,n){var i=we(e,t,n),o=we(e+1,t,n)
...
for(s.sort(e),a.sort(e),l.sort(e),c.sort(e),t=0;t<7;t++)a[t]=ee(a[t]),l[t]=ee(l[t]),c[t]=ee(c[t])
this._weekdaysRegex=new RegExp("^("+c.join("|")+")","i"),this._weekdaysShortRegex=this._weekdaysRegex,this._weekdaysMinRegex=this._weekdaysRegex,this._weekdaysStrictRegex=new RegExp("^("+l.join("|")+")","i"),this._weekdaysShortStrictRegex=new RegExp("^("+a.join("|")+")","i"),this._weekdaysMinStrictRegex=new RegExp("^("+s.join("|")+")","i")}function ze(){return this.hours()%12||12}function Ue(){return this.hours()||24}function Ye(e,t){B(e,0,0,function(){return this.localeData().meridiem(this.hours(),this.minutes(),t)})}function Be(e,t){return t._meridiemParse}function Ve(e){return"p"===(e+"").toLowerCase().charAt(0)}function Ge(e,t,n){return e>11?n?"pm":"PM":n?"am":"AM"}function Qe(e){return e?e.toLowerCase().replace("_","-"):e}function Ze(e){for(var t,n,i,o,r=0;r<e.length;){for(o=Qe(e[r]).split("-"),t=o.length,n=Qe(e[r+1]),n=n?n.split("-"):null;t>0;){if(i=Je(o.slice(0,t).join("-")))return i
...
return n&&p(e).overflow===-2&&(t=n[no]<0||n[no]>11?no:n[io]<1||n[io]>oe(n[to],n[no])?io:n[oo]<0||n[oo]>24||24===n[oo]&&(0!==n[ro]||0!==n[so]||0!==n[ao])?oo:n[ro]<0||n[ro]>59?ro:n[so]<0||n[so]>59?so:n[ao]<0||n[ao]>999?ao:-1,p(e)._overflowDayOfYear&&(t<to||t>io)&&(t=io),p(e)._overflowWeeks&&t===-1&&(t=lo),p(e)._overflowWeekday&&t===-1&&(t=co),p(e).overflow=t),e}function ot(e){var t,n,i,o,r,s,a=e._i,l=Io.exec(a)||Oo.exec(a)
...
s="Z"}e._f=o+(r||"")+(s||""),ut(e)}else e._isValid=!1}function rt(t){var n=Fo.exec(t._i)
return null!==n?void(t._d=new Date(+n[1])):(ot(t),void(t._isValid===!1&&(delete t._isValid,e.createFromInputFallback(t))))}function st(e,t,n){return null!=e?e:null!=t?t:n}function at(t){var n=new Date(e.now())
...
if(!e._d){for(i=at(e),e._w&&null==e._a[io]&&null==e._a[no]&&ct(e),e._dayOfYear&&(o=st(e._a[to],i[to]),e._dayOfYear>me(o)&&(p(e)._overflowDayOfYear=!0),n=be(o,0,e._dayOfYear),e._a[no]=n.getUTCMonth(),e._a[io]=n.getUTCDate()),t=0;t<3&&null==e._a[t];++t)e._a[t]=r[t]=i[t]
for(;t<7;t++)e._a[t]=r[t]=null==e._a[t]?2===t?1:0:e._a[t]
24===e._a[oo]&&0===e._a[ro]&&0===e._a[so]&&0===e._a[ao]&&(e._nextDay=!0,e._a[oo]=0),e._d=(e._useUTC?be:ye).apply(null,r),null!=e._tzm&&e._d.setUTCMinutes(e._d.getUTCMinutes()-e._tzm),e._nextDay&&(e._a[oo]=24)}}function ct(e){var t,n,i,o,r,s,a,l
if(t=e._w,null!=t.GG||null!=t.W||null!=t.E)r=1,s=4,n=st(t.GG,e._a[to],_e(yt(),1,4).year),i=st(t.W,1),o=st(t.E,1),(o<1||o>7)&&(l=!0)
else{r=e._locale._week.dow,s=e._locale._week.doy
var c=_e(yt(),r,s)
n=st(t.gg,e._a[to],c.year),i=st(t.w,c.week),null!=t.d?(o=t.d,(o<0||o>6)&&(l=!0)):null!=t.e?(o=t.e+r,(t.e<0||t.e>6)&&(l=!0)):o=r}i<1||i>Ce(n,r,s)?p(e)._overflowWeeks=!0:null!=l?p(e)._overflowWeekday=!0:(a=xe(n,i,o,r,s),e._a[to]=a.year,e._dayOfYear=a.dayOfYear)}function ut(t){if(t._f===e.ISO_8601)return void ot(t)
t._a=[],p(t).empty=!0
var n,i,o,r,s,a=""+t._i,l=a.length,c=0
for(o=Z(t._f,t._locale).match(Oi)||[],n=0;n<o.length;n++)r=o[n],i=(a.match(X(r,t))||[])[0],i&&(s=a.substr(0,a.indexOf(i)),s.length>0&&p(t).unusedInput.push(s),a=a.slice(a.indexOf(i)+i.length),c+=i.length),Pi[r]?(i?p(t).empty=!1:p(t).unusedTokens.push(r),ie(r,i,t)):t._strict&&!i&&p(t).unusedTokens.push(r)
p(t).charsLeftOver=l-c,a.length>0&&p(t).unusedInput.push(a),t._a[oo]<=12&&p(t).bigHour===!0&&t._a[oo]>0&&(p(t).bigHour=void 0),p(t).parsedDateParts=t._a.slice(0),p(t).meridiem=t._meridiem,t._a[oo]=dt(t._locale,t._a[oo],t._meridiem),lt(t),it(t)}function dt(e,t,n){var i
...
e._a=a([t.year,t.month,t.day||t.date,t.hour,t.minute,t.second,t.millisecond],function(e){return e&&parseInt(e,10)}),lt(e)}}function ft(e){var t=new v(it(mt(e)))
return t._nextDay&&(t.add(1,"d"),t._nextDay=void 0),t}function mt(e){var t=e._i,i=e._f
return e._locale=e._locale||tt(e._l),null===t||void 0===i&&""===t?f({nullInput:!0}):("string"==typeof t&&(e._i=t=e._locale.preparse(t)),y(t)?new v(it(t)):(s(t)?e._d=t:n(i)?pt(e):i?ut(e):gt(e),h(e)||(e._d=null),e))}function gt(t){var i=t._i
void 0===i?t._d=new Date(e.now()):s(i)?t._d=new Date(i.valueOf()):"string"==typeof i?rt(t):n(i)?(t._a=a(i.slice(0),function(e){return parseInt(e,10)}),lt(t)):"object"==typeof i?ht(t):r(i)?t._d=new Date(i):e.createFromInputFallback(t)}function vt(e,t,r,s,a){var l={}
return r!==!0&&r!==!1||(s=r,r=void 0),(i(e)&&o(e)||n(e)&&0===e.length)&&(e=void 0),l._isAMomentObject=!0,l._useUTC=l._isUTC=a,l._l=r,l._i=e,l._f=t,l._strict=s,ft(l)}function yt(e,t,n,i){return vt(e,t,n,i,!1)}function bt(e,t){var i,o
...
return bt("isAfter",e)}function _t(e){var t=N(e),n=t.year||0,i=t.quarter||0,o=t.month||0,r=t.week||0,s=t.day||0,a=t.hour||0,l=t.minute||0,c=t.second||0,u=t.millisecond||0
this._milliseconds=+u+1e3*c+6e4*l+1e3*a*60*60,this._days=+s+7*r,this._months=+o+3*i+12*n,this._data={},this._locale=tt(),this._bubble()}function Ct(e){return e instanceof _t}function St(e){return e<0?Math.round(-1*e)*-1:Math.round(e)}function Dt(e,t){B(e,0,0,function(){var e=this.utcOffset(),n="+"
...
return n._isUTC?(i=n.clone(),o=(y(t)||s(t)?t.valueOf():yt(t).valueOf())-i.valueOf(),i._d.setTime(i._d.valueOf()+o),e.updateOffset(i,!1),i):yt(t).local()}function Et(e){return 15*-Math.round(e._d.getTimezoneOffset()/15)}function At(t,n){var i,o=this._offset||0
...
return this._isDSTShifted}function Nt(){return!!this.isValid()&&!this._isUTC}function jt(){return!!this.isValid()&&this._isUTC}function Rt(){return!!this.isValid()&&(this._isUTC&&0===this._offset)}function Ht(e,t){var n,i,o,s=e,a=null
return Ct(e)?s={ms:e._milliseconds,d:e._days,M:e._months}:r(e)?(s={},t?s[t]=e:s.milliseconds=e):(a=qo.exec(e))?(n="-"===a[1]?-1:1,s={y:0,d:w(a[io])*n,h:w(a[oo])*n,m:w(a[ro])*n,s:w(a[so])*n,ms:w(St(1e3*a[ao]))*n}):(a=Wo.exec(e))?(n="-"===a[1]?-1:1,s={y:qt(a[2],n),M:qt(a[3],n),w:qt(a[4],n),d:qt(a[5],n),h:qt(a[6],n),m:qt(a[7],n),s:qt(a[8],n)}):null==s?s={}:"object"==typeof s&&("from"in s||"to"in s)&&(o=zt(yt(s.from),yt(s.to)),s={},s.ms=o.milliseconds,s.M=o.months),i=new _t(s),Ct(e)&&l(e,"_locale")&&(i._locale=e._locale),i}function qt(e,t){var n=e&&parseFloat(e.replace(",","."))
...
return null===i||isNaN(+i)||(S(t,"moment()."+t+"(period, number) is deprecated. Please use moment()."+t+"(number, period). See http://momentjs.com/guides/#/warnings/add-inverted-param/ for more info."),r=n,n=i,i=r),n="string"==typeof n?+n:n,o=Ht(n,i),Yt(this,o,e),this}}function Yt(t,n,i,o){var r=n._milliseconds,s=St(n._days),a=St(n._months)
t.isValid()&&(o=null==o||o,r&&t._d.setTime(t._d.valueOf()+r*i),s&&W(t,"Date",q(t,"Date")+s*i),a&&ce(t,q(t,"Month")+a*i),o&&e.updateOffset(t,s||a))}function Bt(e,t){var n=e.diff(t,"days",!0)
return n<-6?"sameElse":n<-1?"lastWeek":n<0?"lastDay":n<1?"sameDay":n<2?"nextDay":n<7?"nextWeek":"sameElse"}function Vt(t,n){var i=t||yt(),o=kt(i,this).startOf("day"),r=e.calendarFormat(this,o)||"sameElse",s=n&&(D(n[r])?n[r].call(this,i):n[r])
return this.format(s||this.localeData().calendar(r,this,yt(i)))}function Gt(){return new v(this)}function Qt(e,t){var n=y(e)?e:yt(e)
...
return!(!this.isValid()||!i.isValid())&&(t=F(t||"millisecond"),"millisecond"===t?this.valueOf()===i.valueOf():(n=i.valueOf(),this.clone().startOf(t).valueOf()<=n&&n<=this.clone().endOf(t).valueOf()))}function Kt(e,t){return this.isSame(e,t)||this.isAfter(e,t)}function en(e,t){return this.isSame(e,t)||this.isBefore(e,t)}function tn(e,t,n){var i,o,r,s
return this.isValid()?(i=kt(e,this),i.isValid()?(o=6e4*(i.utcOffset()-this.utcOffset()),t=F(t),"year"===t||"month"===t||"quarter"===t?(s=nn(this,i),"quarter"===t?s/=3:"year"===t&&(s/=12)):(r=this-i,s="second"===t?r/1e3:"minute"===t?r/6e4:"hour"===t?r/36e5:"day"===t?(r-o)/864e5:"week"===t?(r-o)/6048e5:r),n?s:b(s)):NaN):NaN}function nn(e,t){var n,i,o=12*(t.year()-e.year())+(t.month()-e.month()),r=e.clone().add(o,"months")
...
return 0<e.year()&&e.year()<=9999?D(Date.prototype.toISOString)?this.toDate().toISOString():Q(e,"YYYY-MM-DD[T]HH:mm:ss.SSS[Z]"):Q(e,"YYYYYY-MM-DD[T]HH:mm:ss.SSS[Z]")}function sn(){if(!this.isValid())return"moment.invalid(/* "+this._i+" */)"
var e="moment",t=""
this.isLocal()||(e=0===this.utcOffset()?"moment.utc":"moment.parseZone",t="Z")
var n="["+e+'("]',i=0<this.year()&&this.year()<=9999?"YYYY":"YYYYYY",o="-MM-DD[T]HH:mm:ss.SSS",r=t+'[")]'
return this.format(n+i+o+r)}function an(t){t||(t=this.isUtc()?e.defaultFormatUtc:e.defaultFormat)
var n=Q(this,t)
...
return null==e?_e(this,i,o).year:(r=Ce(e,i,o),t>r&&(t=r),On.call(this,e,t,n,i,o))}function On(e,t,n,i,o){var r=xe(e,t,n,i,o),s=be(r.year,0,r.dayOfYear)
return this.year(s.getUTCFullYear()),this.month(s.getUTCMonth()),this.date(s.getUTCDate()),this}function Mn(e){return null==e?Math.ceil((this.month()+1)/3):this.month(3*(e-1)+this.month()%3)}function Ln(e){var t=Math.round((this.clone().startOf("day")-this.clone().startOf("year"))/864e5)+1
return null==e?t:this.add(e-t,"d")}function Pn(e,t){t[ao]=w(1e3*("0."+e))}function Fn(){return this._isUTC?"UTC":""}function Nn(){return this._isUTC?"Coordinated Universal Time":""}function jn(e){return yt(1e3*e)}function Rn(){return yt.apply(null,arguments).parseZone()}function Hn(e){return e}function qn(e,t,n,i){var o=tt(),r=u().set(i,t)
...
var o=tt(),s=e?o._week.dow:0
if(null!=n)return qn(t,(n+s)%7,i,"day")
var a,l=[]
for(a=0;a<7;a++)l[a]=qn(t,(a+s)%7,i,"day")
...
return r>=0&&s>=0&&a>=0||r<=0&&s<=0&&a<=0||(r+=864e5*Kn(ni(a)+s),s=0,a=0),l.milliseconds=r%1e3,e=b(r/1e3),l.seconds=e%60,t=b(e/60),l.minutes=t%60,n=b(t/60),l.hours=n%24,s+=b(n/24),o=b(ti(s)),a+=o,s-=Kn(ni(o)),i=b(a/12),a%=12,l.days=s,l.months=a,l.years=i,this}function ti(e){return 4800*e/146097}function ni(e){return 146097*e/4800}function ii(e){var t,n,i=this._milliseconds
...
default:throw new Error("Unknown unit "+e)}}function oi(){return this._milliseconds+864e5*this._days+this._months%12*2592e6+31536e6*w(this._months/12)}function ri(e){return function(){return this.as(e)}}function si(e){return e=F(e),this[e+"s"]()}function ai(e){return function(){return this._data[e]}}function li(){return b(this.days()/7)}function ci(e,t,n,i,o){return o.relativeTime(t||1,!!n,e,i)}function ui(e,t,n){var i=Ht(e).abs(),o=mr(i.as("s")),r=mr(i.as("m")),s=mr(i.as("h")),a=mr(i.as("d")),l=mr(i.as("M")),c=mr(i.as("y")),u=o<gr.s&&["s",o]||r<=1&&["m"]||r<gr.m&&["mm",r]||s<=1&&["h"]||s<gr.h&&["hh",s]||a<=1&&["d"]||a<gr.d&&["dd",a]||l<=1&&["M"]||l<gr.M&&["MM",l]||c<=1&&["y"]||["yy",c]
...
var s=n,a=r,l=o,c=t,u=e,d=i,p=this.asSeconds()
return p?(p<0?"-":"")+"P"+(s?s+"Y":"")+(a?a+"M":"")+(l?l+"D":"")+(c||u||d?"T":"")+(c?c+"H":"")+(u?u+"M":"")+(d?d+"S":""):"P0D"}var mi,gi
...
t[oo]=w(e.substr(0,i)),t[ro]=w(e.substr(i,2)),t[so]=w(e.substr(o)),p(n).bigHour=!0}),te("Hmm",function(e,t,n){var i=e.length-2
t[oo]=w(e.substr(0,i)),t[ro]=w(e.substr(i))}),te("Hmmss",function(e,t,n){var i=e.length-4,o=e.length-2
t[oo]=w(e.substr(0,i)),t[ro]=w(e.substr(i,2)),t[so]=w(e.substr(o))})
...
var Vo=H("Minutes",!1)
B("s",["ss",2],0,"second"),P("second","s"),j("second",15),J("s",qi),J("ss",qi,Ni),te(["s","ss"],so)
var Go=H("Seconds",!1)
...
var Ko=Math.abs,er=ri("ms"),tr=ri("s"),nr=ri("m"),ir=ri("h"),or=ri("d"),rr=ri("w"),sr=ri("M"),ar=ri("y"),lr=ai("milliseconds"),cr=ai("seconds"),ur=ai("minutes"),dr=ai("hours"),pr=ai("days"),hr=ai("months"),fr=ai("years"),mr=Math.round,gr={s:45,m:45,h:22,d:26,M:11},vr=Math.abs,yr=_t.prototype
return yr.abs=Qn,yr.add=Jn,yr.subtract=Xn,yr.as=ii,yr.asMilliseconds=er,yr.asSeconds=tr,yr.asMinutes=nr,yr.asHours=ir,yr.asDays=or,yr.asWeeks=rr,yr.asMonths=sr,yr.asYears=ar,yr.valueOf=oi,yr._bubble=ei,yr.get=si,yr.milliseconds=lr,yr.seconds=cr,yr.minutes=ur,yr.hours=dr,yr.days=pr,yr.weeks=li,yr.months=hr,yr.years=fr,yr.humanize=hi,yr.toISOString=fi,yr.toString=fi,yr.toJSON=fi,yr.locale=pn,yr.localeData=hn,yr.toIsoString=C("toIsoString() is deprecated. Please use toISOString() instead (notice the capitals)",fi),yr.lang=Yo,B("X",0,0,"unix"),B("x",0,0,"valueOf"),J("x",Gi),J("X",Ji),te("X",function(e,t,n){n._d=new Date(1e3*parseFloat(e,10))}),te("x",function(e,t,n){n._d=new Date(w(e))}),e.version="2.17.1",t(yt),e.fn=Jo,e.min=wt,e.max=xt,e.now=Ro,e.utc=u,e.unix=jn,e.months=Un,e.isDate=s,e.locale=Xe,e.invalid=f,e.duration=Ht,e.isMoment=y,e.weekdays=Bn,e.parseZone=Rn,e.localeData=tt,e.isDuration=Ct,e.monthsShort=Yn,e.weekdaysMin=Gn,e.defineLocale=Ke,e.updateLocale=et,e.locales=nt,e.weekdaysShort=Vn,e.normalizeUnits=F,e.relativeTimeRounding=di,e.relativeTimeThreshold=pi,e.calendarFormat=Bt,e.prototype=Jo,e}),function(e,t){"object"==typeof exports&&"undefined"!=typeof module?t(require("../moment")):"function"==typeof define&&define.amd?define(["moment"],t):t(e.moment)}(this,function(e){"use strict"
...
return i}),window.Modernizr=function(e,t,n){function i(e){f.cssText=e}function o(e,t){return typeof e===t}var r,s,a,l="2.6.2",c={},u=!0,d=t.documentElement,p="modernizr",h=t.createElement(p),f=h.style,m=({}.toString,{}),g=[],v=g.slice,y={}.hasOwnProperty
...
i||(i=o(n))
var r
return r=i.cache[e]?i.cache[e].cloneNode():h.test(e)?(i.cache[e]=i.createElem(e)).cloneNode():i.createElem(e),r.canHaveChildren&&!p.test(e)?i.frag.appendChild(r):r}function s(e,n){if(e||(e=t),u)return e.createDocumentFragment()
n=n||o(e)
...
y=1,e?e.t?f(function(){("c"==e.t?p.injectCss:p.injectJs)(e.s,0,e.a,e.x,e.e,1)},0):(e(),a()):y=0}function l(e,n,i,o,r,l,c){function u(t){if(!h&&s(d.readyState)&&(b.r=h=1,!y&&a(),d.onload=d.onreadystatechange=null,t)){"img"!=e&&f(function(){x.removeChild(d)},50)
...
l.url.split(".").pop().split("?").shift(),l.bypass||(o&&(o=i(o)?o:o[e]||o[s]||o[e.split("/").pop().split("?")[0]]),l.instead?l.instead(e,o,r,s,a):(T[l.url]?l.noexec=!0:T[l.url]=1,r.load(l.url,l.forceCSS||!l.forceJS&&"css"==l.url.split(".").pop().split("?").shift()?"c":n,l.noexec,l.attrs,l.timeout),(i(o)||i(c))&&r.load(function(){u(),o&&o(l.origUrl,a,s),c&&c(l.origUrl,a,s),T[l.url]=2})))}function a(e,t){function n(e,n){if(e){if(o(e))n||(d=function(){var e=[].slice.call(arguments)
p.apply(this,e),h()}),s(e,d,t,0,c)
...
e&&e.apply(this,t),h()}}(p[l])),s(e[l],d,t,l,c))}else!n&&h()}var a,l,c=!!e.test,u=e.load||e.both,d=e.callback||r,p=d,h=e.complete||r
...
else Object(e)===e&&a(e,d)},p.addPrefix=function(e,t){k[e]=t},p.addFilter=function(e){D.push(e)},p.errorTimeout=1e4,null==t.readyState&&t.addEventListener&&(t.readyState="loading",t.addEventListener("DOMContentLoaded",d=function(){t.removeEventListener("DOMContentLoaded",d,0),t.readyState="complete"},0)),e.yepnope=u(),e.yepnope.executeStack=a,e.yepnope.injectJs=function(e,n,i,o,l,c){var u,d,h=t.createElement("script"),o=o||p.errorTimeout
h.src=e
for(d in i)h.setAttribute(d,i[d])
n=c?a:n||r,h.onreadystatechange=h.onload=function(){!u&&s(h.readyState)&&(u=1,n(),h.onload=h.onreadystatechange=null)},f(function(){u||(u=1,n(1))},o),l?h.onload():m.parentNode.insertBefore(h,m)},e.yepnope.injectCss=function(e,n,i,o,s,l){var c,o=t.createElement("link"),n=l?a:n||r
o.href=e,o.rel="stylesheet",o.type="text/css"
for(c in i)o.setAttribute(c,i[c])
s||(m.parentNode.insertBefore(o,m),f(n,0))}}(this,document),Modernizr.load=function(){yepnope.apply(window,[].slice.call(arguments,0))},function(){var e,t,n,i,o,r,s,a,l=[].slice,c={}.hasOwnProperty,u=function(e,t){function n(){this.constructor=e}for(var i in t)c.call(t,i)&&(e[i]=t[i])
...
return t=arguments[0],e=2<=arguments.length?l.call(arguments,1):[],"function"==typeof t?t.apply(this,e):t},n.prototype.uploadFile=function(e){return this.uploadFiles([e])},n.prototype.uploadFiles=function(e){var t,r,s,a,l,c,u,d,p,h,f,m,g,v,y,b,w,x,_,C,S,D,T,k,E,A,$,I,O,M,L,P,F,N
for(_=new XMLHttpRequest,C=0,k=e.length;C<k;C++)t=e[C],t.xhr=_
m=o(this.options.method,e),w=o(this.options.url,e),_.open(m,w,!0),_.withCredentials=!!this.options.withCredentials,y=null,s=function(n){return function(){var i,o,r
...
return _.send(r)},n.prototype._finished=function(e,t,i){var o,r,s
...
t.barWidth=o[0].offsetWidth-o[0].clientWidth,t.bScrollOversize=100===r[0].offsetWidth&&100!==o[0].clientWidth,t.bScrollbarLeft=1!==Math.round(r.offset().left),t.bBounding=!!n[0].getBoundingClientRect().width,n.remove()}i.extend(e.oBrowser,Ue.__browser),e.oScroll.iBarWidth=Ue.__browser.barWidth}function u(e,t,i,o,r,s){var a,l=!1
for(i!==n&&(a=i,l=!0);o!==r;)e.hasOwnProperty(o)&&(a=l?t(a,e[o],o,e):e[o],l=!0,o+=s)
return a}function d(e,n){var o=Ue.defaults.column,r=e.aoColumns.length,o=i.extend({},Ue.models.oColumn,o,{nTh:n?n:t.createElement("th"),sTitle:o.sTitle?o.sTitle:n?n.innerHTML:"",aDataSort:o.aDataSort?o.aDataSort:[r],mData:o.mData?o.mData:r,idx:r})
e.aoColumns.push(o),o=e.aoPreSearchCols,o[r]=i.extend({},Ue.models.oSearch,o[r]),p(e,r,i(n).data())}function p(e,t,o){var t=e.aoColumns[t],s=e.oClasses,a=i(t.nTh)
...
return i.map(e.aoColumns,function(e,i){e[t]&&n.push(i)}),n}function y(e){var t,i,o,r,s,a,l,c,u,d=e.aoColumns,p=e.aoData,h=Ue.ext.type.detect
for(t=0,i=d.length;t<i;t++)if(l=d[t],u=[],!l.sType&&l._sManualType)l.sType=l._sManualType
else if(!l.sType){for(o=0,r=h.length;o<r;o++){for(s=0,a=p.length;s<a&&(u[s]===n&&(u[s]=_(e,s,t,"type")),c=h[o](u[s],e),c||o===h.length-1)&&"html"!==c;s++);if(c){l.sType=c
break}}l.sType||(l.sType="string")}}function b(e,t,o,r){var s,a,l,c,u,p,h=e.aoColumns
if(t)for(s=t.length-1;0<=s;s--){p=t[s]
var f=p.targets!==n?p.targets:p.aTargets
for(i.isArray(f)||(f=[f]),a=0,l=f.length;a<l;a++)if("number"==typeof f[a]&&0<=f[a]){for(;h.length<=f[a];)d(e)
r(f[a],p)}else if("number"==typeof f[a]&&0>f[a])r(h.length+f[a],p)
else if("string"==typeof f[a])for(c=0,u=h.length;c<u;c++)("_all"==f[a]||i(h[c].nTh).hasClass(f[a]))&&r(c,p)}if(o)for(s=0,e=o.length;s<e;s++)r(s,o[s])}function w(e,t,o,r){var s=e.aoData.length,a=i.extend(!0,{},Ue.models.oRow,{src:o?"dom":"data",idx:s})
a._aData=t,e.aoData.push(a)
for(var l=e.aoColumns,c=0,u=l.length;c<u;c++)l[c].sType=null
return e.aiDisplayMaster.push(s),t=e.rowIdFn(t),t!==n&&(e.aIds[t]=a),(o||!e.oFeatures.bDeferRender)&&O(e,s,o,r),s}function x(e,t){var n
return t instanceof i||(t=i(t)),t.map(function(t,i){return n=I(e,i),w(e,n.data,i,n.cells)})}function _(e,t,i,o){var r=e.iDraw,s=e.aoColumns[i],a=e.aoData[t]._aData,l=s.sDefaultContent,i=s.fnGetData(a,o,{settings:e,row:t,col:i})
if(i===n)return e.iDrawError!=r&&null===l&&(Oe(e,0,"Requested unknown parameter "+("function"==typeof s.mData?"{function}":"'"+s.mData+"'")+" for row "+t,4),e.iDrawError=r),l
...
if(""!==r){a=S(r)
for(var l=0,c=a.length;l<c;l++){if(r=a[l].match(ht),s=a[l].match(ft),r){if(a[l]=a[l].replace(ht,""),""!==a[l]&&(e=e[a[l]]),s=[],a.splice(0,l+1),a=a.join("."),i.isArray(e))for(l=0,c=e.length;l<c;l++)s.push(o(e[l],t,a))
e=r[0].substring(1,r[0].length-1),e=""===e?s:s.join(e)
break}if(s)a[l]=a[l].replace(ft,""),e=e[a[l]]()
...
s=r[r.length-1]
for(var a,l,c=0,u=r.length-1;c<u;c++){if(a=r[c].match(ht),l=r[c].match(ft),a){if(r[c]=r[c].replace(ht,""),e[r[c]]=[],s=r.slice(),s.splice(0,c+1),a=s.join("."),i.isArray(o))for(l=0,u=o.length;l<u;l++)s={},t(s,o[l],a),e[r[c]].push(s)
else e[r[c]]=o
return}l&&(r[c]=r[c].replace(ft,""),e=e[r[c]](o)),null!==e[r[c]]&&e[r[c]]!==n||(e[r[c]]={}),e=e[r[c]]}s.match(ft)?e[s.replace(ft,"")](o):e[s.replace(ht,"")]=o}
return function(n,i){return t(n,i,e)}}return function(t,n){t[e]=n}}function k(e){return at(e.aoData,"_aData")}function E(e){e.aoData.length=0,e.aiDisplayMaster.length=0,e.aiDisplay.length=0,e.aIds={}}function A(e,t,i){for(var o=-1,r=0,s=e.length;r<s;r++)e[r]==t?o=r:e[r]>t&&e[r]--;-1!=o&&i===n&&e.splice(o,1)}function $(e,t,i,o){var r,s=e.aoData[t],a=function(n,i){for(;n.childNodes.length;)n.removeChild(n.firstChild)
n.innerHTML=_(e,t,i,"display")}
if("dom"!==i&&(i&&"auto"!==i||"dom"!==s.src)){var l=s.anCells
if(l)if(o!==n)a(l[o],o)
else for(i=0,r=l.length;i<r;i++)a(l[i],i)}else s._aData=I(e,s,o,o===n?n:s._aData).data
if(s._aSortData=null,s._aFilterData=null,a=e.aoColumns,o!==n)a[o].sType=null
else{for(i=0,r=a.length;i<r;i++)a[i].sType=null
M(e,s)}}function I(e,t,o,r){var s,a,l,c=[],u=t.firstChild,d=0,p=e.aoColumns,h=e._rowReadObject,r=r!==n?r:h?{}:[],f=function(e,t){if("string"==typeof e){var n=e.indexOf("@");-1!==n&&(n=e.substring(n+1),T(e)(r,t.getAttribute(n)))}},m=function(e){o!==n&&o!==d||(a=p[d],l=i.trim(e.innerHTML),a&&a._bAttrSrc?(T(a.mData._)(r,l),f(a.mData.sort,e),f(a.mData.type,e),f(a.mData.filter,e)):h?(a._setter||(a._setter=T(a.mData)),a._setter(r,l)):r[d]=l),d++}
if(u)for(;u;)s=u.nodeName.toUpperCase(),"TD"!=s&&"TH"!=s||(m(u),c.push(u)),u=u.nextSibling
else{c=t.anCells,s=0
for(var g=c.length;s<g;s++)m(c[s])}return(t=u?t:t.nTr)&&(t=t.getAttribute("id"))&&T(e.rowId)(r,t),{data:r,cells:c}}function O(e,n,i,o){var r,s,a,l,c,u=e.aoData[n],d=u._aData,p=[]
if(null===u.nTr){for(r=i||t.createElement("tr"),u.nTr=r,u.anCells=p,r._DT_RowIndex=n,M(e,u),l=0,c=e.aoColumns.length;l<c;l++)a=e.aoColumns[l],s=i?o[l]:t.createElement(a.sCellType),p.push(s),i&&!a.mRender&&a.mData===l||(s.innerHTML=_(e,n,l,"display")),a.sClass&&(s.className+=" "+a.sClass),a.bVisible&&!i?r.appendChild(s):!a.bVisible&&i&&s.parentNode.removeChild(s),a.fnCreatedCell&&a.fnCreatedCell.call(e.oInstance,s,_(e,n,l),d,n,l)
...
for(c&&(r=i("<tr/>").appendTo(a)),t=0,n=d.length;t<n;t++)s=d[t],o=i(s.nTh).addClass(s.sClass),c&&o.appendTo(r),e.oFeatures.bSort&&(o.addClass(s.sSortingClass),!1!==s.bSortable&&(o.attr("tabindex",e.iTabIndex).attr("aria-controls",e.sTableId),Te(e,s.nTh,t))),s.sTitle!=o[0].innerHTML&&o.html(s.sTitle),Re(e,"header")(e,o,s,u)
if(c&&R(e.aoHeader,a),i(a).find(">tr").attr("role","row"),i(a).find(">tr>th, >tr>td").addClass(u.sHeaderTH),i(l).find(">tr>th, >tr>td").addClass(u.sFooterTH),null!==l)for(e=e.aoFooter[0],t=0,n=e.length;t<n;t++)s=d[t],s.nTf=e[t].cell,s.sClass&&i(s.nTf).addClass(s.sClass)}function P(e,t,o){var r,s,a,l,c=[],u=[],d=e.aoColumns.length
...
l++}i(c[r][a].cell).attr("rowspan",d).attr("colspan",l)}}}}function F(e){var t=Ne(e,"aoPreDrawCallback","preDraw",[e])
if(-1!==i.inArray(!1,t))pe(e,!1)
else{var t=[],o=0,r=e.asStripeClasses,s=r.length,a=e.oLanguage,l=e.iInitDisplayStart,c="ssp"==He(e),u=e.aiDisplay
...
if(0!==u.length)for(a=c?e.aoData.length:d,c=c?0:l;c<a;c++){var p=u[c],h=e.aoData[p]
if(null===h.nTr&&O(e,p),p=h.nTr,0!==s){var f=r[o%s]
h._sRowStripe!=f&&(i(p).removeClass(h._sRowStripe).addClass(f),h._sRowStripe=f)}Ne(e,"aoRowCallback",null,[p,h._aData,o,c]),t.push(p),o++}else o=a.sZeroRecords,1==e.iDraw&&"ajax"==He(e)?o=a.sLoadingRecords:a.sEmptyTable&&0===e.fnRecordsTotal()&&(o=a.sEmptyTable),t[0]=i("<tr/>",{class:s?r[0]:""}).append(i("<td />",{valign:"top",colSpan:g(e),class:e.oClasses.sRowEmpty}).html(o))[0]
...
for(var s,a,l,c,u,d,p=e.sDom.split(""),h=0;h<p.length;h++){if(s=null,a=p[h],"<"==a){if(l=i("<div/>")[0],c=p[h+1],"'"==c||'"'==c){for(u="",d=2;p[h+d]!=c;)u+=p[h+d],d++
"H"==u?u=t.sJUIHeader:"F"==u&&(u=t.sJUIFooter),-1!=u.indexOf(".")?(c=u.split("."),l.id=c[0].substr(1,c[0].length-1),l.className=c[1]):"#"==u.charAt(0)?l.id=u.substr(1,u.length-1):l.className=u,h+=d}r.append(l),r=i(l)}else if(">"==a)r=r.parent()
else if("l"==a&&o.bPaginate&&o.bLengthChange)s=le(e)
else if("f"==a&&o.bFilter)s=B(e)
else if("r"==a&&o.bProcessing)s=de(e)
else if("t"==a)s=he(e)
else if("i"==a&&o.bInfo)s=ne(e)
else if("p"==a&&o.bPaginate)s=ce(e)
else if(0!==Ue.ext.feature.length)for(l=Ue.ext.feature,d=0,c=l.length;d<c;d++)if(a==l[d].cFeature){s=l[d].fnInit(e)
break}s&&(l=e.aanFeatures,l[a]||(l[a]=[]),l[a].push(s),r.append(s))}n.replaceWith(r),e.nHolding=null}function R(e,t){var n,o,r,s,a,l,c,u,d,p,h=i(t).children("tr")
for(e.splice(0,e.length),r=0,l=h.length;r<l;r++)e.push([])
for(r=0,l=h.length;r<l;r++)for(n=h[r],o=n.firstChild;o;){if("TD"==o.nodeName.toUpperCase()||"TH"==o.nodeName.toUpperCase()){for(u=1*o.getAttribute("colspan"),d=1*o.getAttribute("rowspan"),u=u&&0!==u&&1!==u?u:1,d=d&&0!==d&&1!==d?d:1,s=0,a=e[r];a[s];)s++
for(c=s,p=1===u,a=0;a<u;a++)for(s=0;s<d;s++)e[r+s][c+a]={cell:o,unique:p},e[r+s].nTr=n}o=o.nextSibling}}function H(e,t,n){var i=[]
...
n?(n=n[0],o[n]||(o[n]=[]),o[n].push(t.value)):o[t.name]=t.value}),t=o}var s,a=e.ajax,l=e.oInstance,c=function(t){Ne(e,null,"xhr",[e,t,e.jqXHR]),n(t)}
...
e.aiDisplay=e.aiDisplayMaster.slice(),e.bAjaxDataGet=!1,F(e),e._bInitComplete||se(e,t),e.bAjaxDataGet=!0,pe(e,!1)}function Y(e,t){var o=i.isPlainObject(e.ajax)&&e.ajax.dataSrc!==n?e.ajax.dataSrc:e.sAjaxDataProp
return"data"===o?t.aaData||t[o]:""!==o?D(o)(t):t}function B(e){var n=e.oClasses,o=e.sTableId,r=e.oLanguage,s=e.oPreviousSearch,a=e.aanFeatures,l='<input type="search" class="'+n.sFilterInput+'"/>',c=r.sSearch,c=c.match(/_INPUT_/)?c.replace("_INPUT_",l):c+l,n=i("<div/>",{id:a.f?null:o+"_filter",class:n.sFilter}).append(i("<label/>").append(c)),a=function(){var t=this.value?this.value:""
t!=s.sSearch&&(V(e,{sSearch:t,bRegex:s.bRegex,bSmart:s.bSmart,bCaseInsensitive:s.bCaseInsensitive}),e._iDisplayStart=0,F(e))},l=null!==e.searchDelay?e.searchDelay:"ssp"===He(e)?400:0,u=i("input",n).val(s.sSearch).attr("placeholder",r.sSearchPlaceholder).bind("keyup.DT search.DT input.DT paste.DT cut.DT",l?ve(a,l):a).bind("keypress.DT",function(e){if(13==e.keyCode)return!1}).attr("aria-controls",o)
return i(e.nTable).on("search.dt.DT",function(n,i){if(e===i)try{u[0]!==t.activeElement&&u.val(s.sSearch)}catch(e){}}),n[0]}function V(e,t,i){var o=e.oPreviousSearch,r=e.aoPreSearchCols,s=function(e){o.sSearch=e.sSearch,o.bRegex=e.bRegex,o.bSmart=e.bSmart,o.bCaseInsensitive=e.bCaseInsensitive}
if(y(e),"ssp"!=He(e)){for(Z(e,t.sSearch,i,t.bEscapeRegex!==n?!t.bEscapeRegex:t.bRegex,t.bSmart,t.bCaseInsensitive),s(t),t=0;t<r.length;t++)Q(e,r[t].sSearch,t,r[t].bEscapeRegex!==n?!r[t].bEscapeRegex:r[t].bRegex,r[t].bSmart,r[t].bCaseInsensitive)
G(e)}else s(t)
e.bFiltered=!0,Ne(e,null,"search",[e])}function G(e){for(var t,n,o=Ue.ext.search,r=e.aiDisplay,s=0,a=o.length;s<a;s++){for(var l=[],c=0,u=r.length;c<u;c++)n=r[c],t=e.aoData[n],o[s](e,t._aFilterData,n,t._aData,c)&&l.push(n)
r.length=0,i.merge(r,l)}}function Q(e,t,n,i,o,r){if(""!==t)for(var s=e.aiDisplay,i=J(t,i,o,r),o=s.length-1;0<=o;o--)t=e.aoData[s[o]]._aFilterData[n],i.test(t)||s.splice(o,1)}function Z(e,t,n,i,o,r){var s,i=J(t,i,o,r),o=e.oPreviousSearch.sSearch,r=e.aiDisplayMaster
if(0!==Ue.ext.search.length&&(n=!0),s=K(e),0>=t.length)e.aiDisplay=r.slice()
else for((s||n||o.length>t.length||0!==t.indexOf(o)||e.bSorted)&&(e.aiDisplay=r.slice()),t=e.aiDisplay,n=t.length-1;0<=n;n--)i.test(e.aoData[t[n]]._sFilterRow)||t.splice(n,1)}function J(e,t,n,o){return e=t?e:X(e),n&&(e="^(?=.*?"+i.map(e.match(/"[^"]+"|[^ ]+/g)||[""],function(e){if('"'===e.charAt(0))var t=e.match(/^"(.*)"$/),e=t?t[1]:e
return e.replace('"',"")}).join(")(?=.*?")+").*$"),RegExp(e,o?"i":"")}function X(e){return e.replace(et,"\\$1")}function K(e){var t,n,i,o,r,s,a,l,c=e.aoColumns,u=Ue.ext.type.search
for(t=!1,n=0,o=e.aoData.length;n<o;n++)if(l=e.aoData[n],!l._aFilterData){for(s=[],i=0,r=c.length;i<r;i++)t=c[i],t.bSearchable?(a=_(e,n,i,"filter"),u[t.sType]&&(a=u[t.sType](a)),null===a&&(a=""),"string"!=typeof a&&a.toString&&(a=a.toString())):a="",a.indexOf&&-1!==a.indexOf("&")&&(mt.innerHTML=a,a=gt?mt.textContent:mt.innerText),a.replace&&(a=a.replace(/[\r\n]/g,"")),s.push(a)
...
Ne(e,null,"preInit",[e]),N(e),r=He(e),("ssp"!=r||s)&&("ajax"==r?q(e,[],function(n){var i=Y(e,n)
for(t=0;t<i.length;t++)w(e,i[t])
e.iInitDisplayStart=o,N(e),pe(e,!1),se(e,n)},e):(pe(e,!1),se(e)))}else setTimeout(function(){re(e)},200)}function se(e,t){e._bInitComplete=!0,(t||e.oInit.aaData)&&h(e),Ne(e,"aoInitComplete","init",[e,t])}function ae(e,t){var n=parseInt(t,10)
e._iDisplayLength=n,je(e),Ne(e,null,"length",[e,n])}function le(e){for(var t=e.oClasses,n=e.sTableId,o=e.aLengthMenu,r=i.isArray(o[0]),s=r?o[0]:o,o=r?o[1]:o,r=i("<select/>",{name:n+"_length","aria-controls":n,class:t.sLengthSelect}),a=0,l=s.length;a<l;a++)r[0][a]=new Option(o[a],s[a])
var c=i("<div><label/></div>").addClass(t.sLength)
return e.aanFeatures.l||(c[0].id=n+"_length"),c.children().append(e.oLanguage.sLengthMenu.replace("_MENU_",r[0].outerHTML)),i("select",c).val(e._iDisplayLength).bind("change.DT",function(){ae(e,i(this).val()),F(e)}),i(e.nTable).bind("length.dt.DT",function(t,n,o){e===n&&i("select",c).val(o)}),c[0]}function ce(e){var t=e.sPaginationType,n=Ue.ext.pager[t],o="function"==typeof n,r=function(e){F(e)},t=i("<div/>").addClass(e.oClasses.sPaging+t)[0],s=e.aanFeatures
...
for(t=s.p.length;c<t;c++)Re(e,"pageButton")(e,s.p[c],c,l,i,a)}else n.fnUpdate(e,r)},sName:"pagination"})),t}function ue(e,t,n){var i=e._iDisplayStart,o=e._iDisplayLength,r=e.fnRecordsDisplay()
...
if(l||!x&&!u&&!c&&p==g(t)&&p==y.length)for(n=0;n<p;n++)(m=f(t,n))&&(a[m].sWidth=xe(y.eq(n).width()))
else{p=i(s).clone().css("visibility","hidden").removeAttr("id"),p.find("tbody tr").remove()
var _=i("<tr/>").appendTo(p.find("tbody"))
for(p.find("thead, tfoot").remove(),p.append(i(t.nTHead).clone()).append(i(t.nTFoot).clone()),p.find("tfoot th, tfoot td").css("width",""),y=H(t,p.find("thead")[0]),n=0;n<m.length;n++)o=a[m[n]],y[n].style.width=null!==o.sWidthOrig&&""!==o.sWidthOrig?xe(o.sWidthOrig):""
if(t.aoData.length)for(n=0;n<m.length;n++)x=m[n],o=a[x],i(be(t,x)).clone(!1).append(o.sContentPadding).appendTo(_)
...
s.style.width=xe(p.css("width")),x.remove()}b&&(s.style.width=xe(b)),!b&&!u||t._reszEvt||(s=function(){i(e).bind("resize.DT-"+t.sInstance,ve(function(){h(t)}))},l?setTimeout(s,1e3):s(),t._reszEvt=!0)}function ve(e,t){var i,o,r=t!==n?t:200
...
if(0>n)return null
var o=e.aoData[n]
return o.nTr?o.anCells[t]:i("<td/>").html(_(e,n,t,"display"))[0]}function we(e,t){for(var n,i=-1,o=-1,r=0,s=e.aoData.length;r<s;r++)n=_(e,r,t,"display")+"",n=n.replace(vt,""),n.length>i&&(i=n.length,o=r)
return o}function xe(e){return null===e?"0px":"number"==typeof e?0>e?"0px":e+"px":e.match(/\d$/)?e+"px":e}function _e(e){var t,o,r,s,a,l,c=[],u=e.aoColumns
t=e.aaSortingFixed,o=i.isPlainObject(t)
var d=[]
for(r=function(e){e.length&&!i.isArray(e[0])?d.push(e):i.merge(d,e)},i.isArray(t)&&r(t),o&&t.pre&&r(t.pre),r(e.aaSorting),o&&t.post&&r(t.post),e=0;e<d.length;e++)for(l=d[e][0],r=u[l].aDataSort,t=0,o=r.length;t<o;t++)s=r[t],a=u[s].sType||"string",d[e]._idx===n&&(d[e]._idx=i.inArray(d[e][1],u[s].asSorting)),c.push({src:l,col:s,dir:d[e][1],index:d[e]._idx,type:a,formatter:Ue.ext.type.order[a+"-pre"]})
return c}function Ce(e){var t,n,i,o,r=[],s=Ue.ext.type.order,a=e.aoData,l=0,c=e.aiDisplayMaster
...
return n=r[e],i=r[t],n<i?-1:n>i?1:0})}e.bSorted=!0}function Se(e){for(var t,n,i=e.aoColumns,o=_e(e),e=e.oLanguage.oAria,r=0,s=i.length;r<s;r++){n=i[r]
var a=n.asSorting
...
"number"==typeof s[0]&&(s=e.aaSorting=[s]),o&&e.oFeatures.bSortMulti?(o=i.inArray(t,at(s,"0")),-1!==o?(t=l(s[o],!0),null===t&&1===s.length&&(t=0),null===t?s.splice(o,1):(s[o][1]=a[t],s[o]._idx=t)):(s.push([t,a[0],0]),s[s.length-1]._idx=0)):s.length&&s[0][0]==t?(t=l(s[0]),s.length=1,s[0][1]=a[t],s[0]._idx=t):(s.length=0,s.push([t,a[0]]),s[0]._idx=0),N(e),"function"==typeof r&&r(e)}function Te(e,t,n,i){var o=e.aoColumns[n]
Pe(t,{},function(t){!1!==o.bSortable&&(e.oFeatures.bProcessing?(pe(e,!0),setTimeout(function(){De(e,n,t.shiftKey,i),"ssp"!==He(e)&&pe(e,!1)},0)):De(e,n,t.shiftKey,i))})}function ke(e){var t,n,o=e.aLastSort,r=e.oClasses.sSortColumn,s=_e(e),a=e.oFeatures
if(a.bSort&&a.bSortClasses){for(a=0,t=o.length;a<t;a++)n=o[a].src,i(at(e.aoData,"anCells",n)).removeClass(r+(2>a?a+1:3))
for(a=0,t=s.length;a<t;a++)n=s[a].src,i(at(e.aoData,"anCells",n)).addClass(r+(2>a?a+1:3))}e.aLastSort=s}function Ee(e,t){var n,i=e.aoColumns[t],o=Ue.ext.order[i.sSortDataType]
o&&(n=o.call(e.oInstance,e,t,m(e,t)))
for(var r,s=Ue.ext.type.order[i.sType+"-pre"],a=0,l=e.aoData.length;a<l;a++)i=e.aoData[a],i._aSortData||(i._aSortData=[]),(!i._aSortData[t]||o)&&(r=o?n[a]:_(e,a,t,"sort"),i._aSortData[t]=s?s(r):r)}function Ae(e){if(e.oFeatures.bStateSave&&!e.bDestroying){var t={time:+new Date,start:e._iDisplayStart,length:e._iDisplayLength,order:i.extend(!0,[],e.aaSorting),search:ee(e.oPreviousSearch),columns:i.map(e.aoColumns,function(t,n){return{visible:t.bVisible,search:ee(e.aoPreSearchCols[n])}})}
...
return!!nt(e)||(t&&i&&(e=ot(e,t)),n&&i&&(e=e.replace(tt,"")),!isNaN(parseFloat(e))&&isFinite(e))},st=function(e,t,n){return!!nt(e)||(nt(e)||"string"==typeof e?!!rt(e.replace(Je,""),t,n)||null:null)},at=function(e,t,i){var o=[],r=0,s=e.length
...
o.push(t),s++}return o},pt=function(e,t,i){e[t]!==n&&(e[i]=e[t])},ht=/\[.*?\]$/,ft=/\(\)$/,mt=i("<div>")[0],gt=mt.textContent!==n,vt=/<.*?>/g
...
e===n||e?t.draw(!1):(""!==o.sX||""!==o.sY)&&fe(i)},this.fnClearTable=function(e){var t=this.api(!0).clear();(e===n||e)&&t.draw()},this.fnClose=function(e){this.api(!0).row(e).child.hide()},this.fnDeleteRow=function(e,t,i){var o=this.api(!0),e=o.rows(e),r=e.settings()[0],s=r.aoData[e[0][0]]
...
return i===n||null===i?s.row(t).data(e):s.cell(t,i).data(e),(r===n||r)&&s.columns.adjust(),(o===n||o)&&s.draw(),0},this.fnVersionCheck=Ye.fnVersionCheck
...
else{a(y),l(y.column),r(y,y,!0),r(y.column,y.column,!0),r(y,i.extend(f,_.data()))
...
break e}c=null}c||(c={name:r,val:{},methodExt:[],propExt:[]},l.push(c)),n===o-1?c.val=t:l=s?c.methodExt:c.propExt}},Be.registerPlural=Ge=function(e,t,o){Be.register(e,o),Be.register(t,function(){var e=o.apply(this,arguments)
...
return{page:r?0:Math.floor(t/i),pages:r?1:Math.ceil(o/i),start:t,end:e.fnDisplayEnd(),length:i,recordsTotal:e.fnRecordsTotal(),recordsDisplay:o,serverSide:"ssp"===He(e)}}),Ve("page.len()",function(e){return e===n?0!==this.context.length?this.context[0]._iDisplayLength:n:this.iterator("table",function(t){ae(t,e)})})
...
var _t=function(e,t,o,r,s){var a,l,c,u,d,p,h=[]
for(c=typeof t,t&&"string"!==c&&"function"!==c&&t.length!==n||(t=[t]),c=0,u=t.length;c<u;c++)for(l=t[c]&&t[c].split?t[c].split(","):[t[c]],d=0,p=l.length;d<p;d++)(a=o("string"==typeof l[d]?i.trim(l[d]):l[d]))&&a.length&&(h=h.concat(a))
if(e=Ye.selector[e],e.length)for(c=0,u=e.length;c<u;c++)h=e[c](r,s,h)
...
return"search"===e?i._aFilterData:i._aSortData},1)}),Ge("rows().invalidate()","row().invalidate()",function(e){return this.iterator("row",function(t,n){$(t,n,e)})}),Ge("rows().indexes()","row().index()",function(){return this.iterator("row",function(e,t){return t},1)}),Ge("rows().ids()","row().id()",function(e){for(var t=[],n=this.context,i=0,o=n.length;i<o;i++)for(var r=0,s=this[i].length;r<s;r++){var a=n[i].rowIdFn(n[i].aoData[this[i][r]]._aData)
t.push((!0===e?"#":"")+a)}return new Be(n,t)}),Ge("rows().remove()","row().remove()",function(){var e=this
...
A(t.aiDisplayMaster,i),A(t.aiDisplay,i),A(e[o],i,!1),je(t),i=t.rowIdFn(s._aData),i!==n&&delete t.aIds[i]}),this.iterator("table",function(e){for(var t=0,n=e.aoData.length;t<n;t++)e.aoData[t].idx=t}),this}),Ve("rows.add()",function(e){var t=this.iterator("table",function(t){var n,i,o,r=[]
...
var t=Ct(t),o=this.iterator("table",function(n){var o=e,r=t,s=n.aoColumns,a=at(s,"sName"),l=at(s,"nTh")
...
if("fromData"===e||"toVisible"===e)return m(n,t)}}),Ve("column()",function(e,t){return St(this.columns(e,t))}),Ve("cells()",function(e,t,o){if(i.isPlainObject(e)&&(e.row===n?(o=e,e=null):(o=t,t=null)),i.isPlainObject(t)&&(o=t,t=null),null===t||t===n)return this.iterator("table",function(t){var r,s,a,l,c,u,d,p=e,h=Ct(o),f=t.aoData,m=Dt(t,h),g=ut(lt(f,m,"anCells")),v=i([].concat.apply([],g)),y=t.aoColumns.length
return _t("cell",p,function(e){var o="function"==typeof e
if(null===e||e===n||o){for(s=[],a=0,l=m.length;a<l;a++)for(r=m[a],c=0;c<y;c++)u={row:r,column:c},o?(d=f[r],e(u,_(t,r,c),d.anCells?d.anCells[c]:null)&&s.push(u)):s.push(u)
...
i.each(t[o],function(t,n){r.push([n,e])}),n.aaSorting=r})}),Ve("search()",function(e,t,o,r){var s=this.context
return e===n?0!==s.length?s[0].oPreviousSearch.sSearch:n:this.iterator("table",function(n){n.oFeatures.bFilter&&V(n,i.extend({},n.oPreviousSearch,{sSearch:e+"",bRegex:null!==t&&t,bSmart:null===o||o,bCaseInsensitive:null===r||r}),1)})}),Ge("columns().search()","column().search()",function(e,t,o,r){return this.iterator("column",function(s,a){var l=s.aoPreSearchCols
return e===n?l[a].sSearch:void(s.oFeatures.bFilter&&(i.extend(l[a],{sSearch:e+"",bRegex:null!==t&&t,bSmart:null===o||o,bCaseInsensitive:null===r||r}),V(s,s.oPreviousSearch,1)))})}),Ve("state()",function(){return this.context.length?this.context[0].oSavedState:null}),Ve("state.clear()",function(){return this.iterator("table",function(e){e.fnStateSaveCallback.call(e.oInstance,e,{})})}),Ve("state.loaded()",function(){return this.context.length?this.context[0].oLoadedState:null}),Ve("state.save()",function(){return this.iterator("table",function(e){Ae(e)})}),Ue.versionCheck=Ue.fnVersionCheck=function(e){for(var t,n,i=Ue.version.split("."),e=e.split("."),o=0,r=e.length;o<r;o++)if(t=parseInt(i[o],10)||0,n=parseInt(e[o],10)||0,t!==n)return t>n
return!0},Ue.isDataTable=Ue.fnIsDataTable=function(e){var t=i(e).get(0),n=!1
return i.each(Ue.settings,function(e,o){var r=o.nScrollHead?i("table",o.nScrollHead)[0]:null,s=o.nScrollFoot?i("table",o.nScrollFoot)[0]:null
o.nTable!==t&&r!==t&&s!==t||(n=!0)}),n},Ue.tables=Ue.fnTables=function(e){var t=!1
...
return e.length?e[0].oInit:null}),Ve("data()",function(){return this.iterator("table",function(e){return at(e.aoData,"_aData")}).flatten()}),Ve("destroy()",function(t){return t=t||!1,this.iterator("table",function(n){var o,r=n.nTableWrapper.parentNode,s=n.oClasses,a=n.nTable,l=n.nTBody,c=n.nTHead,u=n.nTFoot,d=i(a),l=i(l),p=i(n.nTableWrapper),h=i.map(n.aoData,function(e){return e.nTr})
n.bDestroying=!0,Ne(n,"aoDestroyCallback","destroy",[n]),t||new Be(n).columns().visible(!0),p.unbind(".DT").find(":not(tbody *)").unbind(".DT"),i(e).unbind(".DT-"+n.sInstance),a!=c.parentNode&&(d.children("thead").detach(),d.append(c)),u&&a!=u.parentNode&&(d.children("tfoot").detach(),d.append(u)),n.aaSorting=[],n.aaSortingFixed=[],ke(n),i(h).removeClass(n.asStripeClasses.join(" ")),i("th, td",c).removeClass(s.sSortable+" "+s.sSortableAsc+" "+s.sSortableDesc+" "+s.sSortableNone),n.bJUI&&(i("th span."+s.sSortIcon+", td span."+s.sSortIcon,c).detach(),i("th, td",c).each(function(){var e=i("div."+s.sSortJUIWrapper,this)
i(this).append(e.contents()),e.detach()})),l.children().detach(),l.append(h),c=t?"remove":"detach",d[c](),p[c](),!t&&r&&(r.insertBefore(a,n.nTableReinsertBefore),d.css("width",n.sDestroyWidth).removeClass(s.sTable),(o=n.asDestroyStripes.length)&&l.children().each(function(e){i(this).addClass(n.asDestroyStripes[e%o])})),r=i.inArray(n,Ue.settings),-1!==r&&Ue.settings.splice(r,1)})}),i.each(["column","row","cell"],function(e,t){Ve(t+"s().every()",function(e){return this.iterator(t,function(i,o,r,s,a){e.call(new Be(i)[t](o,"cell"===t?r:n),o,r,s,a)})})}),Ve("i18n()",function(e,t,o){var r=this.context[0],e=D(e)(r.oLanguage)
...
break
default:l=g+1,c=s===g?d.sPageButtonActive:""}null!==l&&(m=i("<a>",{class:d.sPageButton+" "+c,"aria-controls":e.sTableId,"data-dt-idx":h,tabindex:e.iTabIndex,id:0===o&&"string"==typeof g?e.sTableId+"_"+g:null}).html(l).appendTo(t),Pe(m,{action:g},v),h++)}}
...
a="bottom"==a&&u.bottom+p>f.bottom?"top":"top"==a&&u.top-p<f.top?"bottom":"right"==a&&u.right+d>f.width?"left":"left"==a&&u.left-d<f.left?"right":a,r.removeClass(h).addClass(a)}var m=this.getCalculatedOffset(a,u,d,p)
...
e.magnificPopup.registerModule(I,{options:{hiddenClass:"hide",markup:"",tNotFound:"Content not found"},proto:{initInline:function(){t.types.push(I),_(a+"."+I,function(){O()})},getInline:function(n,i){if(O(),n.src){var o=t.st.inline,r=e(n.src)
if(r.length){var s=r[0].parentNode
s&&s.tagName&&(A||(E=o.hiddenClass,A=C(E),E="mfp-"+E),$=r.after(A).detach().removeClass(E)),t.updateStatus("ready")}else t.updateStatus("error",o.tNotFound),r=e("<div>")
...
e.magnificPopup.registerModule(L,{options:{settings:null,cursor:"mfp-ajax-cur",tError:'<a href="%url%">The content</a> could not be loaded.'},proto:{initAjax:function(){t.types.push(L),M=t.st.ajax.cursor,_(a+"."+L,F),_("BeforeChange."+L,F)},getAjax:function(n){M&&e(document.body).addClass(M),t.updateStatus("loading")
...
t.types.push("image"),_(p+i,function(){"image"===t.currItem.type&&n.cursor&&e(document.body).addClass(n.cursor)}),_(a+i,function(){n.cursor&&e(document.body).removeClass(n.cursor),x.off("resize"+m)}),_("Resize"+i,t.resizeImage),t.isLowIE&&_("AfterChange",t.resizeImage)},resizeImage:function(){var e=t.currItem
...
r=c(e),r.css(t._getOffset()),t.wrap.append(r),o=setTimeout(function(){r.css(t._getOffset(!0)),o=setTimeout(function(){u(),setTimeout(function(){r.remove(),e=r=null,S("ZoomAnimationEnded")},16)},s)},16)}}),_(l+i,function(){if(t._allowZoom()){if(clearTimeout(o),t.st.removalDelay=s,!e){if(e=t._getItemToZoom(),!e)return
...
return t.direction=!0,!(!n||!n.enabled)&&(r+=" mfp-gallery",_(p+o,function(){n.navigateByImgClick&&t.wrap.on("click"+o,".mfp-img",function(){if(t.items.length>1)return t.next(),!1}),i.on("keydown"+o,function(e){37===e.keyCode?t.prev():39===e.keyCode&&t.next()})}),_("UpdateStatus"+o,function(e,n){n.text&&(n.text=Y(n.text,t.currItem.index,t.items.length))}),_(d+o,function(e,i,o,r){var s=t.items.length
o.counter=s>1?Y(n.tCounter,r.index,s):""}),_("BuildControls"+o,function(){if(t.items.length>1&&n.arrows&&!t.arrowLeft){var i=n.arrowMarkup,o=t.arrowLeft=e(i.replace(/%title%/gi,n.tPrev).replace(/%dir%/gi,"left")).addClass(y),r=t.arrowRight=e(i.replace(/%title%/gi,n.tNext).replace(/%dir%/gi,"right")).addClass(y)
...
void 0!==t[n]&&(o[e]=t[n])}),o},L=function(){var t,o=(h||n).position(),r=(h||n).offset(),s=i.widgetPositioning.vertical,a=i.widgetPositioning.horizontal
...
t=n,n.children().first().after(f)}if("auto"===s&&(s=r.top+1.5*f.height()>=e(window).height()+e(window).scrollTop()&&f.height()+n.outerHeight()<r.top?"top":"bottom"),"auto"===a&&(a=t.width()<r.left+f.outerWidth()/2&&r.left+f.outerWidth()>e(window).width()?"right":"left"),"top"===s?f.addClass("top").removeClass("bottom"):f.addClass("bottom").removeClass("top"),"right"===a?f.addClass("pull-right"):f.removeClass("pull-right"),"static"===t.css("position")&&(t=t.parents().filter(function(){return"static"!==e(this).css("position")}).first()),0===t.length)throw new Error("datetimepicker component should be placed within a non-static positioned container")
f.css({top:"top"===s?"auto":o.top+n.outerHeight(),bottom:"top"===s?t.outerHeight()-(t===n?0:o.top):"auto",left:"left"===a?t===n?0:o.left:"auto",right:"left"===a?"auto":t.outerWidth()-n.outerWidth()-(t===n?0:o.left)})},P=function(e){"dp.change"===e.type&&(e.date&&e.date.isSame(e.oldDate)||!e.date&&!e.oldDate)||n.trigger(e)},F=function(e){"y"===e&&(e="YYYY"),P({type:"dp.update",change:e,viewDate:r.clone()})},N=function(e){f&&(e&&(u=Math.max(m,Math.min(3,u+e))),f.find(".datepicker > div").hide().filter(".datepicker-"+g[u].clsName).show())},j=function(){var t=e("<tr>"),n=r.clone().startOf("w").startOf("d")
...
f.find(".datepicker-months td").empty().append(t)},Y=function(){var t=f.find(".datepicker-months"),n=t.find("th"),s=t.find("tbody").find("span")
n.eq(0).find("span").attr("title",i.tooltips.prevYear),n.eq(1).attr("title",i.tooltips.selectYear),n.eq(2).find("span").attr("title",i.tooltips.nextYear),t.find(".disabled").removeClass("disabled"),z(r.clone().subtract(1,"y"),"y")||n.eq(0).addClass("disabled"),n.eq(1).text(r.year()),z(r.clone().add(1,"y"),"y")||n.eq(2).addClass("disabled"),s.removeClass("active"),o.isSame(r,"y")&&!p&&s.eq(o.month()).addClass("active"),s.each(function(t){z(r.clone().month(t),"M")||e(this).addClass("disabled")})},B=function(){var e=f.find(".datepicker-years"),t=e.find("th"),n=r.clone().subtract(5,"y"),s=r.clone().add(6,"y"),a=""
for(t.eq(0).find("span").attr("title",i.tooltips.prevDecade),t.eq(1).attr("title",i.tooltips.selectDecade),t.eq(2).find("span").attr("title",i.tooltips.nextDecade),e.find(".disabled").removeClass("disabled"),i.minDate&&i.minDate.isAfter(n,"y")&&t.eq(0).addClass("disabled"),t.eq(1).text(n.year()+"-"+s.year()),i.maxDate&&i.maxDate.isBefore(s,"y")&&t.eq(2).addClass("disabled");!n.isAfter(s,"y");)a+='<span data-action="selectYear" class="year'+(n.isSame(o,"y")&&!p?" active":"")+(z(n,"y")?"":" disabled")+'">'+n.year()+"</span>",n.add(1,"y")
e.find("td").html(a)},V=function(){var e,n=f.find(".datepicker-decades"),s=n.find("th"),a=t({y:r.year()-r.year()%100-1}),l=a.clone().add(100,"y"),c=a.clone(),u=!1,d=!1,p=""
for(s.eq(0).find("span").attr("title",i.tooltips.prevCentury),s.eq(2).find("span").attr("title",i.tooltips.nextCentury),n.find(".disabled").removeClass("disabled"),(a.isSame(t({y:1900}))||i.minDate&&i.minDate.isAfter(a,"y"))&&s.eq(0).addClass("disabled"),s.eq(1).text(a.year()+"-"+l.year()),(a.isSame(t({y:2e3}))||i.maxDate&&i.maxDate.isBefore(l,"y"))&&s.eq(2).addClass("disabled");!a.isAfter(l,"y");)e=a.year()+12,u=i.minDate&&i.minDate.isAfter(a,"y")&&i.minDate.year()<=e,d=i.maxDate&&i.maxDate.isAfter(a,"y")&&i.maxDate.year()<=e,p+='<span data-action="selectDecade" class="decade'+(o.isAfter(a)&&o.year()<=e?" active":"")+(z(a,"y")||u||d?"":" disabled")+'" data-selection="'+(a.year()+6)+'">'+(a.year()+1)+" - "+(a.year()+12)+"</span>",a.add(12,"y")
p+="<span></span><span></span><span></span>",n.find("td").html(p),s.eq(1).text(c.year()+1+"-"+a.year())},G=function(){var t,n,s,a=f.find(".datepicker-days"),l=a.find("th"),c=[],u=[]
if(k()){for(l.eq(0).find("span").attr("title",i.tooltips.prevMonth),l.eq(1).attr("title",i.tooltips.selectMonth),l.eq(2).find("span").attr("title",i.tooltips.nextMonth),a.find(".disabled").removeClass("disabled"),l.eq(1).text(r.format(i.dayViewHeaderFormat)),z(r.clone().subtract(1,"M"),"M")||l.eq(0).addClass("disabled"),z(r.clone().add(1,"M"),"M")||l.eq(2).addClass("disabled"),t=r.clone().startOf("M").startOf("w").startOf("d"),s=0;s<42;s++)0===t.weekday()&&(n=e("<tr>"),i.calendarWeeks&&n.append('<td class="cw">'+t.week()+"</td>"),c.push(n)),u=["day"],t.isBefore(r,"M")&&u.push("old"),t.isAfter(r,"M")&&u.push("new"),t.isSame(o,"d")&&!p&&u.push("active"),z(t,"d")||u.push("disabled"),t.isSame(S(),"d")&&u.push("today"),0!==t.day()&&6!==t.day()||u.push("weekend"),P({type:"dp.classify",date:t,classNames:u}),n.append('<td data-action="selectDay" data-day="'+t.format("L")+'" class="'+u.join(" ")+'">'+t.date()+"</td>"),t.add(1,"d")
a.find("tbody").empty().append(c),Y(),B(),V()}},Q=function(){var t=f.find(".timepicker-hours table"),n=r.clone().startOf("d"),i=[],o=e("<tr>")
for(r.hour()>11&&!a&&n.hour(12);n.isSame(r,"d")&&(a||r.hour()<12&&n.hour()<12||r.hour()>11);)n.hour()%4===0&&(o=e("<tr>"),i.push(o)),o.append('<td data-action="selectHour" class="hour'+(z(n,"h")?"":" disabled")+'">'+n.format(a?"HH":"hh")+"</td>"),n.add(1,"h")
t.empty().append(i)},Z=function(){for(var t=f.find(".timepicker-minutes table"),n=r.clone().startOf("h"),o=[],s=e("<tr>"),a=1===i.stepping?5:i.stepping;r.isSame(n,"h");)n.minute()%(4*a)===0&&(s=e("<tr>"),o.push(s)),s.append('<td data-action="selectMinute" class="minute'+(z(n,"m")?"":" disabled")+'">'+n.format("mm")+"</td>"),n.add(a,"m")
...
a||(e=f.find(".timepicker [data-action=togglePeriod]"),t=o.clone().add(o.hours()>=12?-12:12,"h"),e.text(o.format("A")),z(t,"h")?e.removeClass("disabled"):e.addClass("disabled")),n.filter("[data-time-component=hours]").text(o.format(a?"HH":"hh")),n.filter("[data-time-component=minutes]").text(o.format("mm")),n.filter("[data-time-component=seconds]").text(o.format("ss")),Q(),Z(),J()},K=function(){f&&(G(),X())},ee=function(e){var t=p?null:o
if(!e)return p=!0,s.val(""),n.data("date",""),P({type:"dp.change",date:!1,oldDate:t}),void K()
...
z(e)?(o=e,r=o.clone(),s.val(o.format(l)),n.data("date",o.format(l)),p=!1,K(),P({type:"dp.change",date:o.clone(),oldDate:t})):(i.keepInvalid?P({type:"dp.change",date:e,oldDate:t}):s.val(p?"":o.format(l)),P({type:"dp.error",date:e,oldDate:t}))},te=function(){var t=!1
return f?(f.find(".collapse").each(function(){var n=e(this).data("collapse")
return!n||!n.transitioning||(t=!0,!1)}),t?d:(h&&h.hasClass("btn")&&h.toggleClass("active"),f.hide(),e(window).off("resize",L),f.off("click","[data-action]"),f.off("mousedown",!1),f.remove(),f=!1,P({type:"dp.hide",date:o.clone()}),s.blur(),r=o.clone(),d)):d},ne=function(){ee(null)},ie=function(e){return void 0===i.parseInputDate?(!t.isMoment(e)||e instanceof Date)&&(e=S(e)):e=i.parseInputDate(e),e},oe={next:function(){var e=g[u].navFnc
...
z(e,"s")&&ee(e)},togglePeriod:function(){ee(o.clone().add(o.hours()>=12?-12:12,"h"))},togglePicker:function(t){var n,o=e(t.target),r=o.closest("ul"),s=r.find(".in"),a=r.find(".collapse:not(.in)")
if(s&&s.length){if(n=s.data("collapse"),n&&n.transitioning)return
s.collapse?(s.collapse("hide"),a.collapse("show")):(s.removeClass("in"),a.addClass("in")),o.is("span")?o.toggleClass(i.icons.time+" "+i.icons.date):o.find("span").toggleClass(i.icons.time+" "+i.icons.date)}},showPicker:function(){f.find(".timepicker > div:not(.timepicker-picker)").hide(),f.find(".timepicker .timepicker-picker").show()},showHours:function(){f.find(".timepicker .timepicker-picker").hide(),f.find(".timepicker .timepicker-hours").show()},showMinutes:function(){f.find(".timepicker .timepicker-picker").hide(),f.find(".timepicker .timepicker-minutes").show()},showSeconds:function(){f.find(".timepicker .timepicker-picker").hide(),f.find(".timepicker .timepicker-seconds").show()},selectHour:function(t){var n=parseInt(e(t.target).text(),10)
a||(o.hours()>=12?12!==n&&(n+=12):12===n&&(n=0)),ee(o.clone().hours(n)),oe.showPicker.call(d)},selectMinute:function(t){ee(o.clone().minutes(parseInt(e(t.target).text(),10))),oe.showPicker.call(d)},selectSecond:function(t){ee(o.clone().seconds(parseInt(e(t.target).text(),10))),oe.showPicker.call(d)},clear:ne,today:function(){var e=S()
z(e,"d")&&ee(e)},close:te},re=function(t){return!e(t.currentTarget).is(".disabled")&&(oe[e(t.currentTarget).data("action")].apply(d,arguments),!1)},se=function(){var t,n={year:function(e){return e.month(0).date(1).hours(0).seconds(0).minutes(0)},month:function(e){return e.date(1).hours(0).seconds(0).minutes(0)},day:function(e){return e.hours(0).seconds(0).minutes(0)},hour:function(e){return e.seconds(0).minutes(0)},minute:function(e){return e.seconds(0)}}
return s.prop("disabled")||!i.ignoreReadonly&&s.prop("readonly")||f?d:(void 0!==s.val()&&0!==s.val().trim().length?ee(ie(s.val().trim())):p&&i.useCurrent&&(i.inline||s.is("input")&&0===s.val().trim().length)&&(t=S(),"string"==typeof i.useCurrent&&(t=n[i.useCurrent](t)),ee(t)),f=O(),j(),U(),f.find(".timepicker-hours").hide(),f.find(".timepicker-minutes").hide(),f.find(".timepicker-seconds").hide(),K(),N(),e(window).on("resize",L),f.on("click","[data-action]",re),f.on("mousedown",!1),h&&h.hasClass("btn")&&h.toggleClass("active"),L(),f.show(),i.focusOnShow&&!s.is(":focus")&&s.focus(),P({type:"dp.show"}),d)},ae=function(){return f?te():se()},le=function(e){var t,n,o,r,s=null,a=[],l={},c=e.which,u="p"
_[c]=u
for(t in _)_.hasOwnProperty(t)&&_[t]===u&&(a.push(t),parseInt(t,10)!==c&&(l[t]=!0))
for(t in i.keyBinds)if(i.keyBinds.hasOwnProperty(t)&&"function"==typeof i.keyBinds[t]&&(o=t.split(" "),o.length===a.length&&x[c]===o[o.length-1])){for(r=!0,n=o.length-2;n>=0;n--)if(!(x[o[n]]in l)){r=!1
break}if(r){s=i.keyBinds[t]
...
return ee(i),t.stopImmediatePropagation(),!1},de=function(){s.on({change:ue,blur:i.debug?"":te,keydown:le,keyup:ce,focus:i.allowInputToggle?se:""}),n.is("input")?s.on({focus:se}):h&&(h.on("click",ae),h.on("mousedown",!1))},pe=function(){s.off({change:ue,blur:blur,keydown:le,keyup:ce,focus:i.allowInputToggle?te:""}),n.is("input")?s.off({focus:se}):h&&(h.off("click",ae),h.off("mousedown",!1))},he=function(t){var n={}
...
return t.replace(/(\[[^\[]*\])|(\\)?(LTS|LT|LL?L?L?|l{1,4})/g,function(e){return o.localeData().longDateFormat(e)||e})}),c=i.extraFormats?i.extraFormats.slice():[],c.indexOf(e)<0&&c.indexOf(l)<0&&c.push(l),a=l.toLowerCase().indexOf("a")<1&&l.replace(/\[.*?\]/g,"").indexOf("h")<1,D("y")&&(m=2),D("M")&&(m=1),D("d")&&(m=0),u=Math.max(m,u),p||ee(o)}
if(d.destroy=function(){te(),pe(),n.removeData("DateTimePicker"),n.removeData("date")},d.toggle=ae,d.show=se,d.hide=te,d.disable=function(){return te(),h&&h.hasClass("btn")&&h.addClass("disabled"),s.prop("disabled",!0),d},d.enable=function(){return h&&h.hasClass("btn")&&h.removeClass("disabled"),s.prop("disabled",!1),d},d.ignoreReadonly=function(e){if(0===arguments.length)return i.ignoreReadonly
...
return i.locale=e,o.locale(i.locale),r.locale(i.locale),l&&me(),f&&(te(),se()),d},d.stepping=function(e){return 0===arguments.length?i.stepping:(e=parseInt(e,10),(isNaN(e)||e<1)&&(e=1),i.stepping=e,d)},d.useCurrent=function(e){var t=["year","month","day","hour","minute"]
...
return i.collapse===e?d:(i.collapse=e,f&&(te(),se()),d)},d.icons=function(t){if(0===arguments.length)return e.extend({},i.icons)
...
return r=ie(e),F(),d},n.is("input"))s=n
...
if(n.hasClass("input-group")&&(h=0===n.find(".datepickerbutton").length?n.find(".input-group-addon"):n.find(".datepickerbutton")),!i.inline&&!s.is("input"))throw new Error("Could not initialize DateTimePicker without an input element")
return o=S(),r=o.clone(),e.extend(!0,i,M()),d.options(i),me(),de(),s.prop("disabled")&&d.disable(),s.is("input")&&0!==s.val().trim().length?ee(ie(s.val().trim())):i.defaultDate&&void 0===s.attr("placeholder")&&ee(i.defaultDate),i.inline&&se(),d}
return e.fn.datetimepicker=function(t){t=t||{}
var i,o=Array.prototype.slice.call(arguments,1),r=!0,s=["destroy","hide","show","toggle"]
...
if("string"==typeof t)return this.each(function(){var n=e(this),s=n.data("DateTimePicker")
if(!s)throw new Error('bootstrap-datetimepicker("'+t+'") method was called on an element that is not using DateTimePicker')
i=s[t].apply(s,o),r=i===s}),r||e.inArray(t,s)>-1?this:i
...
do o=t+"_"+i()
while(e("#"+o).length>0)
n.attr("id",o)}return n.attr("id")},r=function(t){try{var n=e(t)}catch(e){return null}return 0===n.length?null:n.is('input[type="checkbox"]')?n.prop("checked")===!0:n.is('input[type="radio"]')&&void 0!==n.attr("name")?e('input[name="'+n.attr("name")+'"]:checked').val():void 0!==n.prop("value")?n.val():n.html()},s=function(t,n,i){try{var o=e(t)}catch(e){return}0!==o.length&&(o.is('input[type="checkbox"]')?n?o.attr("checked",!0):o.removeAttr("checked"):void 0!==o.prop("value")?i?o.attr("value",n):o.val(n):o.html(n))},a=function(e){return void 0===e||e},l=function(e){return(e+"").replace(/[.?*+^$[\]\\(){}|-]/g,"\\$&")},c=function(t,n,i,o){var r=function(t){var n=e(t)
e.each(t.attributes,function(t,r){"string"===e.type(r.value)&&n.attr(r.name.replace(i,o),r.value.replace(i,o))}),e.each(n.data(),function(t,r){"string"===e.type(r)&&n.data(t.replace(i,o),r.replace(i,o))})},s=t.eq(n)
r(s[0]),s.find("*").each(function(){r(this)})},u=function(e,t,n,i,o,r){var s=new RegExp(l(n.name_prefix+"["+o+"]"),"g"),a=n.name_prefix+"["+r+"]"
c(t,i,s,a),s=new RegExp(l(e.attr("id")+"_"+o),"g"),a=e.attr("id")+"_"+r,c(t,i,s,a)},d=function(e,t,n,i,o){var r=new RegExp(l(t.name_prefix+"["+i+"]"),"g"),s=t.name_prefix+"["+o+"]"
return n=n.replace(r,s),r=new RegExp(l(e.attr("id")+"_"+i),"g"),s=e.attr("id")+"_"+o,n=n.replace(r,s)},p=function(t){e(t).find(":input").each(function(e,t){s(t,r(t),!0)})},h=function(e,t,n,i){var o=e.data("collection-settings")
...
return e.find(n.elements_selector)},y=function(t,n,i){var r=0===t.find("."+n.prefix+"-tmp").length,s=t.find(n.elements_selector)
if(n.allow_add&&r&&(t.append('<span class="'+n.prefix+'-tmp"></span>'),n.add&&t.append(e(n.add).addClass(n.prefix+"-action "+n.prefix+"-rescue-add").data("collection",t.attr("id")))),i)for(var a=e(n.container),l=t.find("."+n.prefix+"-add, ."+n.prefix+"-rescue-add, ."+n.prefix+"-duplicate").first();s.length<n.init_with_n_elements;){var c=s.length>0?s.last():void 0,u=s.length+1
s=w(a,l,t,n,s,c,u,!1)}if(s.each(function(i){var r=e(this),a=r.find("."+n.prefix+"-actions").addBack().filter("."+n.prefix+"-actions")
0===a.length&&(a=e('<div class="'+n.prefix+'-actions"></div>'),r.append(a))
var l=[{enabled:n.allow_remove,selector:n.prefix+"-remove",html:n.remove,condition:s.length>n.min},{enabled:n.allow_up,selector:n.prefix+"-up",html:n.up,condition:0!==s.index(r)},{enabled:n.allow_down,selector:n.prefix+"-down",html:n.down,condition:s.index(r)!==s.length-1},{enabled:n.allow_add&&!n.add_at_the_end&&!n.custom_add_location,selector:n.prefix+"-add",html:n.add,condition:s.length<n.max},{enabled:n.allow_duplicate,selector:n.prefix+"-duplicate",html:n.duplicate,condition:s.length<n.max}]
e.each(l,function(s,l){if(l.enabled){var c=r.find("."+l.selector)
0===c.length&&l.html&&(c=e(l.html).appendTo(a).addClass(l.selector)),l.condition?(c.removeClass(n.prefix+"-action-disabled"),n.hide_useless_buttons&&c.css("display","")):(c.addClass(n.prefix+"-action-disabled"),n.hide_useless_buttons&&c.css("display","none")),c.addClass(n.prefix+"-action").data("collection",t.attr("id")).data(n.prefix+"-element",o(t.attr("id")+"_"+i,r))}else r.find("."+l.selector).css("display","none")})}),n.allow_add){var d=t.find("."+n.prefix+"-rescue-add").css("display",""),p=t.find("."+n.prefix+"-add");(!n.add_at_the_end&&p.length>0||n.custom_add_location)&&d.css("display","none"),s.length>=n.max&&n.hide_useless_buttons&&t.find("."+n.prefix+"-add, ."+n.prefix+"-rescue-add, ."+n.prefix+"-duplicate").css("display","none")}},b=function(t,n,i){i.children&&e.each(i.children,function(e,i){return i.selector?void(null!==n?n.find(i.selector).collection(i):t.find(i.selector).collection(i)):(console.log("jquery.collection.js: given collection "+t.attr("id")+" has children collections, but children's root selector is undefined."),!0)})},w=function(t,n,i,o,r,s,c,u){if(r.length<o.max&&(u&&a(o.before_duplicate(i,s))||a(o.before_add(i,s)))){var h=i.data("prototype"),f=r.length,m=new RegExp(l(o.prototype_name),"g"),y=e(h.replace(m,f)),w=i.find("> ."+o.prefix+"-tmp")
...
c!==-1&&(r=v(i,r,o,c))}b(i,y,o),(u&&!a(o.after_duplicate(i,y))||!a(o.after_add(i,y)))&&(c!==-1&&(r=g(i,r,o,c+1)),y.remove())}return r},x=function(e,t,n,i,o){if(n.length>t.min&&a(t.before_remove(e,i))){n=g(e,n,t,o)
var r=n.last(),s=r.clone({withDataAndEvents:!0})
r.remove(),a(t.after_remove(e,s))||(e.find("> ."+t.prefix+"-tmp").before(s),n=e.find(t.elements_selector),n=v(e,n,t,o-1))}return n},_=function(e,t,n,i,o){return 0!==o&&a(t.before_up(e,i))&&(n=h(e,n,o,o-1),a(t.after_up(e,i))||(n=h(e,n,o-1,o))),n},C=function(e,t,n,i,o){return o!==n.length-1&&a(t.before_down(e,i))&&(n=h(e,n,o,o+1),a(t.after_down(e,n))||(n=h(e,n,o+1,o))),n},S=e(this)
...
if(i.init_with_n_elements<i.min&&(i.init_with_n_elements=i.min),i.drag_drop&&i.allow_up&&i.allow_down){var s,l
...
return a(i.drag_drop_start(t,n,o,l))?(n.placeholder.height(n.item.height()),n.placeholder.width(n.item.width()),void(s=o.index(l))):void c.sortable("cancel")},update:function(t,n){var o=r.find(i.elements_selector),c=n.item,u=e(this)
u.sortable("cancel"),!1!==i.drag_drop_update(t,n,o,c)&&a(l-s>0?i.before_up(r,c):i.before_down(r,c))&&(l=o.index(c),o=r.find(i.elements_selector),1===Math.abs(l-s)?(o=h(r,o,s,l),a(l-s>0?i.after_up(r,c):i.after_down(r,c))||(o=h(r,o,l,s))):s<l?(o=f(r,o,i,s,l),a(l-s>0?i.after_up(r,c):i.after_down(r,c))||(o=m(r,o,i,l,s))):(o=m(r,o,i,s,l),a(l-s>0?i.after_up(r,c):i.after_down(r,c))||(o=f(r,o,i,l,s))),y(r,i,!1))}},i.drag_drop_options))}r.data("collection-settings",i)
var c=e(i.container)
...
if(void 0===o)throw"Can't find collection: "+n.data("collection")}var r=i.find(o.elements_selector),s=n.data(o.prefix+"-element")?e("#"+n.data(o.prefix+"-element")):void 0,a=s&&s.length?r.index(s):-1,l=n.is("."+o.prefix+"-duplicate");(n.is("."+o.prefix+"-add")||n.is("."+o.prefix+"-rescue-add")||l)&&o.allow_add&&(r=w(c,n,i,o,r,s,a,l)),n.is("."+o.prefix+"-remove")&&o.allow_remove&&(r=x(i,o,r,s,a)),n.is("."+o.prefix+"-up")&&o.allow_up&&(r=_(i,o,r,s,a)),n.is("."+o.prefix+"-down")&&o.allow_down&&(r=C(i,o,r,s,a)),y(i,o,!1),t.preventDefault()}),y(r,i,!0),b(r,null,i),i.after_init(r)}),!0)}}(jQuery),"undefined"==typeof jQuery)throw new Error("AdminLTE requires jQuery")
...
var e,n,i
!function(t){function o(e,t){return w.call(e,t)}function r(e,t){var n,i,o,r,s,a,l,c,u,d,p,h=t&&t.split("/"),f=y.map,m=f&&f["*"]||{}
if(e&&"."===e.charAt(0))if(t){for(e=e.split("/"),s=e.length-1,y.nodeIdCompat&&_.test(e[s])&&(e[s]=e[s].replace(_,"")),e=h.slice(0,h.length-1).concat(e),u=0;u<e.length;u+=1)if(p=e[u],"."===p)e.splice(u,1),u-=1
else if(".."===p){if(1===u&&(".."===e[2]||".."===e[0]))break
u>0&&(e.splice(u-1,2),u-=2)}e=e.join("/")}else 0===e.indexOf("./")&&(e=e.substring(2))
if((h||m)&&f){for(n=e.split("/"),u=n.length;u>0;u-=1){if(i=n.slice(0,u).join("/"),h)for(d=h.length;d>0;d-=1)if(o=f[h.slice(0,d).join("/")],o&&(o=o[i])){r=o,a=u
break}if(r)break
!l&&m&&m[i]&&(l=m[i],c=u)}!r&&l&&(r=l,a=c),r&&(n.splice(0,a,r),e=n.join("/"))}return e}function s(e,n){return function(){var i=x.call(arguments,0)
return"string"!=typeof i[0]&&1===i.length&&i.push(null),h.apply(t,i.concat([e,n]))}}function a(e){return function(t){return r(t,e)}}function l(e){return function(t){g[e]=t}}function c(e){if(o(v,e)){var n=v[e]
...
return e=i[1],o&&(o=r(o,t),n=c(o)),o?e=n&&n.normalize?n.normalize(e,a(t)):r(e,t):(e=r(e,t),i=u(e),o=i[0],e=i[1],o&&(n=c(o))),{f:o?o+"!"+e:e,n:e,pr:o,p:n}},m={require:function(e){return s(e)},exports:function(e){var t=g[e]
return"undefined"!=typeof t?t:g[e]={}},module:function(e){return{id:e,uri:"",exports:g[e],config:d(e)}}},p=function(e,n,i,r){var a,u,d,p,h,y,w=[],x=typeof i
...
else if("module"===u)a=w[h]=m.module(e)
else if(o(g,u)||o(v,u)||o(b,u))w[h]=c(u)
else{if(!p.p)throw new Error(e+" missing "+u)
p.p.load(p.n,s(r,!0),l(u),{}),w[h]=g[u]}d=i?i.apply(g[e],w):void 0,e&&(a&&a.exports!==t&&a.exports!==g[e]?g[e]=a.exports:d===t&&y||(g[e]=d))}else e&&(g[e]=i)},e=n=h=function(e,n,i,o,r){if("string"==typeof e)return m[e]?m[e](n):c(f(e,n).f)
...
i>0&&(t.call(arguments,e.prototype.constructor),o=n.prototype.constructor),o.apply(this,arguments)}function o(){this.constructor=i}var r=t(n),s=t(e)
...
n.setAttribute(o,r)}if(t.children){var s=e(n),a=document.createElement("strong")
...
p.append(l),s.append(a),s.append(p)}else this.template(t,n)
...
0===o?i.$results.scrollTop(0):a-s<0&&i.$results.scrollTop(l)}}),t.on("results:next",function(){var e=i.getHighlightedResults(),t=i.$results.find("[aria-selected]"),n=t.index(e),o=n+1
...
0===o?i.$results.scrollTop(0):a>s&&i.$results.scrollTop(l)}}),t.on("results:focus",function(e){e.element.addClass("select2-results__option--highlighted")}),t.on("results:message",function(e){i.displayMessage(e)}),e.fn.mousewheel&&this.$results.on("mousewheel",function(e){var t=i.$results.scrollTop(),n=i.$results.get(0).scrollHeight-t+e.deltaY,o=e.deltaY>0&&t-e.deltaY<=0,r=e.deltaY<0&&n<=i.$results.height()
...
if(0!==e.length){var t=this.$results.find("[aria-selected]"),n=t.index(e),i=this.$results.offset().top,o=e.offset().top,r=this.$results.scrollTop()+(o-i),s=o-i
r-=2*e.outerHeight(!1),n<=2?this.$results.scrollTop(0):(s>this.$results.outerHeight()||s<0)&&this.$results.scrollTop(r)}},n.prototype.template=function(t,n){var i=this.options.get("templateResult"),o=this.options.get("escapeMarkup"),r=i(t,n)
...
return t},i.prototype.update=function(e){if(this.clear(),0!==e.length){for(var t=[],i=0;i<e.length;i++){var o=e[i],r=this.selectionContainer(),s=this.display(o,r)
r.append(s),r.prop("title",o.title||o.text),r.data("data",o),t.push(r)}var a=this.$selection.find(".select2-selection__rendered")
n.appendMany(a,t)}},i}),t.define("select2/selection/placeholder",["../utils"],function(e){function t(e,t,n){this.placeholder=this.normalizePlaceholder(n.get("placeholder")),e.call(this,t,n)}return t.prototype.normalizePlaceholder=function(e,t){return"string"==typeof t&&(t={id:"",text:t}),t},t.prototype.createPlaceholder=function(e,t){var n=this.selectionContainer()
...
e=.75*t+"em"}this.$search.css("width",e)},i}),t.define("select2/selection/eventRelay",["jquery"],function(e){function t(){}return t.prototype.bind=function(t,n,i){var o=this,r=["open","opening","close","closing","select","selecting","unselect","unselecting"],s=["opening","closing","selecting","unselecting"]
t.call(this,n,i),n.on("*",function(t,n){if(e.inArray(t,r)!==-1){n=n||{}
var i=e.Event("select2:"+t,{params:n})
o.$element.trigger(i),e.inArray(t,s)!==-1&&(n.prevented=i.isDefaultPrevented())}})},t}),t.define("select2/translation",["jquery","require"],function(e,t){function n(e){this.dict=e||{}}return n.prototype.all=function(){return this.dict},n.prototype.get=function(e){return this.dict[e]},n.prototype.extend=function(t){this.dict=e.extend({},t.all(),this.dict)},n._cache={},n.loadPath=function(e){if(!(e in n._cache)){var i=t(e)
...
for(var r=0;r<e.length;r++){var s=e[r].id
n.inArray(s,o)===-1&&o.push(s)}t.$element.val(o),t.$element.trigger("change")})
else{var i=e.id
this.$element.val(i),this.$element.trigger("change")}},i.prototype.unselect=function(e){var t=this
if(this.$element.prop("multiple"))return e.selected=!1,n(e.element).is("option")?(e.element.selected=!1,void this.$element.trigger("change")):void this.current(function(i){for(var o=[],r=0;r<i.length;r++){var s=i[r].id
s!==e.id&&n.inArray(s,o)===-1&&o.push(s)}t.$element.val(o),t.$element.trigger("change")})},i.prototype.bind=function(e,t){var n=this
...
if(t.is("option")||t.is("optgroup")){var r=o.item(t),s=o.matches(e,r)
...
for(var i=e.children("option"),o=[],r=0;r<i.length;r++){var s=n(i[r]),a=this.item(s)
o.push(a)}t.children=o}return t=this._normalizeItem(t),t.element=e[0],n.data(e[0],"data",t),t},i.prototype._normalizeItem=function(e){n.isPlainObject(e)||(e={id:e,text:e}),e=n.extend({},{text:""},e)
...
0===t.length&&(t=this.option(e),this.addOptions(t)),i.__super__.select.call(this,e)},i.prototype.convertToOptions=function(e){function i(e){return function(){return n(this).val()==e.id}}for(var o=this,r=this.$element.find("option"),s=r.map(function(){return o.item(n(this)).id}).get(),a=[],l=0;l<e.length;l++){var c=this._normalizeItem(e[l])
if(n.inArray(c.id,s)>=0){var u=r.filter(i(c)),d=this.item(u),p=n.extend(!0,{},c,d),h=this.option(p)
u.replaceWith(h)}else{var f=this.option(c)
if(c.children){var m=this.convertToOptions(c.children)
t.appendMany(f,m)}a.push(f)}}return a},i}),t.define("select2/data/ajax",["./array","../utils","jquery"],function(e,t,n){function i(e,t){this.ajaxOptions=this._applyDefaults(t.get("ajax")),null!=this.ajaxOptions.processResults&&(this.processResults=this.ajaxOptions.processResults),i.__super__.constructor.call(this,e,t)}return t.Extend(i,e),i.prototype._applyDefaults=function(e){var t={data:function(e){return n.extend({},e,{q:e.term})},transport:function(e,t,i){var o=n.ajax(e)
...
if(void 0!==s&&(this.insertTag=s),t.call(this,n,i),e.isArray(o))for(var a=0;a<o.length;a++){var l=o[a],c=this._normalizeItem(l),u=this.option(c)
this.$element.append(u)}}return t.prototype.query=function(e,t,n){function i(e,r){for(var s=e.results,a=0;a<s.length;a++){var l=s[a],c=null!=l.children&&!i({results:l.children},!0),u=l.text===t.term
if(u||c)return!r&&(e.data=s,void n(e))}if(r)return!0
var d=o.createTag(t)
if(null!=d){var p=o.option(d)
p.attr("data-select2-tag",!0),o.addOptions([p]),o.insertTag(s,d)}e.results=s,n(e)}var o=this
...
void 0!==i&&(this.tokenizer=i),e.call(this,t,n)}return t.prototype.bind=function(e,t,n){e.call(this,t,n),this.$search=t.dropdown.$search||t.selection.$search||n.find(".select2-search__field")},t.prototype.query=function(t,n,i){function o(t){var n=s._normalizeItem(t),i=s.$element.find("option").filter(function(){return e(this).val()===n.id})
if(!i.length){var o=s.option(n)
o.attr("data-select2-tag",!0),s._removeOldTags(),s.addOptions([o])}r(n)}function r(e){s.trigger("select",{data:e})}var s=this
n.term=n.term||""
var a=this.tokenizer(n,this.options,o)
a.term!==n.term&&(this.$search.length&&(this.$search.val(a.term),this.$search.focus()),n.term=a.term),t.call(this,n,i)},t.prototype.tokenizer=function(t,n,i,o){for(var r=i.get("tokenSeparators")||[],s=n.term,a=0,l=this.createTag||function(e){return{id:e.term,text:e.term}};a<s.length;){var c=s[a]
if(e.inArray(c,r)!==-1){var u=s.substr(0,a),d=e.extend({},n,{term:u}),p=l(d)
...
return n.append(i),this.$dropdownContainer=n,n},n.prototype._hideDropdown=function(e){this.$dropdownContainer.detach()},n.prototype._attachPositioningHandler=function(n,i){var o=this,r="scroll.select2."+i.id,s="resize.select2."+i.id,a="orientationchange.select2."+i.id,l=this.$container.parents().filter(t.hasScroll)
...
e(this).scrollTop(n.y)}),e(window).on(r+" "+s+" "+a,function(e){o._positionDropdown(),o._resizeDropdown()})},n.prototype._detachPositioningHandler=function(n,i){var o="scroll.select2."+i.id,r="resize.select2."+i.id,s="orientationchange.select2."+i.id,a=this.$container.parents().filter(t.hasScroll)
a.off(o),e(window).off(o+" "+r+" "+s)},n.prototype._positionDropdown=function(){var t=e(window),n=this.$dropdown.hasClass("select2-dropdown--above"),i=this.$dropdown.hasClass("select2-dropdown--below"),o=null,r=this.$container.offset()
r.bottom=r.top+this.$container.outerHeight(!1)
var s={height:this.$container.outerHeight(!1)}
s.top=r.top,s.bottom=r.top+s.height
var a={height:this.$dropdown.outerHeight(!1)},l={top:t.scrollTop(),bottom:t.scrollTop()+t.height()},c=l.top<r.top-a.height,u=l.bottom>r.bottom+a.height,d={left:r.left,top:s.bottom},p=this.$dropdownParent
...
if(o.children&&o.children.length>0){for(var r=e.extend(!0,{},o),s=o.children.length-1;s>=0;s--){var a=o.children[s],l=n(i,a)
null==l&&r.children.splice(s,1)}return r.children.length>0?r:n(i,r)}var c=t(o.text).toUpperCase(),u=t(i.term).toUpperCase()
...
for(var s=r.split(";"),a=0,l=s.length;a<l;a+=1){var c=s[a].replace(/\s/g,""),u=c.match(n)
...
return t.attr("dir",this.options.get("dir")),this.$container=t,this.$container.addClass("select2-container--"+this.options.get("theme")),t.data("element",this.$element),t},o}),t.define("select2/compat/utils",["jquery"],function(e){function t(t,n,i){var o,r,s=[]
...
if(s=s||n,r.indexOf(":all:")!==-1){r=r.replace(":all:","")
var a=s
s=function(e){var t=a(e)
return null!=t?t+" "+e:e}}var l=this.options.get("containerCss")||{}
return e.isFunction(l)&&(l=l(this.$element)),t.syncCssClasses(o,this.$element,s),o.css(l),o.addClass(r),o},i}),t.define("select2/compat/dropdownCss",["jquery","./utils"],function(e,t){function n(e){return null}function i(){}return i.prototype.render=function(i){var o=i.call(this),r=this.options.get("dropdownCssClass")||""
e.isFunction(r)&&(r=r(this.$element))
...
return t.selected||e.inArray(t.id,n)!==-1?(t.selected=!0,o.push(t)):t.selected=!1,t.children&&o.push.apply(o,i(t.children,n)),o}for(var o=[],r=0;r<this._currentData.length;r++){var s=this._currentData[r]
o.push.apply(o,i(s,this.$element.val().split(this._valueSeparator)))}n(o)},t.prototype.select=function(t,n){if(this.options.get("multiple")){var i=this.$element.val()
...
t.id!=r.id&&i.push(r.id)}n.$element.val(i.join(n._valueSeparator)),n.$element.trigger("change")})},t.prototype.query=function(e,t,n){for(var i=[],o=0;o<this._currentData.length;o++){var r=this._currentData[o],s=this.matches(t,r)
null!==s&&i.push(s)}n({results:i})},t.prototype.addOptions=function(t,n){var i=e.map(n,function(t){return e.data(t[0],"data")})
...
if(i.children){for(var r=i.children.length-1;r>=0;r--){var s=i.children[r],a=t(n.term,s.text,s)
...
var i=["blur","change","click","dblclick","focus","focusin","focusout","input","keydown","keyup","keypress","mousedown","mouseenter","mouseleave","mousemove","mouseover","mouseup","search","touchend","touchstart"]
this.$selection.on(i.join(" "),function(e){e.stopPropagation()})},e}),function(n){"function"==typeof t.define&&t.define.amd?t.define("jquery-mousewheel",["jquery"],n):"object"==typeof exports?module.exports=n:n(e)}(function(e){function t(t){var s=t||window.event,a=l.call(arguments,1),c=0,d=0,p=0,h=0,f=0,m=0
if(t=e.event.fix(s),t.type="mousewheel","detail"in s&&(p=s.detail*-1),"wheelDelta"in s&&(p=s.wheelDelta),"wheelDeltaY"in s&&(p=s.wheelDeltaY),"wheelDeltaX"in s&&(d=s.wheelDeltaX*-1),"axis"in s&&s.axis===s.HORIZONTAL_AXIS&&(d=p*-1,p=0),c=0===p?d:p,"deltaY"in s&&(p=s.deltaY*-1,c=p),"deltaX"in s&&(d=s.deltaX,0===p&&(c=d*-1)),0!==p||0!==d){if(1===s.deltaMode){var g=e.data(this,"mousewheel-line-height")
c*=g,p*=g,d*=g}else if(2===s.deltaMode){var v=e.data(this,"mousewheel-page-height")
c*=v,p*=v,d*=v}if(h=Math.max(Math.abs(p),Math.abs(d)),(!r||h<r)&&(r=h,i(s,h)&&(r/=40)),i(s,h)&&(c/=40,d/=40,p/=40),c=Math[c>=1?"floor":"ceil"](c/r),d=Math[d>=1?"floor":"ceil"](d/r),p=Math[p>=1?"floor":"ceil"](p/r),u.settings.normalizeOffset&&this.getBoundingClientRect){var y=this.getBoundingClientRect()
f=t.clientX-y.left,m=t.clientY-y.top}return t.deltaX=d,t.deltaY=p,t.deltaFactor=r,t.offsetX=f,t.offsetY=m,t.deltaMode=0,a.unshift(t,c,d,p),o&&clearTimeout(o),o=setTimeout(n,200),(e.event.dispatch||e.event.handle).apply(this,a)}}function n(){r=null}function i(e,t){return u.settings.adjustOldDeltas&&"mousewheel"===e.type&&t%120===0}var o,r,s=["wheel","mousewheel","DOMMouseScroll","MozMousePixelScroll"],a="onwheel"in document||document.documentMode>=9?["wheel"]:["mousewheel","DomMouseScroll","MozMousePixelScroll"],l=Array.prototype.slice
if(e.event.fixHooks)for(var c=s.length;c;)e.event.fixHooks[s[--c]]=e.event.mouseHooks
var u=e.event.special.mousewheel={version:"3.1.12",setup:function(){if(this.addEventListener)for(var n=a.length;n;)this.addEventListener(a[--n],t,!1)
else this.onmousewheel=t
e.data(this,"mousewheel-line-height",u.getLineHeight(this)),e.data(this,"mousewheel-page-height",u.getPageHeight(this))},teardown:function(){if(this.removeEventListener)for(var n=a.length;n;)this.removeEventListener(a[--n],t,!1)
